...
`)}const FT={[Hx]:"Linear",[Gx]:"Reinhard",[jx]:"Cineon",[Wx]:"ACESFilmic",[qx]:"AgX",[$x]:"Neutral",[Xx]:"Custom"};function kT(t,e){const n=FT[e];return n===void 0?($e("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Jo=new J;function OT(){at.getLuminanceCoefficients(Jo);const t=Jo.x.toFixed(4),e=Jo.y.toFixed(4),n=Jo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,_2=[new J(1,0,0),new J(-1,0,0),new J(0,1,0),new J(0,-1,0),new J(0,0,1),new J(0,0,-1)],y2=[new J(0,-1,0),new J(0,-1,0),new J(0,0,1),new J(0,0,-1),new J(0,-1,0),new J(0,-1,0)],h0=new Pt,ma=new J,Nu=new J;function S2(t,e,n){let i=new Ch;const r=new lt,s=new lt,a=new Tt,o=new LM,c=new DM,u={},h=n.maxTextureSize,p={[gr]:yn,[yn]:gr,[ui]:ui},f=new _i({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new lt},radius:{value:4}},vertexShader:x2,fragmentShader:v2}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const _=new ni;_.setAttribute("position",new xi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new en(_,f),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Da;let d=this.type;this.render=function(A,P,g){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||A.length===0)return;this.type===S1&&($e("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Da);const R=t.getRenderTarget(),C=t.getActiveCubeFace(),D=t.getActiveMipmapLevel(),z=t.state;z.setBlending(Pi),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const W=d!==this.type;W&&P.traverse(function(ne){ne.material&&(Array.isArray(ne.material)?ne.material.forEach(V=>V.needsUpdate=!0):ne.material.needsUpdate=!0)});for(let ne=0,V=A.length;ne<V;ne++){const Q=A[ne],$=Q.shadow;if($===void 0){$e("WebGLShadowMap:",Q,"has no shadow.");continue}if($.autoUpdate===!1&&$.needsUpdate===!1)continue;r.copy($.mapSize);const b=$.getFrameExtents();r.multiply(b),s.copy($.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/b.x),r.x=s.x*b.x,$.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/b.y),r.y=s.y*b.y,$.mapSize.y=s.y));const E=t.state.buffers.depth.getReversed();if($.camera._reversedDepth=E,$.map===null||W===!0){if($.map!==null&&($.map.depthTexture!==null&&($.map.depthTexture.dispose(),$.map.depthTexture=null),$.map.dispose()),this.type===ya){if(Q.isPointLight){$e("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}$.map=new gi(r.x,r.y,{format:Xr,type:ki,minFilter:nn,magFilter:nn,generateMipmaps:!1}),$.map.texture.name=Q.name+".shadowMap",$.map.depthTexture=new $s(r.x,r.y,di),$.map.depthTexture.name=Q.name+".shadowMapDepth",$.map.depthTexture.format=Oi,$.map.depthTexture.compareFunction=null,$.map.depthTexture.minFilter=Xt,$.map.depthTexture.magFilter=Xt}else Q.isPointLight?($.map=new gv(r.x),$.map.depthTexture=new TM(r.x,vi)):($.map=new gi(r.x,r.y),$.map.depthTexture=new $s(r.x,r.y,vi)),$.map.depthTexture.name=Q.name+".shadowMap",$.map.depthTexture.format=Oi,this.type===Da?($.map.depthTexture.compareFunction=E?wh:Mh,$.map.depthTexture.minFilter=nn,$.map.depthTexture.magFilter=nn):($.map.depthTexture.compareFunction=null,$.map.depthTexture.minFilter=Xt,$.map.depthTexture.magFilter=Xt);$.camera.updateProjectionMatrix()}const L=$.map.isWebGLCubeRenderTarget?6:1;for(let O=0;O<L;O++){if($.map.isWebGLCubeRenderTarget)t.setRenderTarget($.map,O),t.clear();else{O===0&&(t.setRenderTarget($.map),t.clear());const U=$.getViewport(O);a.set(s.x*U.x,s.y*U.y,s.x*U.z,s.y*U.w),z.viewport(a)}if(Q.isPointLight){const U=$.camera,ce=$.matrix,he=Q.distance||U.far;he!==U.far&&(U.far=he,U.updateProjectionMatrix()),ma.setFromMatrixPosition(Q.matrixWorld),U.position.copy(ma),Nu.copy(U.position),Nu.add(_2[O]),U.up.copy(y2[O]),U.lookAt(Nu),U.updateMatrixWorld(),ce.makeTranslation(-ma.x,-ma.y,-ma.z),h0.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),$._frustum.setFromProjectionMatrix(h0,U.coordinateSystem,U.reversedDepth)}else $.updateMatrices(Q);i=$.getFrustum(),y(P,g,$.camera,Q,this.type)}$.isPointLightShadow!==!0&&this.type===ya&&v($,g),$.needsUpdate=!1}d=this.type,x.needsUpdate=!1,t.setRenderTarget(R,C,D)};function v(A,P){const g=e.update(w);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,m.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new gi(r.x,r.y,{format:Xr,type:ki})),f.uniforms.shadow_pass.value=A.map.depthTexture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,t.setRenderTarget(A.mapPass),t.clear(),t.renderBufferDirect(P,null,g,f,w,null),m.uniforms.shadow_pass.value=A.mapPass.texture,m.uniforms.resolution.value=A.mapSize,m.uniforms.radius.value=A.radius,t.setRenderTarget(A.map),t.clear(),t.renderBufferDirect(P,null,g,m,w,null)}function M(A,P,g,R){let C=null;const D=g.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)C=D;else if(C=g.isPointLight===!0?c:o,t.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const z=C.uuid,W=P.uuid;let ne=u[z];ne===void 0&&(ne={},u[z]=ne);let V=ne[W];V===void 0&&(V=C.clone(),ne[W]=V,P.addEventListener("dispose",T)),C=V}if(C.visible=P.visible,C.wireframe=P.wireframe,R===ya?C.side=P.shadowSide!==null?P.shadowSide:P.side:C.side=P.shadowSide!==null?P.shadowSide:p[P.side],C.alphaMap=P.alphaMap,C.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,C.map=P.map,C.clipShadows=P.clipShadows,C.clippingPlanes=P.clippingPlanes,C.clipIntersection=P.clipIntersection,C.displacementMap=P.displacementMap,C.displacementScale=P.displacementScale,C.displacementBias=P.displacementBias,C.wireframeLinewidth=P.wireframeLinewidth,C.linewidth=P.linewidth,g.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const z=t.properties.get(C);z.light=g}return C}function y(A,P,g,R,C){if(A.visible===!1)return;if(A.layers.test(P.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&C===ya)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(g.matrixWorldInverse,A.matrixWorld);const W=e.update(A),ne=A.material;if(Array.isArray(ne)){const V=W.groups;for(let Q=0,$=V.length;Q<$;Q++){const b=V[Q],E=ne[b.materialIndex];if(E&&E.visible){const L=M(A,E,R,C);A.onBeforeShadow(t,A,P,g,W,L,b),t.renderBufferDirect(g,null,W,L,A,b),A.onAfterShadow(t,A,P,g,W,L,b)}}}else if(ne.visible){const V=M(A,ne,R,C);A.onBeforeShadow(t,A,P,g,W,V,null),t.renderBufferDirect(g,null,W,V,A,null),A.onAfterShadow(t,A,P,g,W,V,null)}}const z=A.children;for(let W=0,ne=z.length;W<ne;W++)y(z[W],P,g,R,C)}function T(A){A.target.removeEventListener("dispose",T);for(const g in u){const R=u[g],C=A.target.uuid;C in R&&(R[C].dispose(),delete R[C])}}}function M2(t,e){function n(){let G=!1;const ye=new Tt;let Y=null;const F=new Tt(0,0,0,0);return{setMask:function(re){Y!==re&&!G&&(t.colorMask(re,re,re,re),Y=re)},setLocked:function(re){G=re},setClear:function(re,j,fe,ie,ve){ve===!0&&(re*=ie,j*=ie,fe*=ie),ye.set(re,j,fe,ie),F.equals(ye)===!1&&(t.clearColor(re,j,fe,ie),F.copy(ye))},reset:function(){G=!1,Y=null,F.set(-1,0,0,0)}}}function i(){let G=!1,ye=!1,Y=null,F=null,re=null;return{setReversed:function(j){if(ye!==j){const fe=e.get("EXT_clip_control");j?fe.clipControlEXT(fe.LOWER_LEFT_EXT,fe.ZERO_TO_ONE_EXT):fe.clipControlEXT(fe.LOWER_LEFT_EXT,fe.NEGATIVE_ONE_TO_ONE_EXT),ye=j;const ie=re;re=null,this.setClear(ie)}},getReversed:function(){return ye},setTest:function(j){j?Z(t.DEPTH_TEST):ge(t.DEPTH_TEST)},setMask:function(j){Y!==j&&!G&&(t.depthMask(j),Y=j)},setFunc:function(j){if(ye&&(j=eM[j]),F!==j){switch(j){case Ad:t.depthFunc(t.NEVER);break;case Rd:t.depthFunc(t.ALWAYS);break;case Nd:t.depthFunc(t.LESS);break;case Xs:t.depthFunc(t.LEQUAL);break;case Pd:t.depthFunc(t.EQUAL);break;case Ld:t.depthFunc(t.GEQUAL);break;case Dd:t.depthFunc(t.GREATER);break;case Id:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}F=j}},setLocked:function(j){G=j},setClear:function(j){re!==j&&(re=j,ye&&(j=1-j),t.clearDepth(j))},reset:function(){G=!1,Y=null,F=null,re=null,ye=!1}}}function r(){let G=!1,ye=null,Y=null,F=null,re=null,j=null,fe=null,ie=null,ve=null;return{setTest:function(ze){G||(ze?Z(t.STENCIL_TEST):ge(t.STENCIL_TEST))},setMask:function(ze){ye!==ze&&!G&&(t.stencilMask(ze),ye=ze)},setFunc:function(ze,Qe,ht){(Y!==ze||F!==Qe||re!==ht)&&(t.stencilFunc(ze,Qe,ht),Y=ze,F=Qe,re=ht)},setOp:function(ze,Qe,ht){(j!==ze||fe!==Qe||ie!==ht)&&(t.stencilOp(ze,Qe,ht),j=ze,fe=Qe,ie=ht)},setLocked:function(ze){G=ze},setClear:function(ze){ve!==ze&&(t.clearStencil(ze),ve=ze)},reset:function(){G=!1,ye=null,Y=null,F=null,re=null,j=null,fe=null,ie=null,ve=null}}}const s=new n,a=new i,o=new r,c=new WeakMap,u=new WeakMap;let h={},p={},f={},m=new WeakMap,_=[],w=null,x=!1,d=null,v=null,M=null,y=null,T=null,A=null,P=null,g=new dt(0,0,0),R=0,C=!1,D=null,z=null,W=null,ne=null,V=null;const Q=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let $=!1,b=0;const E=t.getParameter(t.VERSION);E.indexOf("WebGL")!==-1?(b=parseFloat(/^WebGL (\d)/.exec(E)[1]),$=b>=1):E.indexOf("OpenGL ES")!==-1&&(b=parseFloat(/^OpenGL ES (\d)/.exec(E)[1]),$=b>=2);let L=null,O={};const U=t.getParameter(t.SCISSOR_BOX),ce=t.getParameter(t.VIEWPORT),he=new Tt().fromArray(U),se=new Tt().fromArray(ce);function k(G,ye,Y,F){const re=new Uint8Array(4),j=t.createTexture();t.bindTexture(G,j),t.texParameteri(G,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(G,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let fe=0;fe<Y;fe++)G===t.TEXTURE_3D||G===t.TEXTURE_2D_ARRAY?t.texImage3D(ye,0,t.RGBA,1,1,F,0,t.RGBA,t.UNSIGNED_BYTE,re):t.texImage2D(ye+fe,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,re);return j}const X={};X[t.TEXTURE_2D]=k(t.TEXTURE_2D,t.TEXTURE_2D,1),X[t.TEXTURE_CUBE_MAP]=k(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),X[t.TEXTURE_2D_ARRAY]=k(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),X[t.TEXTURE_3D]=k(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Z(t.DEPTH_TEST),a.setFunc(Xs),qe(!1),Ve(pm),Z(t.CULL_FACE),Ce(Pi);function Z(G){h[G]!==!0&&(t.enable(G),h[G]=!0)}function ge(G){h[G]!==!1&&(t.disable(G),h[G]=!1)}function me(G,ye){return f[G]!==ye?(t.bindFramebuffer(G,ye),f[G]=ye,G===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=ye),G===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=ye),!0):!1}function de(G,ye){let Y=_,F=!1;if(G){Y=m.get(ye),Y===void 0&&(Y=[],m.set(ye,Y));const re=G.textures;if(Y.length!==re.length||Y[0]!==t.COLOR_ATTACHMENT0){for(let j=0,fe=re.length;j<fe;j++)Y[j]=t.COLOR_ATTACHMENT0+j;Y.length=re.length,F=!0}}else Y[0]!==t.BACK&&(Y[0]=t.BACK,F=!0);F&&t.drawBuffers(Y)}function Ae(G){return w!==G?(t.useProgram(G),w=G,!0):!1}const Se={[Nr]:t.FUNC_ADD,[w1]:t.FUNC_SUBTRACT,[E1]:t.FUNC_REVERSE_SUBTRACT};Se[b1]=t.MIN,Se[T1]=t.MAX;const Me={[C1]:t.ZERO,[A1]:t.ONE,[R1]:t.SRC_COLOR,[Td]:t.SRC_ALPHA,[U1]:t.SRC_ALPHA_SATURATE,[D1]:t.DST_COLOR,[P1]:t.DST_ALPHA,[N1]:t.ONE_MINUS_SRC_COLOR,[Cd]:t.ONE_MINUS_SRC_ALPHA,[I1]:t.ONE_MINUS_DST_COLOR,[L1]:t.ONE_MINUS_DST_ALPHA,[F1]:t.CONSTANT_COLOR,[k1]:t.ONE_MINUS_CONSTANT_COLOR,[O1]:t.CONSTANT_ALPHA,[z1]:t.ONE_MINUS_CONSTANT_ALPHA};function Ce(G,ye,Y,F,re,j,fe,ie,ve,ze){if(G===Pi){x===!0&&(ge(t.BLEND),x=!1);return}if(x===!1&&(Z(t.BLEND),x=!0),G!==M1){if(G!==d||ze!==C){if((v!==Nr||T!==Nr)&&(t.blendEquation(t.FUNC_ADD),v=Nr,T=Nr),ze)switch(G){case Us:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case mm:t.blendFunc(t.ONE,t.ONE);break;case gm:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case xm:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:ut("WebGLState: Invalid blending: ",G);break}else switch(G){case Us:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case mm:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case gm:ut("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case xm:ut("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ut("WebGLState: Invalid blending: ",G);break}M=null,y=null,A=null,P=null,g.set(0,0,0),R=0,d=G,C=ze}return}re=re||ye,j=j||Y,fe=fe||F,(ye!==v||re!==T)&&(t.blendEquationSeparate(Se[ye],Se[re]),v=ye,T=re),(Y!==M||F!==y||j!==A||fe!==P)&&(t.blendFuncSeparate(Me[Y],Me[F],Me[j],Me[fe]),M=Y,y=F,A=j,P=fe),(ie.equals(g)===!1||ve!==R)&&(t.blendColor(ie.r,ie.g,ie.b,ve),g.copy(ie),R=ve),d=G,C=!1}function ke(G,ye){G.side===ui?ge(t.CULL_FACE):Z(t.CULL_FACE);let Y=G.side===yn;ye&&(Y=!Y),qe(Y),G.blending===Us&&G.transparent===!1?Ce(Pi):Ce(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),a.setFunc(G.depthFunc),a.setTest(G.depthTest),a.setMask(G.depthWrite),s.setMask(G.colorWrite);const F=G.stencilWrite;o.setTest(F),F&&(o.setMask(G.stencilWriteMask),o.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),o.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),Ye(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?Z(t.SAMPLE_ALPHA_TO_COVERAGE):ge(t.SAMPLE_ALPHA_TO_COVERAGE)}function qe(G){D!==G&&(G?t.frontFace(t.CW):t.frontFace(t.CCW),D=G)}function Ve(G){G!==_1?(Z(t.CULL_FACE),G!==z&&(G===pm?t.cullFace(t.BACK):G===y1?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):ge(t.CULL_FACE),z=G}function He(G){G!==W&&($&&t.lineWidth(G),W=G)}function Ye(G,ye,Y){G?(Z(t.POLYGON_OFFSET_FILL),(ne!==ye||V!==Y)&&(ne=ye,V=Y,a.getReversed()&&(ye=-ye),t.polygonOffset(ye,Y))):ge(t.POLYGON_OFFSET_FILL)}function We(G){G?Z(t.SCISSOR_TEST):ge(t.SCISSOR_TEST)}function et(G){G===void 0&&(G=t.TEXTURE0+Q-1),L!==G&&(t.activeTexture(G),L=G)}function B(G,ye,Y){Y===void 0&&(L===null?Y=t.TEXTURE0+Q-1:Y=L);let F=O[Y];F===void 0&&(F={type:void 0,texture:void 0},O[Y]=F),(F.type!==G||F.texture!==ye)&&(L!==Y&&(t.activeTexture(Y),L=Y),t.bindTexture(G,ye||X[G]),F.type=G,F.texture=ye)}function tt(){const G=O[L];G!==void 0&&G.type!==void 0&&(t.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function Ke(){try{t.compressedTexImage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function I(){try{t.compressedTexImage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function S(){try{t.texSubImage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function H(){try{t.texSubImage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function K(){try{t.compressedTexSubImage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function oe(){try{t.compressedTexSubImage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function xe(){try{t.texStorage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function we(){try{t.texStorage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function ue(){try{t.texImage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function pe(){try{t.texImage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function Ee(G){return p[G]!==void 0?p[G]:t.getParameter(G)}function De(G,ye){p[G]!==ye&&(t.pixelStorei(G,ye),p[G]=ye)}function be(G){he.equals(G)===!1&&(t.scissor(G.x,G.y,G.z,G.w),he.copy(G))}function Te(G){se.equals(G)===!1&&(t.viewport(G.x,G.y,G.z,G.w),se.copy(G))}function Fe(G,ye){let Y=u.get(ye);Y===void 0&&(Y=new WeakMap,u.set(ye,Y));let F=Y.get(G);F===void 0&&(F=t.getUniformBlockIndex(ye,G.name),Y.set(G,F))}function Oe(G,ye){const F=u.get(ye).get(G);c.get(ye)!==F&&(t.uniformBlockBinding(ye,F,G.__bindingPointIndex),c.set(ye,F))}function Xe(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),h={},p={},L=null,O={},f={},m=new WeakMap,_=[],w=null,x=!1,d=null,v=null,M=null,y=null,T=null,A=null,P=null,g=new dt(0,0,0),R=0,C=!1,D=null,z=null,W=null,ne=null,V=null,he.set(0,0,t.canvas.width,t.canvas.height),se.set(0,0,t.canvas.width,t.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Z,disable:ge,bindFramebuffer:me,drawBuffers:de,useProgram:Ae,setBlending:Ce,setMaterial:ke,setFlipSided:qe,setCullFace:Ve,setLineWidth:He,setPolygonOffset:Ye,setScissorTest:We,activeTexture:et,bindTexture:B,unbindTexture:tt,compressedTexImage2D:Ke,compressedTexImage3D:I,texImage2D:ue,texImage3D:pe,pixelStorei:De,getParameter:Ee,updateUBOMapping:Fe,uniformBlockBinding:Oe,texStorage2D:xe,texStorage3D:we,texSubImage2D:S,texSubImage3D:H,compressedTexSubImage2D:K,compressedTexSubImage3D:oe,scissor:be,viewport:Te,reset:Xe}}function w2(t,e,n,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new lt,h=new WeakMap,p=new Set;let f;const m=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function w(I,S){return _?new OffscreenCanvas(I,S):Yl("canvas")}function x(I,S,H){let K=1;const oe=Ke(I);if((oe.width>H||oe.height>H)&&(K=H/Math.max(oe.width,oe.height)),K<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const xe=Math.floor(K*oe.width),we=Math.floor(K*oe.height);f===void 0&&(f=w(xe,we));const ue=S?w(xe,we):f;return ue.width=xe,ue.height=we,ue.getContext("2d").drawImage(I,0,0,xe,we),$e("WebGLRenderer: Texture has been resized from ("+oe.width+"x"+oe.height+") to ("+xe+"x"+we+")."),ue}else return"data"in I&&$e("WebGLRenderer: Image in DataTexture is too big ("+oe.width+"x"+oe.height+")."),I;return I}function d(I){return I.generateMipmaps}function v(I){t.generateMipmap(I)}function M(I){return I.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?t.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(I,S,H,K,oe,xe=!1){if(I!==null){if(t[I]!==void 0)return t[I];$e("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let we;K&&(we=e.get("EXT_texture_norm16"),we||$e("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let ue=S;if(S===t.RED&&(H===t.FLOAT&&(ue=t.R32F),H===t.HALF_FLOAT&&(ue=t.R16F),H===t.UNSIGNED_BYTE&&(ue=t.R8),H===t.UNSIGNED_SHORT&&we&&(ue=we.R16_EXT),H===t.SHORT&&we&&(ue=we.R16_SNORM_EXT)),S===t.RED_INTEGER&&(H===t.UNSIGNED_BYTE&&(ue=t.R8UI),H===t.UNSIGNED_SHORT&&(ue=t.R16UI),H===t.UNSIGNED_INT&&(ue=t.R32UI),H===t.BYTE&&(ue=t.R8I),H===t.SHORT&&(ue=t.R16I),H===t.INT&&(ue=t.R32I)),S===t.RG&&(H===t.FLOAT&&(ue=t.RG32F),H===t.HALF_FLOAT&&(ue=t.RG16F),H===t.UNSIGNED_BYTE&&(ue=t.RG8),H===t.UNSIGNED_SHORT&&we&&(ue=we.RG16_EXT),H===t.SHORT&&we&&(ue=we.RG16_SNORM_EXT)),S===t.RG_INTEGER&&(H===t.UNSIGNED_BYTE&&(ue=t.RG8UI),H===t.UNSIGNED_SHORT&&(ue=t.RG16UI),H===t.UNSIGNED_INT&&(ue=t.RG32UI),H===t.BYTE&&(ue=t.RG8I),H===t.SHORT&&(ue=t.RG16I),H===t.INT&&(ue=t.RG32I)),S===t.RGB_INTEGER&&(H===t.UNSIGNED_BYTE&&(ue=t.RGB8UI),H===t.UNSIGNED_SHORT&&(ue=t.RGB16UI),H===t.UNSIGNED_INT&&(ue=t.RGB32UI),H===t.BYTE&&(ue=t.RGB8I),H===t.SHORT&&(ue=t.RGB16I),H===t.INT&&(ue=t.RGB32I)),S===t.RGBA_INTEGER&&(H===t.UNSIGNED_BYTE&&(ue=t.RGBA8UI),H===t.UNSIGNED_SHORT&&(ue=t.RGBA16UI),H===t.UNSIGNED_INT&&(ue=t.RGBA32UI),H===t.BYTE&&(ue=t.RGBA8I),H===t.SHORT&&(ue=t.RGBA16I),H===t.INT&&(ue=t.RGBA32I)),S===t.RGB&&(H===t.UNSIGNED_SHORT&&we&&(ue=we.RGB16_EXT),H===t.SHORT&&we&&(ue=we.RGB16_SNORM_EXT),H===t.UNSIGNED_INT_5_9_9_9_REV&&(ue=t.RGB9_E5),H===t.UNSIGNED_INT_10F_11F_11F_REV&&(ue=t.R11F_G11F_B10F)),S===t.RGBA){const pe=xe?$l:at.getTransfer(oe);H===t.FLOAT&&(ue=t.RGBA32F),H===t.HALF_FLOAT&&(ue=t.RGBA16F),H===t.UNSIGNED_BYTE&&(ue=pe===pt?t.SRGB8_ALPHA8:t.RGBA8),H===t.UNSIGNED_SHORT&&we&&(ue=we.RGBA16_EXT),H===t.SHORT&&we&&(ue=we.RGBA16_SNORM_EXT),H===t.UNSIGNED_SHORT_4_4_4_4&&(ue=t.RGBA4),H===t.UNSIGNED_SHORT_5_5_5_1&&(ue=t.RGB5_A1)}return(ue===t.R16F||ue===t.R32F||ue===t.RG16F||ue===t.RG32F||ue===t.RGBA16F||ue===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ue}function T(I,S){let H;return I?S===null||S===vi||S===Ja?H=t.DEPTH24_STENCIL8:S===di?H=t.DEPTH32F_STENCIL8:S===Qa&&(H=t.DEPTH24_STENCIL8,$e("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===vi||S===Ja?H=t.DEPTH_COMPONENT24:S===di?H=t.DEPTH_COMPONENT32F:S===Qa&&(H=t.DEPTH_COMPONENT16),H}function A(I,S){return d(I)===!0||I.isFramebufferTexture&&I.minFilter!==Xt&&I.minFilter!==nn?Math.log2(Math.max(S.width,S.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?S.mipmaps.length:1}function P(I){const S=I.target;S.removeEventListener("dispose",P),R(S),S.isVideoTexture&&h.delete(S),S.isHTMLTexture&&p.delete(S)}function g(I){const S=I.target;S.removeEventListener("dispose",g),D(S)}function R(I){const S=i.get(I);if(S.__webglInit===void 0)return;const H=I.source,K=m.get(H);if(K){const oe=K[S.__cacheKey];oe.usedTimes--,oe.usedTimes===0&&C(I),Object.keys(K).length===0&&m.delete(H)}i.remove(I)}function C(I){const S=i.get(I);t.deleteTexture(S.__webglTexture);const H=I.source,K=m.get(H);delete K[S.__cacheKey],a.memory.textures--}function D(I){const S=i.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),i.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(S.__webglFramebuffer[K]))for(let oe=0;oe<S.__webglFramebuffer[K].length;oe++)t.deleteFramebuffer(S.__webglFramebuffer[K][oe]);else t.deleteFramebuffer(S.__webglFramebuffer[K]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[K])}else{if(Array.isArray(S.__webglFramebuffer))for(let K=0;K<S.__webglFramebuffer.length;K++)t.deleteFramebuffer(S.__webglFramebuffer[K]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let K=0;K<S.__webglColorRenderbuffer.length;K++)S.__webglColorRenderbuffer[K]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[K]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const H=I.textures;for(let K=0,oe=H.length;K<oe;K++){const xe=i.get(H[K]);xe.__webglTexture&&(t.deleteTexture(xe.__webglTexture),a.memory.textures--),i.remove(H[K])}i.remove(I)}let z=0;function W(){z=0}function ne(){return z}function V(I){z=I}function Q(){const I=z;return I>=r.maxTextures&&$e("WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+r.maxTextures),z+=1,I}function $(I){const S=[];return S.push(I.wrapS),S.push(I.wrapT),S.push(I.wrapR||0),S.push(I.magFilter),S.push(I.minFilter),S.push(I.anisotropy),S.push(I.internalFormat),S.push(I.format),S.push(I.type),S.push(I.generateMipmaps),S.push(I.premultiplyAlpha),S.push(I.flipY),S.push(I.unpackAlignment),S.push(I.colorSpace),S.join()}function b(I,S){const H=i.get(I);if(I.isVideoTexture&&B(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&H.__version!==I.version){const K=I.image;if(K===null)$e("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)$e("WebGLRenderer: Texture marked for update but image is incomplete");else{ge(H,I,S);return}}else I.isExternalTexture&&(H.__webglTexture=I.sourceTexture?I.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,H.__webglTexture,t.TEXTURE0+S)}function E(I,S){const H=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&H.__version!==I.version){ge(H,I,S);return}else I.isExternalTexture&&(H.__webglTexture=I.sourceTexture?I.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,H.__webglTexture,t.TEXTURE0+S)}function L(I,S){const H=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&H.__version!==I.version){ge(H,I,S);return}n.bindTexture(t.TEXTURE_3D,H.__webglTexture,t.TEXTURE0+S)}function O(I,S){const H=i.get(I);if(I.isCubeDepthTexture!==!0&&I.version>0&&H.__version!==I.version){me(H,I,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,H.__webglTexture,t.TEXTURE0+S)}const U={[Ud]:t.REPEAT,[Ri]:t.CLAMP_TO_EDGE,[Fd]:t.MIRRORED_REPEAT},ce={[Xt]:t.NEAREST,[H1]:t.NEAREST_MIPMAP_NEAREST,[Po]:t.NEAREST_MIPMAP_LINEAR,[nn]:t.LINEAR,[Qc]:t.LINEAR_MIPMAP_NEAREST,[Ur]:t.LINEAR_MIPMAP_LINEAR},he={[W1]:t.NEVER,[K1]:t.ALWAYS,[X1]:t.LESS,[Mh]:t.LEQUAL,[q1]:t.EQUAL,[wh]:t.GEQUAL,[$1]:t.GREATER,[Y1]:t.NOTEQUAL};function se(I,S){if(S.type===di&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===nn||S.magFilter===Qc||S.magFilter===Po||S.magFilter===Ur||S.minFilter===nn||S.minFilter===Qc||S.minFilter===Po||S.minFilter===Ur)&&$e("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(I,t.TEXTURE_WRAP_S,U[S.wrapS]),t.texParameteri(I,t.TEXTURE_WRAP_T,U[S.wrapT]),(I===t.TEXTURE_3D||I===t.TEXTURE_2D_ARRAY)&&t.texParameteri(I,t.TEXTURE_WRAP_R,U[S.wrapR]),t.texParameteri(I,t.TEXTURE_MAG_FILTER,ce[S.magFilter]),t.texParameteri(I,t.TEXTURE_MIN_FILTER,ce[S.minFilter]),S.compareFunction&&(t.texParameteri(I,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(I,t.TEXTURE_COMPARE_FUNC,he[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Xt||S.minFilter!==Po&&S.minFilter!==Ur||S.type===di&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");t.texParameterf(I,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function k(I,S){let H=!1;I.__webglInit===void 0&&(I.__webglInit=!0,S.addEventListener("dispose",P));const K=S.source;let oe=m.get(K);oe===void 0&&(oe={},m.set(K,oe));const xe=$(S);if(xe!==I.__cacheKey){oe[xe]===void 0&&(oe[xe]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,H=!0),oe[xe].usedTimes++;const we=oe[I.__cacheKey];we!==void 0&&(oe[I.__cacheKey].usedTimes--,we.usedTimes===0&&C(S)),I.__cacheKey=xe,I.__webglTexture=oe[xe].texture}return H}function X(I,S,H){return Math.floor(Math.floor(I/H)/S)}function Z(I,S,H,K){const xe=I.updateRanges;if(xe.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,S.width,S.height,H,K,S.data);else{xe.sort((De,be)=>De.start-be.start);let we=0;for(let De=1;De<xe.length;De++){const be=xe[we],Te=xe[De],Fe=be.start+be.count,Oe=X(Te.start,S.width,4),Xe=X(be.start,S.width,4);Te.start<=Fe+1&&Oe===Xe&&X(Te.start+Te.count-1,S.width,4)===Oe?be.count=Math.max(be.count,Te.start+Te.count-be.start):(++we,xe[we]=Te)}xe.length=we+1;const ue=n.getParameter(t.UNPACK_ROW_LENGTH),pe=n.getParameter(t.UNPACK_SKIP_PIXELS),Ee=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,S.width);for(let De=0,be=xe.length;De<be;De++){const Te=xe[De],Fe=Math.floor(Te.start/4),Oe=Math.ceil(Te.count/4),Xe=Fe%S.width,G=Math.floor(Fe/S.width),ye=Oe,Y=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Xe),n.pixelStorei(t.UNPACK_SKIP_ROWS,G),n.texSubImage2D(t.TEXTURE_2D,0,Xe,G,ye,Y,H,K,S.data)}I.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,ue),n.pixelStorei(t.UNPACK_SKIP_PIXELS,pe),n.pixelStorei(t.UNPACK_SKIP_ROWS,Ee)}}function ge(I,S,H){let K=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(K=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(K=t.TEXTURE_3D);const oe=k(I,S),xe=S.source;n.bindTexture(K,I.__webglTexture,t.TEXTURE0+H);const we=i.get(xe);if(xe.version!==we.__version||oe===!0){if(n.activeTexture(t.TEXTURE0+H),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){const Y=at.getPrimaries(at.workingColorSpace),F=S.colorSpace===tr?null:at.getPrimaries(S.colorSpace),re=S.colorSpace===tr||Y===F?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,re)}n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment);let pe=x(S.image,!1,r.maxTextureSize);pe=tt(S,pe);const Ee=s.convert(S.format,S.colorSpace),De=s.convert(S.type);let be=y(S.internalFormat,Ee,De,S.normalized,S.colorSpace,S.isVideoTexture);se(K,S);let Te;const Fe=S.mipmaps,Oe=S.isVideoTexture!==!0,Xe=we.__version===void 0||oe===!0,G=xe.dataReady,ye=A(S,pe);if(S.isDepthTexture)be=T(S.format===Fr,S.type),Xe&&(Oe?n.texStorage2D(t.TEXTURE_2D,1,be,pe.width,pe.height):n.texImage2D(t.TEXTURE_2D,0,be,pe.width,pe.height,0,Ee,De,null));else if(S.isDataTexture)if(Fe.length>0){Oe&&Xe&&n.texStorage2D(t.TEXTURE_2D,ye,be,Fe[0].width,Fe[0].height);for(let Y=0,F=Fe.length;Y<F;Y++)Te=Fe[Y],Oe?G&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,Te.width,Te.height,Ee,De,Te.data):n.texImage2D(t.TEXTURE_2D,Y,be,Te.width,Te.height,0,Ee,De,Te.data);S.generateMipmaps=!1}else Oe?(Xe&&n.texStorage2D(t.TEXTURE_2D,ye,be,pe.width,pe.height),G&&Z(S,pe,Ee,De)):n.texImage2D(t.TEXTURE_2D,0,be,pe.width,pe.height,0,Ee,De,pe.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Oe&&Xe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ye,be,Fe[0].width,Fe[0].height,pe.depth);for(let Y=0,F=Fe.length;Y<F;Y++)if(Te=Fe[Y],S.format!==Qn)if(Ee!==null)if(Oe){if(G)if(S.layerUpdates.size>0){const re=jm(Te.width,Te.height,S.format,S.type);for(const j of S.layerUpdates){const fe=Te.data.subarray(j*re/Te.data.BYTES_PER_ELEMENT,(j+1)*re/Te.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,j,Te.width,Te.height,1,Ee,fe)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,0,Te.width,Te.height,pe.depth,Ee,Te.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,Y,be,Te.width,Te.height,pe.depth,0,Te.data,0,0);else $e("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?G&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,0,Te.width,Te.height,pe.depth,Ee,De,Te.data):n.texImage3D(t.TEXTURE_2D_ARRAY,Y,be,Te.width,Te.height,pe.depth,0,Ee,De,Te.data)}else{Oe&&Xe&&n.texStorage2D(t.TEXTURE_2D,ye,be,Fe[0].width,Fe[0].height);for(let Y=0,F=Fe.length;Y<F;Y++)Te=Fe[Y],S.format!==Qn?Ee!==null?Oe?G&&n.compressedTexSubImage2D(t.TEXTURE_2D,Y,0,0,Te.width,Te.height,Ee,Te.data):n.compressedTexImage2D(t.TEXTURE_2D,Y,be,Te.width,Te.height,0,Te.data):$e("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?G&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,Te.width,Te.height,Ee,De,Te.data):n.texImage2D(t.TEXTURE_2D,Y,be,Te.width,Te.height,0,Ee,De,Te.data)}else if(S.isDataArrayTexture)if(Oe){if(Xe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ye,be,pe.width,pe.height,pe.depth),G)if(S.layerUpdates.size>0){const Y=jm(pe.width,pe.height,S.format,S.type);for(const F of S.layerUpdates){const re=pe.data.subarray(F*Y/pe.data.BYTES_PER_ELEMENT,(F+1)*Y/pe.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,F,pe.width,pe.height,1,Ee,De,re)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,pe.width,pe.height,pe.depth,Ee,De,pe.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,be,pe.width,pe.height,pe.depth,0,Ee,De,pe.data);else if(S.isData3DTexture)Oe?(Xe&&n.texStorage3D(t.TEXTURE_3D,ye,be,pe.width,pe.height,pe.depth),G&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,pe.width,pe.height,pe.depth,Ee,De,pe.data)):n.texImage3D(t.TEXTURE_3D,0,be,pe.width,pe.height,pe.depth,0,Ee,De,pe.data);else if(S.isFramebufferTexture){if(Xe)if(Oe)n.texStorage2D(t.TEXTURE_2D,ye,be,pe.width,pe.height);else{let Y=pe.width,F=pe.height;for(let re=0;re<ye;re++)n.texImage2D(t.TEXTURE_2D,re,be,Y,F,0,Ee,De,null),Y>>=1,F>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in t){const Y=t.canvas;if(Y.hasAttribute("layoutsubtree")||Y.setAttribute("layoutsubtree","true"),pe.parentNode!==Y){Y.appendChild(pe),p.add(S),Y.onpaint=F=>{const re=F.changedElements;for(const j of p)re.includes(j.image)&&(j.needsUpdate=!0)},Y.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,pe);else{const re=t.RGBA,j=t.RGBA,fe=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,re,j,fe,pe)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(Oe&&Xe){const Y=Ke(Fe[0]);n.texStorage2D(t.TEXTURE_2D,ye,be,Y.width,Y.height)}for(let Y=0,F=Fe.length;Y<F;Y++)Te=Fe[Y],Oe?G&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,Ee,De,Te):n.texImage2D(t.TEXTURE_2D,Y,be,Ee,De,Te);S.generateMipmaps=!1}else if(Oe){if(Xe){const Y=Ke(pe);n.texStorage2D(t.TEXTURE_2D,ye,be,Y.width,Y.height)}G&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Ee,De,pe)}else n.texImage2D(t.TEXTURE_2D,0,be,Ee,De,pe);d(S)&&v(K),we.__version=xe.version,S.onUpdate&&S.onUpdate(S)}I.__version=S.version}function me(I,S,H){if(S.image.length!==6)return;const K=k(I,S),oe=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,I.__webglTexture,t.TEXTURE0+H);const xe=i.get(oe);if(oe.version!==xe.__version||K===!0){n.activeTexture(t.TEXTURE0+H);const we=at.getPrimaries(at.workingColorSpace),ue=S.colorSpace===tr?null:at.getPrimaries(S.colorSpace),pe=S.colorSpace===tr||we===ue?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const Ee=S.isCompressedTexture||S.image[0].isCompressedTexture,De=S.image[0]&&S.image[0].isDataTexture,be=[];for(let j=0;j<6;j++)!Ee&&!De?be[j]=x(S.image[j],!0,r.maxCubemapSize):be[j]=De?S.image[j].image:S.image[j],be[j]=tt(S,be[j]);const Te=be[0],Fe=s.convert(S.format,S.colorSpace),Oe=s.convert(S.type),Xe=y(S.internalFormat,Fe,Oe,S.normalized,S.colorSpace),G=S.isVideoTexture!==!0,ye=xe.__version===void 0||K===!0,Y=oe.dataReady;let F=A(S,Te);se(t.TEXTURE_CUBE_MAP,S);let re;if(Ee){G&&ye&&n.texStorage2D(t.TEXTURE_CUBE_MAP,F,Xe,Te.width,Te.height);for(let j=0;j<6;j++){re=be[j].mipmaps;for(let fe=0;fe<re.length;fe++){const ie=re[fe];S.format!==Qn?Fe!==null?G?Y&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,fe,0,0,ie.width,ie.height,Fe,ie.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,fe,Xe,ie.width,ie.height,0,ie.data):$e("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,fe,0,0,ie.width,ie.height,Fe,Oe,ie.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,fe,Xe,ie.width,ie.height,0,Fe,Oe,ie.data)}}}else{if(re=S.mipmaps,G&&ye){re.length>0&&F++;const j=Ke(be[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,F,Xe,j.width,j.height)}for(let j=0;j<6;j++)if(De){G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,be[j].width,be[j].height,Fe,Oe,be[j].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Xe,be[j].width,be[j].height,0,Fe,Oe,be[j].data);for(let fe=0;fe<re.length;fe++){const ve=re[fe].image[j].image;G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,fe+1,0,0,ve.width,ve.height,Fe,Oe,ve.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,fe+1,Xe,ve.width,ve.height,0,Fe,Oe,ve.data)}}else{G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Fe,Oe,be[j]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Xe,Fe,Oe,be[j]);for(let fe=0;fe<re.length;fe++){const ie=re[fe];G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,fe+1,0,0,Fe,Oe,ie.image[j]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,fe+1,Xe,Fe,Oe,ie.image[j])}}}d(S)&&v(t.TEXTURE_CUBE_MAP),xe.__version=oe.version,S.onUpdate&&S.onUpdate(S)}I.__version=S.version}function de(I,S,H,K,oe,xe){const we=s.convert(H.format,H.colorSpace),ue=s.convert(H.type),pe=y(H.internalFormat,we,ue,H.normalized,H.colorSpace),Ee=i.get(S),De=i.get(H);if(De.__renderTarget=S,!Ee.__hasExternalTextures){const be=Math.max(1,S.width>>xe),Te=Math.max(1,S.height>>xe);oe===t.TEXTURE_3D||oe===t.TEXTURE_2D_ARRAY?n.texImage3D(oe,xe,pe,be,Te,S.depth,0,we,ue,null):n.texImage2D(oe,xe,pe,be,Te,0,we,ue,null)}n.bindFramebuffer(t.FRAMEBUFFER,I),et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,K,oe,De.__webglTexture,0,We(S)):(oe===t.TEXTURE_2D||oe>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&oe<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,K,oe,De.__webglTexture,xe),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ae(I,S,H){if(t.bindRenderbuffer(t.RENDERBUFFER,I),S.depthBuffer){const K=S.depthTexture,oe=K&&K.isDepthTexture?K.type:null,xe=T(S.stencilBuffer,oe),we=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;et(S)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,We(S),xe,S.width,S.height):H?t.renderbufferStorageMultisample(t.RENDERBUFFER,We(S),xe,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,xe,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,we,t.RENDERBUFFER,I)}else{const K=S.textures;for(let oe=0;oe<K.length;oe++){const xe=K[oe],we=s.convert(xe.format,xe.colorSpace),ue=s.convert(xe.type),pe=y(xe.internalFormat,we,ue,xe.normalized,xe.colorSpace);et(S)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,We(S),pe,S.width,S.height):H?t.renderbufferStorageMultisample(t.RENDERBUFFER,We(S),pe,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,pe,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Se(I,S,H){const K=S.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,I),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const oe=i.get(S.depthTexture);if(oe.__renderTarget=S,(!oe.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),K){if(oe.__webglInit===void 0&&(oe.__webglInit=!0,S.depthTexture.addEventListener("dispose",P)),oe.__webglTexture===void 0){oe.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,oe.__webglTexture),se(t.TEXTURE_CUBE_MAP,S.depthTexture);const Ee=s.convert(S.depthTexture.format),De=s.convert(S.depthTexture.type);let be;S.depthTexture.format===Oi?be=t.DEPTH_COMPONENT24:S.depthTexture.format===Fr&&(be=t.DEPTH24_STENCIL8);for(let Te=0;Te<6;Te++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Te,0,be,S.width,S.height,0,Ee,De,null)}}else b(S.depthTexture,0);const xe=oe.__webglTexture,we=We(S),ue=K?t.TEXTURE_CUBE_MAP_POSITIVE_X+H:t.TEXTURE_2D,pe=S.depthTexture.format===Fr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(S.depthTexture.format===Oi)et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,pe,ue,xe,0,we):t.framebufferTexture2D(t.FRAMEBUFFER,pe,ue,xe,0);else if(S.depthTexture.format===Fr)et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,pe,ue,xe,0,we):t.framebufferTexture2D(t.FRAMEBUFFER,pe,ue,xe,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Me(I){const S=i.get(I),H=I.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==I.depthTexture){const K=I.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),K){const oe=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,K.removeEventListener("dispose",oe)};K.addEventListener("dispose",oe),S.__depthDisposeCallback=oe}S.__boundDepthTexture=K}if(I.depthTexture&&!S.__autoAllocateDepthBuffer)if(H)for(let K=0;K<6;K++)Se(S.__webglFramebuffer[K],I,K);else{const K=I.texture.mipmaps;K&&K.length>0?Se(S.__webglFramebuffer[0],I,0):Se(S.__webglFramebuffer,I,0)}else if(H){S.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[K]),S.__webglDepthbuffer[K]===void 0)S.__webglDepthbuffer[K]=t.createRenderbuffer(),Ae(S.__webglDepthbuffer[K],I,!1);else{const oe=I.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,xe=S.__webglDepthbuffer[K];t.bindRenderbuffer(t.RENDERBUFFER,xe),t.framebufferRenderbuffer(t.FRAMEBUFFER,oe,t.RENDERBUFFER,xe)}}else{const K=I.texture.mipmaps;if(K&&K.length>0?n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),Ae(S.__webglDepthbuffer,I,!1);else{const oe=I.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,xe=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,xe),t.framebufferRenderbuffer(t.FRAMEBUFFER,oe,t.RENDERBUFFER,xe)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ce(I,S,H){const K=i.get(I);S!==void 0&&de(K.__webglFramebuffer,I,I.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),H!==void 0&&Me(I)}function ke(I){const S=I.texture,H=i.get(I),K=i.get(S);I.addEventListener("dispose",g);const oe=I.textures,xe=I.isWebGLCubeRenderTarget===!0,we=oe.length>1;if(we||(K.__webglTexture===void 0&&(K.__webglTexture=t.createTexture()),K.__version=S.version,a.memory.textures++),xe){H.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(S.mipmaps&&S.mipmaps.length>0){H.__webglFramebuffer[ue]=[];for(let pe=0;pe<S.mipmaps.length;pe++)H.__webglFramebuffer[ue][pe]=t.createFramebuffer()}else H.__webglFramebuffer[ue]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){H.__webglFramebuffer=[];for(let ue=0;ue<S.mipmaps.length;ue++)H.__webglFramebuffer[ue]=t.createFramebuffer()}else H.__webglFramebuffer=t.createFramebuffer();if(we)for(let ue=0,pe=oe.length;ue<pe;ue++){const Ee=i.get(oe[ue]);Ee.__webglTexture===void 0&&(Ee.__webglTexture=t.createTexture(),a.memory.textures++)}if(I.samples>0&&et(I)===!1){H.__webglMultisampledFramebuffer=t.createFramebuffer(),H.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let ue=0;ue<oe.length;ue++){const pe=oe[ue];H.__webglColorRenderbuffer[ue]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,H.__webglColorRenderbuffer[ue]);const Ee=s.convert(pe.format,pe.colorSpace),De=s.convert(pe.type),be=y(pe.internalFormat,Ee,De,pe.normalized,pe.colorSpace,I.isXRRenderTarget===!0),Te=We(I);t.renderbufferStorageMultisample(t.RENDERBUFFER,Te,be,I.width,I.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,H.__webglColorRenderbuffer[ue])}t.bindRenderbuffer(t.RENDERBUFFER,null),I.depthBuffer&&(H.__webglDepthRenderbuffer=t.createRenderbuffer(),Ae(H.__webglDepthRenderbuffer,I,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(xe){n.bindTexture(t.TEXTURE_CUBE_MAP,K.__webglTexture),se(t.TEXTURE_CUBE_MAP,S);for(let ue=0;ue<6;ue++)if(S.mipmaps&&S.mipmaps.length>0)for(let pe=0;pe<S.mipmaps.length;pe++)de(H.__webglFramebuffer[ue][pe],I,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ue,pe);else de(H.__webglFramebuffer[ue],I,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);d(S)&&v(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(we){for(let ue=0,pe=oe.length;ue<pe;ue++){const Ee=oe[ue],De=i.get(Ee);let be=t.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(be=I.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(be,De.__webglTexture),se(be,Ee),de(H.__webglFramebuffer,I,Ee,t.COLOR_ATTACHMENT0+ue,be,0),d(Ee)&&v(be)}n.unbindTexture()}else{let ue=t.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(ue=I.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ue,K.__webglTexture),se(ue,S),S.mipmaps&&S.mipmaps.length>0)for(let pe=0;pe<S.mipmaps.length;pe++)de(H.__webglFramebuffer[pe],I,S,t.COLOR_ATTACHMENT0,ue,pe);else de(H.__webglFramebuffer,I,S,t.COLOR_ATTACHMENT0,ue,0);d(S)&&v(ue),n.unbindTexture()}I.depthBuffer&&Me(I)}function qe(I){const S=I.textures;for(let H=0,K=S.length;H<K;H++){const oe=S[H];if(d(oe)){const xe=M(I),we=i.get(oe).__webglTexture;n.bindTexture(xe,we),v(xe),n.unbindTexture()}}}const Ve=[],He=[];function Ye(I){if(I.samples>0){if(et(I)===!1){const S=I.textures,H=I.width,K=I.height;let oe=t.COLOR_BUFFER_BIT;const xe=I.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,we=i.get(I),ue=S.length>1;if(ue)for(let Ee=0;Ee<S.length;Ee++)n.bindFramebuffer(t.FRAMEBUFFER,we.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ee,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,we.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ee,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,we.__webglMultisampledFramebuffer);const pe=I.texture.mipmaps;pe&&pe.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,we.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,we.__webglFramebuffer);for(let Ee=0;Ee<S.length;Ee++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(oe|=t.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(oe|=t.STENCIL_BUFFER_BIT)),ue){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,we.__webglColorRenderbuffer[Ee]);const De=i.get(S[Ee]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,De,0)}t.blitFramebuffer(0,0,H,K,0,0,H,K,oe,t.NEAREST),c===!0&&(Ve.length=0,He.length=0,Ve.push(t.COLOR_ATTACHMENT0+Ee),I.depthBuffer&&I.resolveDepthBuffer===!1&&(Ve.push(xe),He.push(xe),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,He)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Ve))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ue)for(let Ee=0;Ee<S.length;Ee++){n.bindFramebuffer(t.FRAMEBUFFER,we.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ee,t.RENDERBUFFER,we.__webglColorRenderbuffer[Ee]);const De=i.get(S[Ee]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,we.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ee,t.TEXTURE_2D,De,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,we.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&c){const S=I.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function We(I){return Math.min(r.maxSamples,I.samples)}function et(I){const S=i.get(I);return I.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function B(I){const S=a.render.frame;h.get(I)!==S&&(h.set(I,S),I.update())}function tt(I,S){const H=I.colorSpace,K=I.format,oe=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||H!==ql&&H!==tr&&(at.getTransfer(H)===pt?(K!==Qn||oe!==Cn)&&$e("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ut("WebGLTextures: Unsupported texture color space:",H)),S}function Ke(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(u.width=I.naturalWidth||I.width,u.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(u.width=I.displayWidth,u.height=I.displayHeight):(u.width=I.width,u.height=I.height),u}this.allocateTextureUnit=Q,this.resetTextureUnits=W,this.getTextureUnits=ne,this.setTextureUnits=V,this.setTexture2D=b,this.setTexture2DArray=E,this.setTexture3D=L,this.setTextureCube=O,this.rebindTextures=Ce,this.setupRenderTarget=ke,this.updateRenderTargetMipmap=qe,this.updateMultisampleRenderTarget=Ye,this.setupDepthRenderbuffer=Me,this.setupFrameBufferTexture=de,this.useMultisampledRTT=et,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function E2(t,e){function n(i,r=tr){let s;const a=at.getTransfer(r);if(i===Cn)return t.UNSIGNED_BYTE;if(i===xh)return t.UNSIGNED_SHORT_4_4_4_4;if(i===vh)return t.UNSIGNED_SHORT_5_5_5_1;if(i===Qx)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Jx)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===Kx)return t.BYTE;if(i===Zx)return t.SHORT;if(i===Qa)return t.UNSIGNED_SHORT;if(i===gh)return t.INT;if(i===vi)return t.UNSIGNED_INT;if(i===di)return t.FLOAT;if(i===ki)return t.HALF_FLOAT;if(i===ev)return t.ALPHA;if(i===tv)return t.RGB;if(i===Qn)return t.RGBA;if(i===Oi)return t.DEPTH_COMPONENT;if(i===Fr)return t.DEPTH_STENCIL;if(i===nv)return t.RED;if(i===_h)return t.RED_INTEGER;if(i===Xr)return t.RG;if(i===yh)return t.RG_INTEGER;if(i===Sh)return t.RGBA_INTEGER;if(i===pl||i===ml||i===gl||i===xl)if(a===pt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===pl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ml)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===gl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===xl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===pl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ml)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===gl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===xl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===kd||i===Od||i===zd||i===Bd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===kd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Od)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===zd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Bd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Vd||i===Hd||i===Gd||i===jd||i===Wd||i===Wl||i===Xd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Vd||i===Hd)return a===pt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Gd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===jd)return s.COMPRESSED_R11_EAC;if(i===Wd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Wl)return s.COMPRESSED_RG11_EAC;if(i===Xd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===qd||i===$d||i===Yd||i===Kd||i===Zd||i===Qd||i===Jd||i===ef||i===tf||i===nf||i===rf||i===sf||i===af||i===of)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===qd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===$d)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Yd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Kd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Zd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Qd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Jd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ef)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===tf)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===nf)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===rf)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===sf)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===af)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===of)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===lf||i===cf||i===uf)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===lf)return a===pt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===cf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===uf)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===df||i===ff||i===Xl||i===hf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===df)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ff)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Xl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===hf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ja?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const b2=`
void main() {
