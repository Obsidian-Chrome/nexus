 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tS=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),st=(t,e)=>{const n=le.forwardRef(({color:i="currentColor",size:r=24,strokeWidth:s=2,absoluteStrokeWidth:a,className:o="",children:c,...u},h)=>le.createElement("svg",{ref:h,...eS,width:r,height:r,stroke:i,strokeWidth:a?Number(s)*24/Number(r):s,className:["lucide",`lucide-${tS(t)}`,o].join(" "),...u},[...e.map(([p,f])=>le.createElement(p,f)),...Array.isArray(c)?c:[c]]));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`)}const UT={[Hx]:"Linear",[Gx]:"Reinhard",[jx]:"Cineon",[Wx]:"ACESFilmic",[qx]:"AgX",[$x]:"Neutral",[Xx]:"Custom"};function FT(t,e){const n=UT[e];return n===void 0?(We("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Jo=new J;function kT(){at.getLuminanceCoefficients(Jo);const t=Jo.x.toFixed(4),e=Jo.y.toFixed(4),n=Jo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const M=v+x+a,y=v+d+o,T=i0(r,r.VERTEX_SHADER,M),A=i0(r,r.FRAGMENT_SHADER,y);r.attachShader(w,T),r.attachShader(w,A),n.index0AttributeName!==void 0?r.bindAttribLocation(w,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(w,0,"position"),r.linkProgram(w);function P(D){if(t.debug.checkShaderErrors){const z=r.getProgramInfoLog(w)||"",j=r.getShaderInfoLog(T)||"",ne=r.getShaderInfoLog(A)||"",V=z.trim(),Q=j.trim(),$=ne.trim();let b=!0,E=!0;if(r.getProgramParameter(w,r.LINK_STATUS)===!1)if(b=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,w,T,A);else{const L=s0(r,T,"vertex"),O=s0(r,A,"fragment");ut("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(w,r.VALIDATE_STATUS)+`
...
Program Info Log: `+V+`
`+L+`
`+O)}else V!==""?We("WebGLProgram: Program Info Log:",V):(Q===""||$==="")&&(E=!1);E&&(D.diagnostics={runnable:b,programLog:V,vertexShader:{log:Q,prefix:x},fragmentShader:{log:$,prefix:d}})}r.deleteShader(T),r.deleteShader(A),g=new vl(r,w),R=BT(r,w)}let g;this.getUniforms=function(){return g===void 0&&P(this),g};let R;this.getAttributes=function(){return R===void 0&&P(this),R};let C=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return C===!1&&(C=r.getProgramParameter(w,NT)),C},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(w),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=PT++,this.cacheKey=e,this.usedTimes=1,this.program=w,this.vertexShader=T,this.fragmentShader=A,this}let n2=0;class i2{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,n,i){const r=this._getShaderCacheForMaterial(e);return r.has(n)===!1&&(r.add(n),n.usedTimes++),r.has(i)===!1&&(r.add(i),i.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new r2(e),n.set(e,i)),i}}class r2{constructor(e){this.id=n2++,this.code=e,this.usedTimes=0}}function s2(t){return t===Xr||t===Wl||t===Xl}function a2(t,e,n,i,r,s){const a=new sv,o=new i2,c=new Set,u=[],h=new Map,p=i.logarithmicDepthBuffer;let f=i.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(g){return c.add(g),g===0?"uv":`uv${g}`}function w(g,R,C,D,z,j){const ne=D.fog,V=z.geometry,Q=g.isMeshStandardMaterial||g.isMeshLambertMaterial||g.isMeshPhongMaterial?D.environment:null,$=g.isMeshStandardMaterial||g.isMeshLambertMaterial&&!g.envMap||g.isMeshPhongMaterial&&!g.envMap,b=e.get(g.envMap||Q,$),E=b&&b.mapping===gc?b.image.height:null,L=m[g.type];g.precision!==null&&(f=i.getMaxPrecision(g.precision),f!==g.precision&&We("WebGLProgram.getParameters:",g.precision,"not supported, using",f,"instead."));const O=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,U=O!==void 0?O.length:0;let ce=0;V.morphAttributes.position!==void 0&&(ce=1),V.morphAttributes.normal!==void 0&&(ce=2),V.morphAttributes.color!==void 0&&(ce=3);let he,se,k,q;if(L){const ie=li[L];he=ie.vertexShader,se=ie.fragmentShader}else{he=g.vertexShader,se=g.fragmentShader;const ie=o.getVertexShaderStage(g),ve=o.getFragmentShaderStage(g);o.update(g,ie,ve),k=ie.id,q=ve.id}const K=t.getRenderTarget(),ge=t.state.buffers.depth.getReversed(),me=z.isInstancedMesh===!0,ue=z.isBatchedMesh===!0,Re=!!g.map,Me=!!g.matcap,_e=!!b,we=!!g.aoMap,Fe=!!g.lightMap,Ge=!!g.bumpMap&&g.wireframe===!1,Xe=!!g.normalMap,Ye=!!g.displacementMap,Je=!!g.emissiveMap,Ke=!!g.metalnessMap,et=!!g.roughnessMap,B=g.anisotropy>0,tt=g.clearcoat>0,qe=g.dispersion>0,I=g.iridescence>0,S=g.sheen>0,H=g.transmission>0,Z=B&&!!g.anisotropyMap,oe=tt&&!!g.clearcoatMap,xe=tt&&!!g.clearcoatNormalMap,Ee=tt&&!!g.clearcoatRoughnessMap,de=I&&!!g.iridescenceMap,pe=I&&!!g.iridescenceThicknessMap,be=S&&!!g.sheenColorMap,De=S&&!!g.sheenRoughnessMap,Te=!!g.specularMap,Ce=!!g.specularColorMap,ke=!!g.specularIntensityMap,Oe=H&&!!g.transmissionMap,je=H&&!!g.thicknessMap,G=!!g.gradientMap,Se=!!g.alphaMap,Y=g.alphaTest>0,F=!!g.alphaHash,re=!!g.extensions;let W=mi;g.toneMapped&&(K===null||K.isXRRenderTarget===!0)&&(W=t.toneMapping);const fe={shaderID:L,shaderType:g.type,shaderName:g.name,vertexShader:he,fragmentShader:se,defines:g.defines,customVertexShaderID:k,customFragmentShaderID:q,isRawShaderMaterial:g.isRawShaderMaterial===!0,glslVersion:g.glslVersion,precision:f,batching:ue,batchingColor:ue&&z._colorsTexture!==null,instancing:me,instancingColor:me&&z.instanceColor!==null,instancingMorph:me&&z.morphTexture!==null,outputColorSpace:K===null?t.outputColorSpace:K.isXRRenderTarget===!0?K.texture.colorSpace:at.workingColorSpace,alphaToCoverage:!!g.alphaToCoverage,map:Re,matcap:Me,envMap:_e,envMapMode:_e&&b.mapping,envMapCubeUVHeight:E,aoMap:we,lightMap:Fe,bumpMap:Ge,normalMap:Xe,displacementMap:Ye,emissiveMap:Je,normalMapObjectSpace:Xe&&g.normalMapType===G1,normalMapTangentSpace:Xe&&g.normalMapType===pf,packedNormalMap:Xe&&g.normalMapType===pf&&s2(g.normalMap.format),metalnessMap:Ke,roughnessMap:et,anisotropy:B,anisotropyMap:Z,clearcoat:tt,clearcoatMap:oe,clearcoatNormalMap:xe,clearcoatRoughnessMap:Ee,dispersion:qe,iridescence:I,iridescenceMap:de,iridescenceThicknessMap:pe,sheen:S,sheenColorMap:be,sheenRoughnessMap:De,specularMap:Te,specularColorMap:Ce,specularIntensityMap:ke,transmission:H,transmissionMap:Oe,thicknessMap:je,gradientMap:G,opaque:g.transparent===!1&&g.blending===Us&&g.alphaToCoverage===!1,alphaMap:Se,alphaTest:Y,alphaHash:F,combine:g.combine,mapUv:Re&&_(g.map.channel),aoMapUv:we&&_(g.aoMap.channel),lightMapUv:Fe&&_(g.lightMap.channel),bumpMapUv:Ge&&_(g.bumpMap.channel),normalMapUv:Xe&&_(g.normalMap.channel),displacementMapUv:Ye&&_(g.displacementMap.channel),emissiveMapUv:Je&&_(g.emissiveMap.channel),metalnessMapUv:Ke&&_(g.metalnessMap.channel),roughnessMapUv:et&&_(g.roughnessMap.channel),anisotropyMapUv:Z&&_(g.anisotropyMap.channel),clearcoatMapUv:oe&&_(g.clearcoatMap.channel),clearcoatNormalMapUv:xe&&_(g.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ee&&_(g.clearcoatRoughnessMap.channel),iridescenceMapUv:de&&_(g.iridescenceMap.channel),iridescenceThicknessMapUv:pe&&_(g.iridescenceThicknessMap.channel),sheenColorMapUv:be&&_(g.sheenColorMap.channel),sheenRoughnessMapUv:De&&_(g.sheenRoughnessMap.channel),specularMapUv:Te&&_(g.specularMap.channel),specularColorMapUv:Ce&&_(g.specularColorMap.channel),specularIntensityMapUv:ke&&_(g.specularIntensityMap.channel),transmissionMapUv:Oe&&_(g.transmissionMap.channel),thicknessMapUv:je&&_(g.thicknessMap.channel),alphaMapUv:Se&&_(g.alphaMap.channel),vertexTangents:!!V.attributes.tangent&&(Xe||B),vertexNormals:!!V.attributes.normal,vertexColors:g.vertexColors,vertexAlphas:g.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,pointsUvs:z.isPoints===!0&&!!V.attributes.uv&&(Re||Se),fog:!!ne,useFog:g.fog===!0,fogExp2:!!ne&&ne.isFogExp2,flatShading:g.wireframe===!1&&(g.flatShading===!0||V.attributes.normal===void 0&&Xe===!1&&(g.isMeshLambertMaterial||g.isMeshPhongMaterial||g.isMeshStandardMaterial||g.isMeshPhysicalMaterial)),sizeAttenuation:g.sizeAttenuation===!0,logarithmicDepthBuffer:p,reversedDepthBuffer:ge,skinning:z.isSkinnedMesh===!0,hasPositionAttribute:V.attributes.position!==void 0,morphTargets:V.morphAttributes.position!==void 0,morphNormals:V.morphAttributes.normal!==void 0,morphColors:V.morphAttributes.color!==void 0,morphTargetsCount:U,morphTextureStride:ce,numDirLights:R.directional.length,numPointLights:R.point.length,numSpotLights:R.spot.length,numSpotLightMaps:R.spotLightMap.length,numRectAreaLights:R.rectArea.length,numHemiLights:R.hemi.length,numDirLightShadows:R.directionalShadowMap.length,numPointLightShadows:R.pointShadowMap.length,numSpotLightShadows:R.spotShadowMap.length,numSpotLightShadowsWithMaps:R.numSpotLightShadowsWithMaps,numLightProbes:R.numLightProbes,numLightProbeGrids:j.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:g.dithering,shadowMapEnabled:t.shadowMap.enabled&&C.length>0,shadowMapType:t.shadowMap.type,toneMapping:W,decodeVideoTexture:Re&&g.map.isVideoTexture===!0&&at.getTransfer(g.map.colorSpace)===pt,decodeVideoTextureEmissive:Je&&g.emissiveMap.isVideoTexture===!0&&at.getTransfer(g.emissiveMap.colorSpace)===pt,premultipliedAlpha:g.premultipliedAlpha,doubleSided:g.side===ui,flipSided:g.side===yn,useDepthPacking:g.depthPacking>=0,depthPacking:g.depthPacking||0,index0AttributeName:g.index0AttributeName,extensionClipCullDistance:re&&g.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(re&&g.extensions.multiDraw===!0||ue)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:g.customProgramCacheKey()};return fe.vertexUv1s=c.has(1),fe.vertexUv2s=c.has(2),fe.vertexUv3s=c.has(3),c.clear(),fe}function x(g){const R=[];if(g.shaderID?R.push(g.shaderID):(R.push(g.customVertexShaderID),R.push(g.customFragmentShaderID)),g.defines!==void 0)for(const C in g.defines)R.push(C),R.push(g.defines[C]);return g.isRawShaderMaterial===!1&&(d(R,g),v(R,g),R.push(t.outputColorSpace)),R.push(g.customProgramCacheKey),R.join()}function d(g,R){g.push(R.precision),g.push(R.outputColorSpace),g.push(R.envMapMode),g.push(R.envMapCubeUVHeight),g.push(R.mapUv),g.push(R.alphaMapUv),g.push(R.lightMapUv),g.push(R.aoMapUv),g.push(R.bumpMapUv),g.push(R.normalMapUv),g.push(R.displacementMapUv),g.push(R.emissiveMapUv),g.push(R.metalnessMapUv),g.push(R.roughnessMapUv),g.push(R.anisotropyMapUv),g.push(R.clearcoatMapUv),g.push(R.clearcoatNormalMapUv),g.push(R.clearcoatRoughnessMapUv),g.push(R.iridescenceMapUv),g.push(R.iridescenceThicknessMapUv),g.push(R.sheenColorMapUv),g.push(R.sheenRoughnessMapUv),g.push(R.specularMapUv),g.push(R.specularColorMapUv),g.push(R.specularIntensityMapUv),g.push(R.transmissionMapUv),g.push(R.thicknessMapUv),g.push(R.combine),g.push(R.fogExp2),g.push(R.sizeAttenuation),g.push(R.morphTargetsCount),g.push(R.morphAttributeCount),g.push(R.numDirLights),g.push(R.numPointLights),g.push(R.numSpotLights),g.push(R.numSpotLightMaps),g.push(R.numHemiLights),g.push(R.numRectAreaLights),g.push(R.numDirLightShadows),g.push(R.numPointLightShadows),g.push(R.numSpotLightShadows),g.push(R.numSpotLightShadowsWithMaps),g.push(R.numLightProbes),g.push(R.shadowMapType),g.push(R.toneMapping),g.push(R.numClippingPlanes),g.push(R.numClipIntersection),g.push(R.depthPacking)}function v(g,R){a.disableAll(),R.instancing&&a.enable(0),R.instancingColor&&a.enable(1),R.instancingMorph&&a.enable(2),R.matcap&&a.enable(3),R.envMap&&a.enable(4),R.normalMapObjectSpace&&a.enable(5),R.normalMapTangentSpace&&a.enable(6),R.clearcoat&&a.enable(7),R.iridescence&&a.enable(8),R.alphaTest&&a.enable(9),R.vertexColors&&a.enable(10),R.vertexAlphas&&a.enable(11),R.vertexUv1s&&a.enable(12),R.vertexUv2s&&a.enable(13),R.vertexUv3s&&a.enable(14),R.vertexTangents&&a.enable(15),R.anisotropy&&a.enable(16),R.alphaHash&&a.enable(17),R.batching&&a.enable(18),R.dispersion&&a.enable(19),R.batchingColor&&a.enable(20),R.gradientMap&&a.enable(21),R.packedNormalMap&&a.enable(22),R.vertexNormals&&a.enable(23),g.push(a.mask),a.disableAll(),R.fog&&a.enable(0),R.useFog&&a.enable(1),R.flatShading&&a.enable(2),R.logarithmicDepthBuffer&&a.enable(3),R.reversedDepthBuffer&&a.enable(4),R.skinning&&a.enable(5),R.morphTargets&&a.enable(6),R.morphNormals&&a.enable(7),R.morphColors&&a.enable(8),R.premultipliedAlpha&&a.enable(9),R.shadowMapEnabled&&a.enable(10),R.doubleSided&&a.enable(11),R.flipSided&&a.enable(12),R.useDepthPacking&&a.enable(13),R.dithering&&a.enable(14),R.transmission&&a.enable(15),R.sheen&&a.enable(16),R.opaque&&a.enable(17),R.pointsUvs&&a.enable(18),R.decodeVideoTexture&&a.enable(19),R.decodeVideoTextureEmissive&&a.enable(20),R.alphaToCoverage&&a.enable(21),R.numLightProbeGrids>0&&a.enable(22),R.hasPositionAttribute&&a.enable(23),g.push(a.mask)}function M(g){const R=m[g.type];let C;if(R){const D=li[R];C=CM.clone(D.uniforms)}else C=g.uniforms;return C}function y(g,R){let C=h.get(R);return C!==void 0?++C.usedTimes:(C=new t2(t,R,g,r),u.push(C),h.set(R,C)),C}function T(g){if(--g.usedTimes===0){const R=u.indexOf(g);u[R]=u[u.length-1],u.pop(),h.delete(g.cacheKey),g.destroy()}}function A(g){o.remove(g)}function P(){o.dispose()}return{getParameters:w,getProgramCacheKey:x,getUniforms:M,acquireProgram:y,releaseProgram:T,releaseShaderCache:A,programs:u,dispose:P}}function o2(){let t=new WeakMap;function e(a){return t.has(a)}function n(a){let o=t.get(a);return o===void 0&&(o={},t.set(a,o)),o}function i(a){t.delete(a)}function r(a,o,c){t.get(a)[o]=c}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function l2(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.materialVariant!==e.materialVariant?t.materialVariant-e.materialVariant:t.z!==e.z?t.z-e.z:t.id-e.id}function u0(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function d0(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function a(f){let m=0;return f.isInstancedMesh&&(m+=2),f.isSkinnedMesh&&(m+=1),m}function o(f,m,_,w,x,d){let v=t[e];return v===void 0?(v={id:f.id,object:f,geometry:m,material:_,materialVariant:a(f),groupOrder:w,renderOrder:f.renderOrder,z:x,group:d},t[e]=v):(v.id=f.id,v.object=f,v.geometry=m,v.material=_,v.materialVariant=a(f),v.groupOrder=w,v.renderOrder=f.renderOrder,v.z=x,v.group=d),e++,v}function c(f,m,_,w,x,d){const v=o(f,m,_,w,x,d);_.transmission>0?i.push(v):_.transparent===!0?r.push(v):n.push(v)}function u(f,m,_,w,x,d){const v=o(f,m,_,w,x,d);_.transmission>0?i.unshift(v):_.transparent===!0?r.unshift(v):n.unshift(v)}function h(f,m,_){n.length>1&&n.sort(f||l2),i.length>1&&i.sort(m||u0),r.length>1&&r.sort(m||u0),_&&(n.reverse(),i.reverse(),r.reverse())}function p(){for(let f=e,m=t.length;f<m;f++){const _=t[f];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:c,unshift:u,finish:p,sort:h}}function c2(){let t=new WeakMap;function e(i,r){const s=t.get(i);let a;return s===void 0?(a=new d0,t.set(i,[a])):r>=s.length?(a=new d0,s.push(a)):a=s[r],a}function n(){t=new WeakMap}return{get:e,dispose:n}}function u2(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new J,color:new dt};break;case"SpotLight":n={position:new J,direction:new J,color:new dt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new J,color:new dt,distance:0,decay:0};break;case"HemisphereLight":n={direction:new J,skyColor:new dt,groundColor:new dt};break;case"RectAreaLight":n={color:new dt,position:new J,halfWidth:new J,halfHeight:new J};break}return t[e.id]=n,n}}}function d2(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new lt};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new lt};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new lt,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let f2=0;function h2(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function p2(t){const e=new u2,n=d2(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let u=0;u<9;u++)i.probe.push(new J);const r=new J,s=new Pt,a=new Pt;function o(u){let h=0,p=0,f=0;for(let R=0;R<9;R++)i.probe[R].set(0,0,0);let m=0,_=0,w=0,x=0,d=0,v=0,M=0,y=0,T=0,A=0,P=0;u.sort(h2);for(let R=0,C=u.length;R<C;R++){const D=u[R],z=D.color,j=D.intensity,ne=D.distance;let V=null;if(D.shadow&&D.shadow.map&&(D.shadow.map.texture.format===Xr?V=D.shadow.map.texture:V=D.shadow.map.depthTexture||D.shadow.map.texture),D.isAmbientLight)h+=z.r*j,p+=z.g*j,f+=z.b*j;else if(D.isLightProbe){for(let Q=0;Q<9;Q++)i.probe[Q].addScaledVector(D.sh.coefficients[Q],j);P++}else if(D.isDirectionalLight){const Q=e.get(D);if(Q.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){const $=D.shadow,b=n.get(D);b.shadowIntensity=$.intensity,b.shadowBias=$.bias,b.shadowNormalBias=$.normalBias,b.shadowRadius=$.radius,b.shadowMapSize=$.mapSize,i.directionalShadow[m]=b,i.directionalShadowMap[m]=V,i.directionalShadowMatrix[m]=D.shadow.matrix,v++}i.directional[m]=Q,m++}else if(D.isSpotLight){const Q=e.get(D);Q.position.setFromMatrixPosition(D.matrixWorld),Q.color.copy(z).multiplyScalar(j),Q.distance=ne,Q.coneCos=Math.cos(D.angle),Q.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),Q.decay=D.decay,i.spot[w]=Q;const $=D.shadow;if(D.map&&(i.spotLightMap[T]=D.map,T++,$.updateMatrices(D),D.castShadow&&A++),i.spotLightMatrix[w]=$.matrix,D.castShadow){const b=n.get(D);b.shadowIntensity=$.intensity,b.shadowBias=$.bias,b.shadowNormalBias=$.normalBias,b.shadowRadius=$.radius,b.shadowMapSize=$.mapSize,i.spotShadow[w]=b,i.spotShadowMap[w]=V,y++}w++}else if(D.isRectAreaLight){const Q=e.get(D);Q.color.copy(z).multiplyScalar(j),Q.halfWidth.set(D.width*.5,0,0),Q.halfHeight.set(0,D.height*.5,0),i.rectArea[x]=Q,x++}else if(D.isPointLight){const Q=e.get(D);if(Q.color.copy(D.color).multiplyScalar(D.intensity),Q.distance=D.distance,Q.decay=D.decay,D.castShadow){const $=D.shadow,b=n.get(D);b.shadowIntensity=$.intensity,b.shadowBias=$.bias,b.shadowNormalBias=$.normalBias,b.shadowRadius=$.radius,b.shadowMapSize=$.mapSize,b.shadowCameraNear=$.camera.near,b.shadowCameraFar=$.camera.far,i.pointShadow[_]=b,i.pointShadowMap[_]=V,i.pointShadowMatrix[_]=D.shadow.matrix,M++}i.point[_]=Q,_++}else if(D.isHemisphereLight){const Q=e.get(D);Q.skyColor.copy(D.color).multiplyScalar(j),Q.groundColor.copy(D.groundColor).multiplyScalar(j),i.hemi[d]=Q,d++}}x>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Ae.LTC_FLOAT_1,i.rectAreaLTC2=Ae.LTC_FLOAT_2):(i.rectAreaLTC1=Ae.LTC_HALF_1,i.rectAreaLTC2=Ae.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=p,i.ambient[2]=f;const g=i.hash;(g.directionalLength!==m||g.pointLength!==_||g.spotLength!==w||g.rectAreaLength!==x||g.hemiLength!==d||g.numDirectionalShadows!==v||g.numPointShadows!==M||g.numSpotShadows!==y||g.numSpotMaps!==T||g.numLightProbes!==P)&&(i.directional.length=m,i.spot.length=w,i.rectArea.length=x,i.point.length=_,i.hemi.length=d,i.directionalShadow.length=v,i.directionalShadowMap.length=v,i.pointShadow.length=M,i.pointShadowMap.length=M,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=v,i.pointShadowMatrix.length=M,i.spotLightMatrix.length=y+T-A,i.spotLightMap.length=T,i.numSpotLightShadowsWithMaps=A,i.numLightProbes=P,g.directionalLength=m,g.pointLength=_,g.spotLength=w,g.rectAreaLength=x,g.hemiLength=d,g.numDirectionalShadows=v,g.numPointShadows=M,g.numSpotShadows=y,g.numSpotMaps=T,g.numLightProbes=P,i.version=f2++)}function c(u,h){let p=0,f=0,m=0,_=0,w=0;const x=h.matrixWorldInverse;for(let d=0,v=u.length;d<v;d++){const M=u[d];if(M.isDirectionalLight){const y=i.directional[p];y.direction.setFromMatrixPosition(M.matrixWorld),r.setFromMatrixPosition(M.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(x),p++}else if(M.isSpotLight){const y=i.spot[m];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(x),y.direction.setFromMatrixPosition(M.matrixWorld),r.setFromMatrixPosition(M.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(x),m++}else if(M.isRectAreaLight){const y=i.rectArea[_];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(x),a.identity(),s.copy(M.matrixWorld),s.premultiply(x),a.extractRotation(s),y.halfWidth.set(M.width*.5,0,0),y.halfHeight.set(0,M.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),_++}else if(M.isPointLight){const y=i.point[f];y.position.setFromMatrixPosition(M.matrixWorld),y.position.applyMatrix4(x),f++}else if(M.isHemisphereLight){const y=i.hemi[w];y.direction.setFromMatrixPosition(M.matrixWorld),y.direction.transformDirection(x),w++}}}return{setup:o,setupView:c,state:i}}function f0(t){const e=new p2(t),n=[],i=[],r=[];function s(f){p.camera=f,n.length=0,i.length=0,r.length=0}function a(f){n.push(f)}function o(f){i.push(f)}function c(f){r.push(f)}function u(){e.setup(n)}function h(f){e.setupView(n,f)}const p={lightsArray:n,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:p,setupLights:u,setupLightsView:h,pushLight:a,pushShadow:o,pushLightProbeGrid:c}}function m2(t){let e=new WeakMap;function n(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new f0(t),e.set(r,[o])):s>=a.length?(o=new f0(t),a.push(o)):o=a[s],o}function i(){e=new WeakMap}return{get:n,dispose:i}}const g2=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,v2=[new J(1,0,0),new J(-1,0,0),new J(0,1,0),new J(0,-1,0),new J(0,0,1),new J(0,0,-1)],_2=[new J(0,-1,0),new J(0,-1,0),new J(0,0,1),new J(0,0,-1),new J(0,-1,0),new J(0,-1,0)],h0=new Pt,ma=new J,Nu=new J;function y2(t,e,n){let i=new Ch;const r=new lt,s=new lt,a=new Tt,o=new PM,c=new LM,u={},h=n.maxTextureSize,p={[gr]:yn,[yn]:gr,[ui]:ui},f=new _i({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new lt},radius:{value:4}},vertexShader:g2,fragmentShader:x2}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const _=new ni;_.setAttribute("position",new xi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new en(_,f),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Da;let d=this.type;this.render=function(A,P,g){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||A.length===0)return;this.type===y1&&(We("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Da);const R=t.getRenderTarget(),C=t.getActiveCubeFace(),D=t.getActiveMipmapLevel(),z=t.state;z.setBlending(Pi),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const j=d!==this.type;j&&P.traverse(function(ne){ne.material&&(Array.isArray(ne.material)?ne.material.forEach(V=>V.needsUpdate=!0):ne.material.needsUpdate=!0)});for(let ne=0,V=A.length;ne<V;ne++){const Q=A[ne],$=Q.shadow;if($===void 0){We("WebGLShadowMap:",Q,"has no shadow.");continue}if($.autoUpdate===!1&&$.needsUpdate===!1)continue;r.copy($.mapSize);const b=$.getFrameExtents();r.multiply(b),s.copy($.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/b.x),r.x=s.x*b.x,$.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/b.y),r.y=s.y*b.y,$.mapSize.y=s.y));const E=t.state.buffers.depth.getReversed();if($.camera._reversedDepth=E,$.map===null||j===!0){if($.map!==null&&($.map.depthTexture!==null&&($.map.depthTexture.dispose(),$.map.depthTexture=null),$.map.dispose()),this.type===ya){if(Q.isPointLight){We("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}$.map=new gi(r.x,r.y,{format:Xr,type:ki,minFilter:nn,magFilter:nn,generateMipmaps:!1}),$.map.texture.name=Q.name+".shadowMap",$.map.depthTexture=new $s(r.x,r.y,di),$.map.depthTexture.name=Q.name+".shadowMapDepth",$.map.depthTexture.format=Oi,$.map.depthTexture.compareFunction=null,$.map.depthTexture.minFilter=Xt,$.map.depthTexture.magFilter=Xt}else Q.isPointLight?($.map=new gv(r.x),$.map.depthTexture=new bM(r.x,vi)):($.map=new gi(r.x,r.y),$.map.depthTexture=new $s(r.x,r.y,vi)),$.map.depthTexture.name=Q.name+".shadowMap",$.map.depthTexture.format=Oi,this.type===Da?($.map.depthTexture.compareFunction=E?wh:Mh,$.map.depthTexture.minFilter=nn,$.map.depthTexture.magFilter=nn):($.map.depthTexture.compareFunction=null,$.map.depthTexture.minFilter=Xt,$.map.depthTexture.magFilter=Xt);$.camera.updateProjectionMatrix()}const L=$.map.isWebGLCubeRenderTarget?6:1;for(let O=0;O<L;O++){if($.map.isWebGLCubeRenderTarget)t.setRenderTarget($.map,O),t.clear();else{O===0&&(t.setRenderTarget($.map),t.clear());const U=$.getViewport(O);a.set(s.x*U.x,s.y*U.y,s.x*U.z,s.y*U.w),z.viewport(a)}if(Q.isPointLight){const U=$.camera,ce=$.matrix,he=Q.distance||U.far;he!==U.far&&(U.far=he,U.updateProjectionMatrix()),ma.setFromMatrixPosition(Q.matrixWorld),U.position.copy(ma),Nu.copy(U.position),Nu.add(v2[O]),U.up.copy(_2[O]),U.lookAt(Nu),U.updateMatrixWorld(),ce.makeTranslation(-ma.x,-ma.y,-ma.z),h0.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),$._frustum.setFromProjectionMatrix(h0,U.coordinateSystem,U.reversedDepth)}else $.updateMatrices(Q);i=$.getFrustum(),y(P,g,$.camera,Q,this.type)}$.isPointLightShadow!==!0&&this.type===ya&&v($,g),$.needsUpdate=!1}d=this.type,x.needsUpdate=!1,t.setRenderTarget(R,C,D)};function v(A,P){const g=e.update(w);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,m.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new gi(r.x,r.y,{format:Xr,type:ki})),f.uniforms.shadow_pass.value=A.map.depthTexture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,t.setRenderTarget(A.mapPass),t.clear(),t.renderBufferDirect(P,null,g,f,w,null),m.uniforms.shadow_pass.value=A.mapPass.texture,m.uniforms.resolution.value=A.mapSize,m.uniforms.radius.value=A.radius,t.setRenderTarget(A.map),t.clear(),t.renderBufferDirect(P,null,g,m,w,null)}function M(A,P,g,R){let C=null;const D=g.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)C=D;else if(C=g.isPointLight===!0?c:o,t.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const z=C.uuid,j=P.uuid;let ne=u[z];ne===void 0&&(ne={},u[z]=ne);let V=ne[j];V===void 0&&(V=C.clone(),ne[j]=V,P.addEventListener("dispose",T)),C=V}if(C.visible=P.visible,C.wireframe=P.wireframe,R===ya?C.side=P.shadowSide!==null?P.shadowSide:P.side:C.side=P.shadowSide!==null?P.shadowSide:p[P.side],C.alphaMap=P.alphaMap,C.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,C.map=P.map,C.clipShadows=P.clipShadows,C.clippingPlanes=P.clippingPlanes,C.clipIntersection=P.clipIntersection,C.displacementMap=P.displacementMap,C.displacementScale=P.displacementScale,C.displacementBias=P.displacementBias,C.wireframeLinewidth=P.wireframeLinewidth,C.linewidth=P.linewidth,g.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const z=t.properties.get(C);z.light=g}return C}function y(A,P,g,R,C){if(A.visible===!1)return;if(A.layers.test(P.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&C===ya)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(g.matrixWorldInverse,A.matrixWorld);const j=e.update(A),ne=A.material;if(Array.isArray(ne)){const V=j.groups;for(let Q=0,$=V.length;Q<$;Q++){const b=V[Q],E=ne[b.materialIndex];if(E&&E.visible){const L=M(A,E,R,C);A.onBeforeShadow(t,A,P,g,j,L,b),t.renderBufferDirect(g,null,j,L,A,b),A.onAfterShadow(t,A,P,g,j,L,b)}}}else if(ne.visible){const V=M(A,ne,R,C);A.onBeforeShadow(t,A,P,g,j,V,null),t.renderBufferDirect(g,null,j,V,A,null),A.onAfterShadow(t,A,P,g,j,V,null)}}const z=A.children;for(let j=0,ne=z.length;j<ne;j++)y(z[j],P,g,R,C)}function T(A){A.target.removeEventListener("dispose",T);for(const g in u){const R=u[g],C=A.target.uuid;C in R&&(R[C].dispose(),delete R[C])}}}function S2(t,e){function n(){let G=!1;const Se=new Tt;let Y=null;const F=new Tt(0,0,0,0);return{setMask:function(re){Y!==re&&!G&&(t.colorMask(re,re,re,re),Y=re)},setLocked:function(re){G=re},setClear:function(re,W,fe,ie,ve){ve===!0&&(re*=ie,W*=ie,fe*=ie),Se.set(re,W,fe,ie),F.equals(Se)===!1&&(t.clearColor(re,W,fe,ie),F.copy(Se))},reset:function(){G=!1,Y=null,F.set(-1,0,0,0)}}}function i(){let G=!1,Se=!1,Y=null,F=null,re=null;return{setReversed:function(W){if(Se!==W){const fe=e.get("EXT_clip_control");W?fe.clipControlEXT(fe.LOWER_LEFT_EXT,fe.ZERO_TO_ONE_EXT):fe.clipControlEXT(fe.LOWER_LEFT_EXT,fe.NEGATIVE_ONE_TO_ONE_EXT),Se=W;const ie=re;re=null,this.setClear(ie)}},getReversed:function(){return Se},setTest:function(W){W?K(t.DEPTH_TEST):ge(t.DEPTH_TEST)},setMask:function(W){Y!==W&&!G&&(t.depthMask(W),Y=W)},setFunc:function(W){if(Se&&(W=J1[W]),F!==W){switch(W){case Ad:t.depthFunc(t.NEVER);break;case Rd:t.depthFunc(t.ALWAYS);break;case Nd:t.depthFunc(t.LESS);break;case Xs:t.depthFunc(t.LEQUAL);break;case Pd:t.depthFunc(t.EQUAL);break;case Ld:t.depthFunc(t.GEQUAL);break;case Dd:t.depthFunc(t.GREATER);break;case Id:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}F=W}},setLocked:function(W){G=W},setClear:function(W){re!==W&&(re=W,Se&&(W=1-W),t.clearDepth(W))},reset:function(){G=!1,Y=null,F=null,re=null,Se=!1}}}function r(){let G=!1,Se=null,Y=null,F=null,re=null,W=null,fe=null,ie=null,ve=null;return{setTest:function(ze){G||(ze?K(t.STENCIL_TEST):ge(t.STENCIL_TEST))},setMask:function(ze){Se!==ze&&!G&&(t.stencilMask(ze),Se=ze)},setFunc:function(ze,Ze,ht){(Y!==ze||F!==Ze||re!==ht)&&(t.stencilFunc(ze,Ze,ht),Y=ze,F=Ze,re=ht)},setOp:function(ze,Ze,ht){(W!==ze||fe!==Ze||ie!==ht)&&(t.stencilOp(ze,Ze,ht),W=ze,fe=Ze,ie=ht)},setLocked:function(ze){G=ze},setClear:function(ze){ve!==ze&&(t.clearStencil(ze),ve=ze)},reset:function(){G=!1,Se=null,Y=null,F=null,re=null,W=null,fe=null,ie=null,ve=null}}}const s=new n,a=new i,o=new r,c=new WeakMap,u=new WeakMap;let h={},p={},f={},m=new WeakMap,_=[],w=null,x=!1,d=null,v=null,M=null,y=null,T=null,A=null,P=null,g=new dt(0,0,0),R=0,C=!1,D=null,z=null,j=null,ne=null,V=null;const Q=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let $=!1,b=0;const E=t.getParameter(t.VERSION);E.indexOf("WebGL")!==-1?(b=parseFloat(/^WebGL (\d)/.exec(E)[1]),$=b>=1):E.indexOf("OpenGL ES")!==-1&&(b=parseFloat(/^OpenGL ES (\d)/.exec(E)[1]),$=b>=2);let L=null,O={};const U=t.getParameter(t.SCISSOR_BOX),ce=t.getParameter(t.VIEWPORT),he=new Tt().fromArray(U),se=new Tt().fromArray(ce);function k(G,Se,Y,F){const re=new Uint8Array(4),W=t.createTexture();t.bindTexture(G,W),t.texParameteri(G,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(G,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let fe=0;fe<Y;fe++)G===t.TEXTURE_3D||G===t.TEXTURE_2D_ARRAY?t.texImage3D(Se,0,t.RGBA,1,1,F,0,t.RGBA,t.UNSIGNED_BYTE,re):t.texImage2D(Se+fe,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,re);return W}const q={};q[t.TEXTURE_2D]=k(t.TEXTURE_2D,t.TEXTURE_2D,1),q[t.TEXTURE_CUBE_MAP]=k(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[t.TEXTURE_2D_ARRAY]=k(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),q[t.TEXTURE_3D]=k(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),K(t.DEPTH_TEST),a.setFunc(Xs),Ge(!1),Xe(pm),K(t.CULL_FACE),we(Pi);function K(G){h[G]!==!0&&(t.enable(G),h[G]=!0)}function ge(G){h[G]!==!1&&(t.disable(G),h[G]=!1)}function me(G,Se){return f[G]!==Se?(t.bindFramebuffer(G,Se),f[G]=Se,G===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=Se),G===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=Se),!0):!1}function ue(G,Se){let Y=_,F=!1;if(G){Y=m.get(Se),Y===void 0&&(Y=[],m.set(Se,Y));const re=G.textures;if(Y.length!==re.length||Y[0]!==t.COLOR_ATTACHMENT0){for(let W=0,fe=re.length;W<fe;W++)Y[W]=t.COLOR_ATTACHMENT0+W;Y.length=re.length,F=!0}}else Y[0]!==t.BACK&&(Y[0]=t.BACK,F=!0);F&&t.drawBuffers(Y)}function Re(G){return w!==G?(t.useProgram(G),w=G,!0):!1}const Me={[Nr]:t.FUNC_ADD,[M1]:t.FUNC_SUBTRACT,[w1]:t.FUNC_REVERSE_SUBTRACT};Me[E1]=t.MIN,Me[b1]=t.MAX;const _e={[T1]:t.ZERO,[C1]:t.ONE,[A1]:t.SRC_COLOR,[Td]:t.SRC_ALPHA,[I1]:t.SRC_ALPHA_SATURATE,[L1]:t.DST_COLOR,[N1]:t.DST_ALPHA,[R1]:t.ONE_MINUS_SRC_COLOR,[Cd]:t.ONE_MINUS_SRC_ALPHA,[D1]:t.ONE_MINUS_DST_COLOR,[P1]:t.ONE_MINUS_DST_ALPHA,[U1]:t.CONSTANT_COLOR,[F1]:t.ONE_MINUS_CONSTANT_COLOR,[k1]:t.CONSTANT_ALPHA,[O1]:t.ONE_MINUS_CONSTANT_ALPHA};function we(G,Se,Y,F,re,W,fe,ie,ve,ze){if(G===Pi){x===!0&&(ge(t.BLEND),x=!1);return}if(x===!1&&(K(t.BLEND),x=!0),G!==S1){if(G!==d||ze!==C){if((v!==Nr||T!==Nr)&&(t.blendEquation(t.FUNC_ADD),v=Nr,T=Nr),ze)switch(G){case Us:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case mm:t.blendFunc(t.ONE,t.ONE);break;case gm:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case xm:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:ut("WebGLState: Invalid blending: ",G);break}else switch(G){case Us:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case mm:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case gm:ut("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case xm:ut("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ut("WebGLState: Invalid blending: ",G);break}M=null,y=null,A=null,P=null,g.set(0,0,0),R=0,d=G,C=ze}return}re=re||Se,W=W||Y,fe=fe||F,(Se!==v||re!==T)&&(t.blendEquationSeparate(Me[Se],Me[re]),v=Se,T=re),(Y!==M||F!==y||W!==A||fe!==P)&&(t.blendFuncSeparate(_e[Y],_e[F],_e[W],_e[fe]),M=Y,y=F,A=W,P=fe),(ie.equals(g)===!1||ve!==R)&&(t.blendColor(ie.r,ie.g,ie.b,ve),g.copy(ie),R=ve),d=G,C=!1}function Fe(G,Se){G.side===ui?ge(t.CULL_FACE):K(t.CULL_FACE);let Y=G.side===yn;Se&&(Y=!Y),Ge(Y),G.blending===Us&&G.transparent===!1?we(Pi):we(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),a.setFunc(G.depthFunc),a.setTest(G.depthTest),a.setMask(G.depthWrite),s.setMask(G.colorWrite);const F=G.stencilWrite;o.setTest(F),F&&(o.setMask(G.stencilWriteMask),o.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),o.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),Je(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?K(t.SAMPLE_ALPHA_TO_COVERAGE):ge(t.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(G){D!==G&&(G?t.frontFace(t.CW):t.frontFace(t.CCW),D=G)}function Xe(G){G!==v1?(K(t.CULL_FACE),G!==z&&(G===pm?t.cullFace(t.BACK):G===_1?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):ge(t.CULL_FACE),z=G}function Ye(G){G!==j&&($&&t.lineWidth(G),j=G)}function Je(G,Se,Y){G?(K(t.POLYGON_OFFSET_FILL),(ne!==Se||V!==Y)&&(ne=Se,V=Y,a.getReversed()&&(Se=-Se),t.polygonOffset(Se,Y))):ge(t.POLYGON_OFFSET_FILL)}function Ke(G){G?K(t.SCISSOR_TEST):ge(t.SCISSOR_TEST)}function et(G){G===void 0&&(G=t.TEXTURE0+Q-1),L!==G&&(t.activeTexture(G),L=G)}function B(G,Se,Y){Y===void 0&&(L===null?Y=t.TEXTURE0+Q-1:Y=L);let F=O[Y];F===void 0&&(F={type:void 0,texture:void 0},O[Y]=F),(F.type!==G||F.texture!==Se)&&(L!==Y&&(t.activeTexture(Y),L=Y),t.bindTexture(G,Se||q[G]),F.type=G,F.texture=Se)}function tt(){const G=O[L];G!==void 0&&G.type!==void 0&&(t.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function qe(){try{t.compressedTexImage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function I(){try{t.compressedTexImage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function S(){try{t.texSubImage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function H(){try{t.texSubImage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function Z(){try{t.compressedTexSubImage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function oe(){try{t.compressedTexSubImage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function xe(){try{t.texStorage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function Ee(){try{t.texStorage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function de(){try{t.texImage2D(...arguments)}catch(G){ut("WebGLState:",G)}}function pe(){try{t.texImage3D(...arguments)}catch(G){ut("WebGLState:",G)}}function be(G){return p[G]!==void 0?p[G]:t.getParameter(G)}function De(G,Se){p[G]!==Se&&(t.pixelStorei(G,Se),p[G]=Se)}function Te(G){he.equals(G)===!1&&(t.scissor(G.x,G.y,G.z,G.w),he.copy(G))}function Ce(G){se.equals(G)===!1&&(t.viewport(G.x,G.y,G.z,G.w),se.copy(G))}function ke(G,Se){let Y=u.get(Se);Y===void 0&&(Y=new WeakMap,u.set(Se,Y));let F=Y.get(G);F===void 0&&(F=t.getUniformBlockIndex(Se,G.name),Y.set(G,F))}function Oe(G,Se){const F=u.get(Se).get(G);c.get(Se)!==F&&(t.uniformBlockBinding(Se,F,G.__bindingPointIndex),c.set(Se,F))}function je(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),h={},p={},L=null,O={},f={},m=new WeakMap,_=[],w=null,x=!1,d=null,v=null,M=null,y=null,T=null,A=null,P=null,g=new dt(0,0,0),R=0,C=!1,D=null,z=null,j=null,ne=null,V=null,he.set(0,0,t.canvas.width,t.canvas.height),se.set(0,0,t.canvas.width,t.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:K,disable:ge,bindFramebuffer:me,drawBuffers:ue,useProgram:Re,setBlending:we,setMaterial:Fe,setFlipSided:Ge,setCullFace:Xe,setLineWidth:Ye,setPolygonOffset:Je,setScissorTest:Ke,activeTexture:et,bindTexture:B,unbindTexture:tt,compressedTexImage2D:qe,compressedTexImage3D:I,texImage2D:de,texImage3D:pe,pixelStorei:De,getParameter:be,updateUBOMapping:ke,uniformBlockBinding:Oe,texStorage2D:xe,texStorage3D:Ee,texSubImage2D:S,texSubImage3D:H,compressedTexSubImage2D:Z,compressedTexSubImage3D:oe,scissor:Te,viewport:Ce,reset:je}}function M2(t,e,n,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new lt,h=new WeakMap,p=new Set;let f;const m=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function w(I,S){return _?new OffscreenCanvas(I,S):Yl("canvas")}function x(I,S,H){let Z=1;const oe=qe(I);if((oe.width>H||oe.height>H)&&(Z=H/Math.max(oe.width,oe.height)),Z<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const xe=Math.floor(Z*oe.width),Ee=Math.floor(Z*oe.height);f===void 0&&(f=w(xe,Ee));const de=S?w(xe,Ee):f;return de.width=xe,de.height=Ee,de.getContext("2d").drawImage(I,0,0,xe,Ee),We("WebGLRenderer: Texture has been resized from ("+oe.width+"x"+oe.height+") to ("+xe+"x"+Ee+")."),de}else return"data"in I&&We("WebGLRenderer: Image in DataTexture is too big ("+oe.width+"x"+oe.height+")."),I;return I}function d(I){return I.generateMipmaps}function v(I){t.generateMipmap(I)}function M(I){return I.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?t.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(I,S,H,Z,oe,xe=!1){if(I!==null){if(t[I]!==void 0)return t[I];We("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let Ee;Z&&(Ee=e.get("EXT_texture_norm16"),Ee||We("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let de=S;if(S===t.RED&&(H===t.FLOAT&&(de=t.R32F),H===t.HALF_FLOAT&&(de=t.R16F),H===t.UNSIGNED_BYTE&&(de=t.R8),H===t.UNSIGNED_SHORT&&Ee&&(de=Ee.R16_EXT),H===t.SHORT&&Ee&&(de=Ee.R16_SNORM_EXT)),S===t.RED_INTEGER&&(H===t.UNSIGNED_BYTE&&(de=t.R8UI),H===t.UNSIGNED_SHORT&&(de=t.R16UI),H===t.UNSIGNED_INT&&(de=t.R32UI),H===t.BYTE&&(de=t.R8I),H===t.SHORT&&(de=t.R16I),H===t.INT&&(de=t.R32I)),S===t.RG&&(H===t.FLOAT&&(de=t.RG32F),H===t.HALF_FLOAT&&(de=t.RG16F),H===t.UNSIGNED_BYTE&&(de=t.RG8),H===t.UNSIGNED_SHORT&&Ee&&(de=Ee.RG16_EXT),H===t.SHORT&&Ee&&(de=Ee.RG16_SNORM_EXT)),S===t.RG_INTEGER&&(H===t.UNSIGNED_BYTE&&(de=t.RG8UI),H===t.UNSIGNED_SHORT&&(de=t.RG16UI),H===t.UNSIGNED_INT&&(de=t.RG32UI),H===t.BYTE&&(de=t.RG8I),H===t.SHORT&&(de=t.RG16I),H===t.INT&&(de=t.RG32I)),S===t.RGB_INTEGER&&(H===t.UNSIGNED_BYTE&&(de=t.RGB8UI),H===t.UNSIGNED_SHORT&&(de=t.RGB16UI),H===t.UNSIGNED_INT&&(de=t.RGB32UI),H===t.BYTE&&(de=t.RGB8I),H===t.SHORT&&(de=t.RGB16I),H===t.INT&&(de=t.RGB32I)),S===t.RGBA_INTEGER&&(H===t.UNSIGNED_BYTE&&(de=t.RGBA8UI),H===t.UNSIGNED_SHORT&&(de=t.RGBA16UI),H===t.UNSIGNED_INT&&(de=t.RGBA32UI),H===t.BYTE&&(de=t.RGBA8I),H===t.SHORT&&(de=t.RGBA16I),H===t.INT&&(de=t.RGBA32I)),S===t.RGB&&(H===t.UNSIGNED_SHORT&&Ee&&(de=Ee.RGB16_EXT),H===t.SHORT&&Ee&&(de=Ee.RGB16_SNORM_EXT),H===t.UNSIGNED_INT_5_9_9_9_REV&&(de=t.RGB9_E5),H===t.UNSIGNED_INT_10F_11F_11F_REV&&(de=t.R11F_G11F_B10F)),S===t.RGBA){const pe=xe?$l:at.getTransfer(oe);H===t.FLOAT&&(de=t.RGBA32F),H===t.HALF_FLOAT&&(de=t.RGBA16F),H===t.UNSIGNED_BYTE&&(de=pe===pt?t.SRGB8_ALPHA8:t.RGBA8),H===t.UNSIGNED_SHORT&&Ee&&(de=Ee.RGBA16_EXT),H===t.SHORT&&Ee&&(de=Ee.RGBA16_SNORM_EXT),H===t.UNSIGNED_SHORT_4_4_4_4&&(de=t.RGBA4),H===t.UNSIGNED_SHORT_5_5_5_1&&(de=t.RGB5_A1)}return(de===t.R16F||de===t.R32F||de===t.RG16F||de===t.RG32F||de===t.RGBA16F||de===t.RGBA32F)&&e.get("EXT_color_buffer_float"),de}function T(I,S){let H;return I?S===null||S===vi||S===Ja?H=t.DEPTH24_STENCIL8:S===di?H=t.DEPTH32F_STENCIL8:S===Qa&&(H=t.DEPTH24_STENCIL8,We("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===vi||S===Ja?H=t.DEPTH_COMPONENT24:S===di?H=t.DEPTH_COMPONENT32F:S===Qa&&(H=t.DEPTH_COMPONENT16),H}function A(I,S){return d(I)===!0||I.isFramebufferTexture&&I.minFilter!==Xt&&I.minFilter!==nn?Math.log2(Math.max(S.width,S.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?S.mipmaps.length:1}function P(I){const S=I.target;S.removeEventListener("dispose",P),R(S),S.isVideoTexture&&h.delete(S),S.isHTMLTexture&&p.delete(S)}function g(I){const S=I.target;S.removeEventListener("dispose",g),D(S)}function R(I){const S=i.get(I);if(S.__webglInit===void 0)return;const H=I.source,Z=m.get(H);if(Z){const oe=Z[S.__cacheKey];oe.usedTimes--,oe.usedTimes===0&&C(I),Object.keys(Z).length===0&&m.delete(H)}i.remove(I)}function C(I){const S=i.get(I);t.deleteTexture(S.__webglTexture);const H=I.source,Z=m.get(H);delete Z[S.__cacheKey],a.memory.textures--}function D(I){const S=i.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),i.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(S.__webglFramebuffer[Z]))for(let oe=0;oe<S.__webglFramebuffer[Z].length;oe++)t.deleteFramebuffer(S.__webglFramebuffer[Z][oe]);else t.deleteFramebuffer(S.__webglFramebuffer[Z]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[Z])}else{if(Array.isArray(S.__webglFramebuffer))for(let Z=0;Z<S.__webglFramebuffer.length;Z++)t.deleteFramebuffer(S.__webglFramebuffer[Z]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Z=0;Z<S.__webglColorRenderbuffer.length;Z++)S.__webglColorRenderbuffer[Z]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[Z]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const H=I.textures;for(let Z=0,oe=H.length;Z<oe;Z++){const xe=i.get(H[Z]);xe.__webglTexture&&(t.deleteTexture(xe.__webglTexture),a.memory.textures--),i.remove(H[Z])}i.remove(I)}let z=0;function j(){z=0}function ne(){return z}function V(I){z=I}function Q(){const I=z;return I>=r.maxTextures&&We("WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+r.maxTextures),z+=1,I}function $(I){const S=[];return S.push(I.wrapS),S.push(I.wrapT),S.push(I.wrapR||0),S.push(I.magFilter),S.push(I.minFilter),S.push(I.anisotropy),S.push(I.internalFormat),S.push(I.format),S.push(I.type),S.push(I.generateMipmaps),S.push(I.premultiplyAlpha),S.push(I.flipY),S.push(I.unpackAlignment),S.push(I.colorSpace),S.join()}function b(I,S){const H=i.get(I);if(I.isVideoTexture&&B(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&H.__version!==I.version){const Z=I.image;if(Z===null)We("WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)We("WebGLRenderer: Texture marked for update but image is incomplete");else{ge(H,I,S);return}}else I.isExternalTexture&&(H.__webglTexture=I.sourceTexture?I.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,H.__webglTexture,t.TEXTURE0+S)}function E(I,S){const H=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&H.__version!==I.version){ge(H,I,S);return}else I.isExternalTexture&&(H.__webglTexture=I.sourceTexture?I.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,H.__webglTexture,t.TEXTURE0+S)}function L(I,S){const H=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&H.__version!==I.version){ge(H,I,S);return}n.bindTexture(t.TEXTURE_3D,H.__webglTexture,t.TEXTURE0+S)}function O(I,S){const H=i.get(I);if(I.isCubeDepthTexture!==!0&&I.version>0&&H.__version!==I.version){me(H,I,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,H.__webglTexture,t.TEXTURE0+S)}const U={[Ud]:t.REPEAT,[Ri]:t.CLAMP_TO_EDGE,[Fd]:t.MIRRORED_REPEAT},ce={[Xt]:t.NEAREST,[V1]:t.NEAREST_MIPMAP_NEAREST,[Po]:t.NEAREST_MIPMAP_LINEAR,[nn]:t.LINEAR,[Qc]:t.LINEAR_MIPMAP_NEAREST,[Ur]:t.LINEAR_MIPMAP_LINEAR},he={[j1]:t.NEVER,[Y1]:t.ALWAYS,[W1]:t.LESS,[Mh]:t.LEQUAL,[X1]:t.EQUAL,[wh]:t.GEQUAL,[q1]:t.GREATER,[$1]:t.NOTEQUAL};function se(I,S){if(S.type===di&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===nn||S.magFilter===Qc||S.magFilter===Po||S.magFilter===Ur||S.minFilter===nn||S.minFilter===Qc||S.minFilter===Po||S.minFilter===Ur)&&We("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(I,t.TEXTURE_WRAP_S,U[S.wrapS]),t.texParameteri(I,t.TEXTURE_WRAP_T,U[S.wrapT]),(I===t.TEXTURE_3D||I===t.TEXTURE_2D_ARRAY)&&t.texParameteri(I,t.TEXTURE_WRAP_R,U[S.wrapR]),t.texParameteri(I,t.TEXTURE_MAG_FILTER,ce[S.magFilter]),t.texParameteri(I,t.TEXTURE_MIN_FILTER,ce[S.minFilter]),S.compareFunction&&(t.texParameteri(I,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(I,t.TEXTURE_COMPARE_FUNC,he[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Xt||S.minFilter!==Po&&S.minFilter!==Ur||S.type===di&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");t.texParameterf(I,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function k(I,S){let H=!1;I.__webglInit===void 0&&(I.__webglInit=!0,S.addEventListener("dispose",P));const Z=S.source;let oe=m.get(Z);oe===void 0&&(oe={},m.set(Z,oe));const xe=$(S);if(xe!==I.__cacheKey){oe[xe]===void 0&&(oe[xe]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,H=!0),oe[xe].usedTimes++;const Ee=oe[I.__cacheKey];Ee!==void 0&&(oe[I.__cacheKey].usedTimes--,Ee.usedTimes===0&&C(S)),I.__cacheKey=xe,I.__webglTexture=oe[xe].texture}return H}function q(I,S,H){return Math.floor(Math.floor(I/H)/S)}function K(I,S,H,Z){const xe=I.updateRanges;if(xe.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,S.width,S.height,H,Z,S.data);else{xe.sort((De,Te)=>De.start-Te.start);let Ee=0;for(let De=1;De<xe.length;De++){const Te=xe[Ee],Ce=xe[De],ke=Te.start+Te.count,Oe=q(Ce.start,S.width,4),je=q(Te.start,S.width,4);Ce.start<=ke+1&&Oe===je&&q(Ce.start+Ce.count-1,S.width,4)===Oe?Te.count=Math.max(Te.count,Ce.start+Ce.count-Te.start):(++Ee,xe[Ee]=Ce)}xe.length=Ee+1;const de=n.getParameter(t.UNPACK_ROW_LENGTH),pe=n.getParameter(t.UNPACK_SKIP_PIXELS),be=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,S.width);for(let De=0,Te=xe.length;De<Te;De++){const Ce=xe[De],ke=Math.floor(Ce.start/4),Oe=Math.ceil(Ce.count/4),je=ke%S.width,G=Math.floor(ke/S.width),Se=Oe,Y=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,je),n.pixelStorei(t.UNPACK_SKIP_ROWS,G),n.texSubImage2D(t.TEXTURE_2D,0,je,G,Se,Y,H,Z,S.data)}I.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,de),n.pixelStorei(t.UNPACK_SKIP_PIXELS,pe),n.pixelStorei(t.UNPACK_SKIP_ROWS,be)}}function ge(I,S,H){let Z=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Z=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Z=t.TEXTURE_3D);const oe=k(I,S),xe=S.source;n.bindTexture(Z,I.__webglTexture,t.TEXTURE0+H);const Ee=i.get(xe);if(xe.version!==Ee.__version||oe===!0){if(n.activeTexture(t.TEXTURE0+H),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){const Y=at.getPrimaries(at.workingColorSpace),F=S.colorSpace===tr?null:at.getPrimaries(S.colorSpace),re=S.colorSpace===tr||Y===F?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,re)}n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment);let pe=x(S.image,!1,r.maxTextureSize);pe=tt(S,pe);const be=s.convert(S.format,S.colorSpace),De=s.convert(S.type);let Te=y(S.internalFormat,be,De,S.normalized,S.colorSpace,S.isVideoTexture);se(Z,S);let Ce;const ke=S.mipmaps,Oe=S.isVideoTexture!==!0,je=Ee.__version===void 0||oe===!0,G=xe.dataReady,Se=A(S,pe);if(S.isDepthTexture)Te=T(S.format===Fr,S.type),je&&(Oe?n.texStorage2D(t.TEXTURE_2D,1,Te,pe.width,pe.height):n.texImage2D(t.TEXTURE_2D,0,Te,pe.width,pe.height,0,be,De,null));else if(S.isDataTexture)if(ke.length>0){Oe&&je&&n.texStorage2D(t.TEXTURE_2D,Se,Te,ke[0].width,ke[0].height);for(let Y=0,F=ke.length;Y<F;Y++)Ce=ke[Y],Oe?G&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,Ce.width,Ce.height,be,De,Ce.data):n.texImage2D(t.TEXTURE_2D,Y,Te,Ce.width,Ce.height,0,be,De,Ce.data);S.generateMipmaps=!1}else Oe?(je&&n.texStorage2D(t.TEXTURE_2D,Se,Te,pe.width,pe.height),G&&K(S,pe,be,De)):n.texImage2D(t.TEXTURE_2D,0,Te,pe.width,pe.height,0,be,De,pe.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Oe&&je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,Se,Te,ke[0].width,ke[0].height,pe.depth);for(let Y=0,F=ke.length;Y<F;Y++)if(Ce=ke[Y],S.format!==Qn)if(be!==null)if(Oe){if(G)if(S.layerUpdates.size>0){const re=jm(Ce.width,Ce.height,S.format,S.type);for(const W of S.layerUpdates){const fe=Ce.data.subarray(W*re/Ce.data.BYTES_PER_ELEMENT,(W+1)*re/Ce.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,W,Ce.width,Ce.height,1,be,fe)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,0,Ce.width,Ce.height,pe.depth,be,Ce.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,Y,Te,Ce.width,Ce.height,pe.depth,0,Ce.data,0,0);else We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?G&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,Y,0,0,0,Ce.width,Ce.height,pe.depth,be,De,Ce.data):n.texImage3D(t.TEXTURE_2D_ARRAY,Y,Te,Ce.width,Ce.height,pe.depth,0,be,De,Ce.data)}else{Oe&&je&&n.texStorage2D(t.TEXTURE_2D,Se,Te,ke[0].width,ke[0].height);for(let Y=0,F=ke.length;Y<F;Y++)Ce=ke[Y],S.format!==Qn?be!==null?Oe?G&&n.compressedTexSubImage2D(t.TEXTURE_2D,Y,0,0,Ce.width,Ce.height,be,Ce.data):n.compressedTexImage2D(t.TEXTURE_2D,Y,Te,Ce.width,Ce.height,0,Ce.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?G&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,Ce.width,Ce.height,be,De,Ce.data):n.texImage2D(t.TEXTURE_2D,Y,Te,Ce.width,Ce.height,0,be,De,Ce.data)}else if(S.isDataArrayTexture)if(Oe){if(je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,Se,Te,pe.width,pe.height,pe.depth),G)if(S.layerUpdates.size>0){const Y=jm(pe.width,pe.height,S.format,S.type);for(const F of S.layerUpdates){const re=pe.data.subarray(F*Y/pe.data.BYTES_PER_ELEMENT,(F+1)*Y/pe.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,F,pe.width,pe.height,1,be,De,re)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,pe.width,pe.height,pe.depth,be,De,pe.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Te,pe.width,pe.height,pe.depth,0,be,De,pe.data);else if(S.isData3DTexture)Oe?(je&&n.texStorage3D(t.TEXTURE_3D,Se,Te,pe.width,pe.height,pe.depth),G&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,pe.width,pe.height,pe.depth,be,De,pe.data)):n.texImage3D(t.TEXTURE_3D,0,Te,pe.width,pe.height,pe.depth,0,be,De,pe.data);else if(S.isFramebufferTexture){if(je)if(Oe)n.texStorage2D(t.TEXTURE_2D,Se,Te,pe.width,pe.height);else{let Y=pe.width,F=pe.height;for(let re=0;re<Se;re++)n.texImage2D(t.TEXTURE_2D,re,Te,Y,F,0,be,De,null),Y>>=1,F>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in t){const Y=t.canvas;if(Y.hasAttribute("layoutsubtree")||Y.setAttribute("layoutsubtree","true"),pe.parentNode!==Y){Y.appendChild(pe),p.add(S),Y.onpaint=F=>{const re=F.changedElements;for(const W of p)re.includes(W.image)&&(W.needsUpdate=!0)},Y.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,pe);else{const re=t.RGBA,W=t.RGBA,fe=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,re,W,fe,pe)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(ke.length>0){if(Oe&&je){const Y=qe(ke[0]);n.texStorage2D(t.TEXTURE_2D,Se,Te,Y.width,Y.height)}for(let Y=0,F=ke.length;Y<F;Y++)Ce=ke[Y],Oe?G&&n.texSubImage2D(t.TEXTURE_2D,Y,0,0,be,De,Ce):n.texImage2D(t.TEXTURE_2D,Y,Te,be,De,Ce);S.generateMipmaps=!1}else if(Oe){if(je){const Y=qe(pe);n.texStorage2D(t.TEXTURE_2D,Se,Te,Y.width,Y.height)}G&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,be,De,pe)}else n.texImage2D(t.TEXTURE_2D,0,Te,be,De,pe);d(S)&&v(Z),Ee.__version=xe.version,S.onUpdate&&S.onUpdate(S)}I.__version=S.version}function me(I,S,H){if(S.image.length!==6)return;const Z=k(I,S),oe=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,I.__webglTexture,t.TEXTURE0+H);const xe=i.get(oe);if(oe.version!==xe.__version||Z===!0){n.activeTexture(t.TEXTURE0+H);const Ee=at.getPrimaries(at.workingColorSpace),de=S.colorSpace===tr?null:at.getPrimaries(S.colorSpace),pe=S.colorSpace===tr||Ee===de?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const be=S.isCompressedTexture||S.image[0].isCompressedTexture,De=S.image[0]&&S.image[0].isDataTexture,Te=[];for(let W=0;W<6;W++)!be&&!De?Te[W]=x(S.image[W],!0,r.maxCubemapSize):Te[W]=De?S.image[W].image:S.image[W],Te[W]=tt(S,Te[W]);const Ce=Te[0],ke=s.convert(S.format,S.colorSpace),Oe=s.convert(S.type),je=y(S.internalFormat,ke,Oe,S.normalized,S.colorSpace),G=S.isVideoTexture!==!0,Se=xe.__version===void 0||Z===!0,Y=oe.dataReady;let F=A(S,Ce);se(t.TEXTURE_CUBE_MAP,S);let re;if(be){G&&Se&&n.texStorage2D(t.TEXTURE_CUBE_MAP,F,je,Ce.width,Ce.height);for(let W=0;W<6;W++){re=Te[W].mipmaps;for(let fe=0;fe<re.length;fe++){const ie=re[fe];S.format!==Qn?ke!==null?G?Y&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,fe,0,0,ie.width,ie.height,ke,ie.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,fe,je,ie.width,ie.height,0,ie.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,fe,0,0,ie.width,ie.height,ke,Oe,ie.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,fe,je,ie.width,ie.height,0,ke,Oe,ie.data)}}}else{if(re=S.mipmaps,G&&Se){re.length>0&&F++;const W=qe(Te[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,F,je,W.width,W.height)}for(let W=0;W<6;W++)if(De){G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,0,0,Te[W].width,Te[W].height,ke,Oe,Te[W].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,je,Te[W].width,Te[W].height,0,ke,Oe,Te[W].data);for(let fe=0;fe<re.length;fe++){const ve=re[fe].image[W].image;G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,fe+1,0,0,ve.width,ve.height,ke,Oe,ve.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,fe+1,je,ve.width,ve.height,0,ke,Oe,ve.data)}}else{G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,0,0,ke,Oe,Te[W]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,je,ke,Oe,Te[W]);for(let fe=0;fe<re.length;fe++){const ie=re[fe];G?Y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,fe+1,0,0,ke,Oe,ie.image[W]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+W,fe+1,je,ke,Oe,ie.image[W])}}}d(S)&&v(t.TEXTURE_CUBE_MAP),xe.__version=oe.version,S.onUpdate&&S.onUpdate(S)}I.__version=S.version}function ue(I,S,H,Z,oe,xe){const Ee=s.convert(H.format,H.colorSpace),de=s.convert(H.type),pe=y(H.internalFormat,Ee,de,H.normalized,H.colorSpace),be=i.get(S),De=i.get(H);if(De.__renderTarget=S,!be.__hasExternalTextures){const Te=Math.max(1,S.width>>xe),Ce=Math.max(1,S.height>>xe);oe===t.TEXTURE_3D||oe===t.TEXTURE_2D_ARRAY?n.texImage3D(oe,xe,pe,Te,Ce,S.depth,0,Ee,de,null):n.texImage2D(oe,xe,pe,Te,Ce,0,Ee,de,null)}n.bindFramebuffer(t.FRAMEBUFFER,I),et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Z,oe,De.__webglTexture,0,Ke(S)):(oe===t.TEXTURE_2D||oe>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&oe<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Z,oe,De.__webglTexture,xe),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Re(I,S,H){if(t.bindRenderbuffer(t.RENDERBUFFER,I),S.depthBuffer){const Z=S.depthTexture,oe=Z&&Z.isDepthTexture?Z.type:null,xe=T(S.stencilBuffer,oe),Ee=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;et(S)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ke(S),xe,S.width,S.height):H?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ke(S),xe,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,xe,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Ee,t.RENDERBUFFER,I)}else{const Z=S.textures;for(let oe=0;oe<Z.length;oe++){const xe=Z[oe],Ee=s.convert(xe.format,xe.colorSpace),de=s.convert(xe.type),pe=y(xe.internalFormat,Ee,de,xe.normalized,xe.colorSpace);et(S)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ke(S),pe,S.width,S.height):H?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ke(S),pe,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,pe,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Me(I,S,H){const Z=S.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,I),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const oe=i.get(S.depthTexture);if(oe.__renderTarget=S,(!oe.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),Z){if(oe.__webglInit===void 0&&(oe.__webglInit=!0,S.depthTexture.addEventListener("dispose",P)),oe.__webglTexture===void 0){oe.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,oe.__webglTexture),se(t.TEXTURE_CUBE_MAP,S.depthTexture);const be=s.convert(S.depthTexture.format),De=s.convert(S.depthTexture.type);let Te;S.depthTexture.format===Oi?Te=t.DEPTH_COMPONENT24:S.depthTexture.format===Fr&&(Te=t.DEPTH24_STENCIL8);for(let Ce=0;Ce<6;Ce++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0,Te,S.width,S.height,0,be,De,null)}}else b(S.depthTexture,0);const xe=oe.__webglTexture,Ee=Ke(S),de=Z?t.TEXTURE_CUBE_MAP_POSITIVE_X+H:t.TEXTURE_2D,pe=S.depthTexture.format===Fr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(S.depthTexture.format===Oi)et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,pe,de,xe,0,Ee):t.framebufferTexture2D(t.FRAMEBUFFER,pe,de,xe,0);else if(S.depthTexture.format===Fr)et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,pe,de,xe,0,Ee):t.framebufferTexture2D(t.FRAMEBUFFER,pe,de,xe,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function _e(I){const S=i.get(I),H=I.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==I.depthTexture){const Z=I.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),Z){const oe=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,Z.removeEventListener("dispose",oe)};Z.addEventListener("dispose",oe),S.__depthDisposeCallback=oe}S.__boundDepthTexture=Z}if(I.depthTexture&&!S.__autoAllocateDepthBuffer)if(H)for(let Z=0;Z<6;Z++)Me(S.__webglFramebuffer[Z],I,Z);else{const Z=I.texture.mipmaps;Z&&Z.length>0?Me(S.__webglFramebuffer[0],I,0):Me(S.__webglFramebuffer,I,0)}else if(H){S.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[Z]),S.__webglDepthbuffer[Z]===void 0)S.__webglDepthbuffer[Z]=t.createRenderbuffer(),Re(S.__webglDepthbuffer[Z],I,!1);else{const oe=I.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,xe=S.__webglDepthbuffer[Z];t.bindRenderbuffer(t.RENDERBUFFER,xe),t.framebufferRenderbuffer(t.FRAMEBUFFER,oe,t.RENDERBUFFER,xe)}}else{const Z=I.texture.mipmaps;if(Z&&Z.length>0?n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),Re(S.__webglDepthbuffer,I,!1);else{const oe=I.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,xe=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,xe),t.framebufferRenderbuffer(t.FRAMEBUFFER,oe,t.RENDERBUFFER,xe)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function we(I,S,H){const Z=i.get(I);S!==void 0&&ue(Z.__webglFramebuffer,I,I.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),H!==void 0&&_e(I)}function Fe(I){const S=I.texture,H=i.get(I),Z=i.get(S);I.addEventListener("dispose",g);const oe=I.textures,xe=I.isWebGLCubeRenderTarget===!0,Ee=oe.length>1;if(Ee||(Z.__webglTexture===void 0&&(Z.__webglTexture=t.createTexture()),Z.__version=S.version,a.memory.textures++),xe){H.__webglFramebuffer=[];for(let de=0;de<6;de++)if(S.mipmaps&&S.mipmaps.length>0){H.__webglFramebuffer[de]=[];for(let pe=0;pe<S.mipmaps.length;pe++)H.__webglFramebuffer[de][pe]=t.createFramebuffer()}else H.__webglFramebuffer[de]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){H.__webglFramebuffer=[];for(let de=0;de<S.mipmaps.length;de++)H.__webglFramebuffer[de]=t.createFramebuffer()}else H.__webglFramebuffer=t.createFramebuffer();if(Ee)for(let de=0,pe=oe.length;de<pe;de++){const be=i.get(oe[de]);be.__webglTexture===void 0&&(be.__webglTexture=t.createTexture(),a.memory.textures++)}if(I.samples>0&&et(I)===!1){H.__webglMultisampledFramebuffer=t.createFramebuffer(),H.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let de=0;de<oe.length;de++){const pe=oe[de];H.__webglColorRenderbuffer[de]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,H.__webglColorRenderbuffer[de]);const be=s.convert(pe.format,pe.colorSpace),De=s.convert(pe.type),Te=y(pe.internalFormat,be,De,pe.normalized,pe.colorSpace,I.isXRRenderTarget===!0),Ce=Ke(I);t.renderbufferStorageMultisample(t.RENDERBUFFER,Ce,Te,I.width,I.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.RENDERBUFFER,H.__webglColorRenderbuffer[de])}t.bindRenderbuffer(t.RENDERBUFFER,null),I.depthBuffer&&(H.__webglDepthRenderbuffer=t.createRenderbuffer(),Re(H.__webglDepthRenderbuffer,I,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(xe){n.bindTexture(t.TEXTURE_CUBE_MAP,Z.__webglTexture),se(t.TEXTURE_CUBE_MAP,S);for(let de=0;de<6;de++)if(S.mipmaps&&S.mipmaps.length>0)for(let pe=0;pe<S.mipmaps.length;pe++)ue(H.__webglFramebuffer[de][pe],I,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+de,pe);else ue(H.__webglFramebuffer[de],I,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);d(S)&&v(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Ee){for(let de=0,pe=oe.length;de<pe;de++){const be=oe[de],De=i.get(be);let Te=t.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Te=I.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Te,De.__webglTexture),se(Te,be),ue(H.__webglFramebuffer,I,be,t.COLOR_ATTACHMENT0+de,Te,0),d(be)&&v(Te)}n.unbindTexture()}else{let de=t.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(de=I.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(de,Z.__webglTexture),se(de,S),S.mipmaps&&S.mipmaps.length>0)for(let pe=0;pe<S.mipmaps.length;pe++)ue(H.__webglFramebuffer[pe],I,S,t.COLOR_ATTACHMENT0,de,pe);else ue(H.__webglFramebuffer,I,S,t.COLOR_ATTACHMENT0,de,0);d(S)&&v(de),n.unbindTexture()}I.depthBuffer&&_e(I)}function Ge(I){const S=I.textures;for(let H=0,Z=S.length;H<Z;H++){const oe=S[H];if(d(oe)){const xe=M(I),Ee=i.get(oe).__webglTexture;n.bindTexture(xe,Ee),v(xe),n.unbindTexture()}}}const Xe=[],Ye=[];function Je(I){if(I.samples>0){if(et(I)===!1){const S=I.textures,H=I.width,Z=I.height;let oe=t.COLOR_BUFFER_BIT;const xe=I.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Ee=i.get(I),de=S.length>1;if(de)for(let be=0;be<S.length;be++)n.bindFramebuffer(t.FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+be,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Ee.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+be,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Ee.__webglMultisampledFramebuffer);const pe=I.texture.mipmaps;pe&&pe.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ee.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ee.__webglFramebuffer);for(let be=0;be<S.length;be++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(oe|=t.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(oe|=t.STENCIL_BUFFER_BIT)),de){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Ee.__webglColorRenderbuffer[be]);const De=i.get(S[be]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,De,0)}t.blitFramebuffer(0,0,H,Z,0,0,H,Z,oe,t.NEAREST),c===!0&&(Xe.length=0,Ye.length=0,Xe.push(t.COLOR_ATTACHMENT0+be),I.depthBuffer&&I.resolveDepthBuffer===!1&&(Xe.push(xe),Ye.push(xe),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Ye)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Xe))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),de)for(let be=0;be<S.length;be++){n.bindFramebuffer(t.FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+be,t.RENDERBUFFER,Ee.__webglColorRenderbuffer[be]);const De=i.get(S[be]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Ee.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+be,t.TEXTURE_2D,De,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ee.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&c){const S=I.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function Ke(I){return Math.min(r.maxSamples,I.samples)}function et(I){const S=i.get(I);return I.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function B(I){const S=a.render.frame;h.get(I)!==S&&(h.set(I,S),I.update())}function tt(I,S){const H=I.colorSpace,Z=I.format,oe=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||H!==ql&&H!==tr&&(at.getTransfer(H)===pt?(Z!==Qn||oe!==Cn)&&We("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ut("WebGLTextures: Unsupported texture color space:",H)),S}function qe(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(u.width=I.naturalWidth||I.width,u.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(u.width=I.displayWidth,u.height=I.displayHeight):(u.width=I.width,u.height=I.height),u}this.allocateTextureUnit=Q,this.resetTextureUnits=j,this.getTextureUnits=ne,this.setTextureUnits=V,this.setTexture2D=b,this.setTexture2DArray=E,this.setTexture3D=L,this.setTextureCube=O,this.rebindTextures=we,this.setupRenderTarget=Fe,this.updateRenderTargetMipmap=Ge,this.updateMultisampleRenderTarget=Je,this.setupDepthRenderbuffer=_e,this.setupFrameBufferTexture=ue,this.useMultisampledRTT=et,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function w2(t,e){function n(i,r=tr){let s;const a=at.getTransfer(r);if(i===Cn)return t.UNSIGNED_BYTE;if(i===xh)return t.UNSIGNED_SHORT_4_4_4_4;if(i===vh)return t.UNSIGNED_SHORT_5_5_5_1;if(i===Qx)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Jx)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===Kx)return t.BYTE;if(i===Zx)return t.SHORT;if(i===Qa)return t.UNSIGNED_SHORT;if(i===gh)return t.INT;if(i===vi)return t.UNSIGNED_INT;if(i===di)return t.FLOAT;if(i===ki)return t.HALF_FLOAT;if(i===ev)return t.ALPHA;if(i===tv)return t.RGB;if(i===Qn)return t.RGBA;if(i===Oi)return t.DEPTH_COMPONENT;if(i===Fr)return t.DEPTH_STENCIL;if(i===nv)return t.RED;if(i===_h)return t.RED_INTEGER;if(i===Xr)return t.RG;if(i===yh)return t.RG_INTEGER;if(i===Sh)return t.RGBA_INTEGER;if(i===pl||i===ml||i===gl||i===xl)if(a===pt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===pl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ml)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===gl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===xl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===pl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ml)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===gl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===xl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===kd||i===Od||i===zd||i===Bd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===kd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Od)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===zd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Bd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Vd||i===Hd||i===Gd||i===jd||i===Wd||i===Wl||i===Xd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Vd||i===Hd)return a===pt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Gd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===jd)return s.COMPRESSED_R11_EAC;if(i===Wd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Wl)return s.COMPRESSED_RG11_EAC;if(i===Xd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===qd||i===$d||i===Yd||i===Kd||i===Zd||i===Qd||i===Jd||i===ef||i===tf||i===nf||i===rf||i===sf||i===af||i===of)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===qd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===$d)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Yd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Kd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Zd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Qd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Jd)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ef)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===tf)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===nf)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===rf)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===sf)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===af)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===of)return a===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===lf||i===cf||i===uf)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===lf)return a===pt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===cf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===uf)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===df||i===ff||i===Xl||i===hf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===df)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ff)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Xl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===hf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ja?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const E2=`
void main() {
...
}`;class T2{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){const i=new uv(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new _i({vertexShader:E2,fragmentShader:b2,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new en(new co(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class C2 extends Kr{constructor(e,n){super();const i=this;let r=null,s=1,a=null,o="local-floor",c=1,u=null,h=null,p=null,f=null,m=null,_=null;const w=typeof XRWebGLBinding<"u",x=new T2,d={},v=n.getContextAttributes();let M=null,y=null;const T=[],A=[],P=new lt;let g=null;const R=new On;R.viewport=new Tt;const C=new On;C.viewport=new Tt;const D=[R,C],z=new kM;let j=null,ne=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(k){let q=T[k];return q===void 0&&(q=new au,T[k]=q),q.getTargetRaySpace()},this.getControllerGrip=function(k){let q=T[k];return q===void 0&&(q=new au,T[k]=q),q.getGripSpace()},this.getHand=function(k){let q=T[k];return q===void 0&&(q=new au,T[k]=q),q.getHandSpace()};function V(k){const q=A.indexOf(k.inputSource);if(q===-1)return;const K=T[q];K!==void 0&&(K.update(k.inputSource,k.frame,u||a),K.dispatchEvent({type:k.type,data:k.inputSource}))}function Q(){r.removeEventListener("select",V),r.removeEventListener("selectstart",V),r.removeEventListener("selectend",V),r.removeEventListener("squeeze",V),r.removeEventListener("squeezestart",V),r.removeEventListener("squeezeend",V),r.removeEventListener("end",Q),r.removeEventListener("inputsourceschange",$);for(let k=0;k<T.length;k++){const q=A[k];q!==null&&(A[k]=null,T[k].disconnect(q))}j=null,ne=null,x.reset();for(const k in d)delete d[k];e.setRenderTarget(M),m=null,f=null,p=null,r=null,y=null,se.stop(),i.isPresenting=!1,e.setPixelRatio(g),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(k){s=k,i.isPresenting===!0&&We("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(k){o=k,i.isPresenting===!0&&We("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||a},this.setReferenceSpace=function(k){u=k},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return p===null&&w&&(p=new XRWebGLBinding(r,n)),p},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(k){if(r=k,r!==null){if(M=e.getRenderTarget(),r.addEventListener("select",V),r.addEventListener("selectstart",V),r.addEventListener("selectend",V),r.addEventListener("squeeze",V),r.addEventListener("squeezestart",V),r.addEventListener("squeezeend",V),r.addEventListener("end",Q),r.addEventListener("inputsourceschange",$),v.xrCompatible!==!0&&await n.makeXRCompatible(),g=e.getPixelRatio(),e.getSize(P),w&&"createProjectionLayer"in XRWebGLBinding.prototype){let K=null,ge=null,me=null;v.depth&&(me=v.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,K=v.stencil?Fr:Oi,ge=v.stencil?Ja:vi);const ue={colorFormat:n.RGBA8,depthFormat:me,scaleFactor:s};p=this.getBinding(),f=p.createProjectionLayer(ue),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),y=new gi(f.textureWidth,f.textureHeight,{format:Qn,type:Cn,depthTexture:new $s(f.textureWidth,f.textureHeight,ge,void 0,void 0,void 0,void 0,void 0,void 0,K),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const K={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,n,K),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),y=new gi(m.framebufferWidth,m.framebufferHeight,{format:Qn,type:Cn,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(c),u=null,a=await r.requestReferenceSpace(o),se.setContext(r),se.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function $(k){for(let q=0;q<k.removed.length;q++){const K=k.removed[q],ge=A.indexOf(K);ge>=0&&(A[ge]=null,T[ge].disconnect(K))}for(let q=0;q<k.added.length;q++){const K=k.added[q];let ge=A.indexOf(K);if(ge===-1){for(let ue=0;ue<T.length;ue++)if(ue>=A.length){A.push(K),ge=ue;break}else if(A[ue]===null){A[ue]=K,ge=ue;break}if(ge===-1)break}const me=T[ge];me&&me.connect(K)}}const b=new J,E=new J;function L(k,q,K){b.setFromMatrixPosition(q.matrixWorld),E.setFromMatrixPosition(K.matrixWorld);const ge=b.distanceTo(E),me=q.projectionMatrix.elements,ue=K.projectionMatrix.elements,Re=me[14]/(me[10]-1),Me=me[14]/(me[10]+1),_e=(me[9]+1)/me[5],we=(me[9]-1)/me[5],Fe=(me[8]-1)/me[0],Ge=(ue[8]+1)/ue[0],Xe=Re*Fe,Ye=Re*Ge,Je=ge/(-Fe+Ge),Ke=Je*-Fe;if(q.matrixWorld.decompose(k.position,k.quaternion,k.scale),k.translateX(Ke),k.translateZ(Je),k.matrixWorld.compose(k.position,k.quaternion,k.scale),k.matrixWorldInverse.copy(k.matrixWorld).invert(),me[10]===-1)k.projectionMatrix.copy(q.projectionMatrix),k.projectionMatrixInverse.copy(q.projectionMatrixInverse);else{const et=Re+Je,B=Me+Je,tt=Xe-Ke,qe=Ye+(ge-Ke),I=_e*Me/B*et,S=we*Me/B*et;k.projectionMatrix.makePerspective(tt,qe,I,S,et,B),k.projectionMatrixInverse.copy(k.projectionMatrix).invert()}}function O(k,q){q===null?k.matrixWorld.copy(k.matrix):k.matrixWorld.multiplyMatrices(q.matrixWorld,k.matrix),k.matrixWorldInverse.copy(k.matrixWorld).invert()}this.updateCamera=function(k){if(r===null)return;let q=k.near,K=k.far;x.texture!==null&&(x.depthNear>0&&(q=x.depthNear),x.depthFar>0&&(K=x.depthFar)),z.near=C.near=R.near=q,z.far=C.far=R.far=K,(j!==z.near||ne!==z.far)&&(r.updateRenderState({depthNear:z.near,depthFar:z.far}),j=z.near,ne=z.far),z.layers.mask=k.layers.mask|6,R.layers.mask=z.layers.mask&-5,C.layers.mask=z.layers.mask&-3;const ge=k.parent,me=z.cameras;O(z,ge);for(let ue=0;ue<me.length;ue++)O(me[ue],ge);me.length===2?L(z,R,C):z.projectionMatrix.copy(R.projectionMatrix),U(k,z,ge)};function U(k,q,K){K===null?k.matrix.copy(q.matrixWorld):(k.matrix.copy(K.matrixWorld),k.matrix.invert(),k.matrix.multiply(q.matrixWorld)),k.matrix.decompose(k.position,k.quaternion,k.scale),k.updateMatrixWorld(!0),k.projectionMatrix.copy(q.projectionMatrix),k.projectionMatrixInverse.copy(q.projectionMatrixInverse),k.isPerspectiveCamera&&(k.fov=mf*2*Math.atan(1/k.projectionMatrix.elements[5]),k.zoom=1)}this.getCamera=function(){return z},this.getFoveation=function(){if(!(f===null&&m===null))return c},this.setFoveation=function(k){c=k,f!==null&&(f.fixedFoveation=k),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=k)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(z)},this.getCameraTexture=function(k){return d[k]};let ce=null;function he(k,q){if(h=q.getViewerPose(u||a),_=q,h!==null){const K=h.views;m!==null&&(e.setRenderTargetFramebuffer(y,m.framebuffer),e.setRenderTarget(y));let ge=!1;K.length!==z.cameras.length&&(z.cameras.length=0,ge=!0);for(let Me=0;Me<K.length;Me++){const _e=K[Me];let we=null;if(m!==null)we=m.getViewport(_e);else{const Ge=p.getViewSubImage(f,_e);we=Ge.viewport,Me===0&&(e.setRenderTargetTextures(y,Ge.colorTexture,Ge.depthStencilTexture),e.setRenderTarget(y))}let Fe=D[Me];Fe===void 0&&(Fe=new On,Fe.layers.enable(Me),Fe.viewport=new Tt,D[Me]=Fe),Fe.matrix.fromArray(_e.transform.matrix),Fe.matrix.decompose(Fe.position,Fe.quaternion,Fe.scale),Fe.projectionMatrix.fromArray(_e.projectionMatrix),Fe.projectionMatrixInverse.copy(Fe.projectionMatrix).invert(),Fe.viewport.set(we.x,we.y,we.width,we.height),Me===0&&(z.matrix.copy(Fe.matrix),z.matrix.decompose(z.position,z.quaternion,z.scale)),ge===!0&&z.cameras.push(Fe)}const me=r.enabledFeatures;if(me&&me.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&w){p=i.getBinding();const Me=p.getDepthInformation(K[0]);Me&&Me.isValid&&Me.texture&&x.init(Me,r.renderState)}if(me&&me.includes("camera-access")&&w){e.state.unbindTexture(),p=i.getBinding();for(let Me=0;Me<K.length;Me++){const _e=K[Me].camera;if(_e){let we=d[_e];we||(we=new uv,d[_e]=we);const Fe=p.getCameraImage(_e);we.sourceTexture=Fe}}}}for(let K=0;K<T.length;K++){const ge=A[K],me=T[K];ge!==null&&me!==void 0&&me.update(ge,q,u||a)}ce&&ce(k,q),q.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:q}),_=null}const se=new pv;se.setAnimationLoop(he),this.setAnimationLoop=function(k){ce=k},this.dispose=function(){}}}const A2=new Pt,Sv=new $e;Sv.set(-1,0,0,0,1,0,0,0,1);function R2(t,e){function n(x,d){x.matrixAutoUpdate===!0&&x.updateMatrix(),d.value.copy(x.matrix)}function i(x,d){d.color.getRGB(x.fogColor.value,dv(t)),d.isFog?(x.fogNear.value=d.near,x.fogFar.value=d.far):d.isFogExp2&&(x.fogDensity.value=d.density)}function r(x,d,v,M,y){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?s(x,d):d.isMeshLambertMaterial?(s(x,d),d.envMap&&(x.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(s(x,d),p(x,d)):d.isMeshPhongMaterial?(s(x,d),h(x,d),d.envMap&&(x.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(s(x,d),f(x,d),d.isMeshPhysicalMaterial&&m(x,d,y)):d.isMeshMatcapMaterial?(s(x,d),_(x,d)):d.isMeshDepthMaterial?s(x,d):d.isMeshDistanceMaterial?(s(x,d),w(x,d)):d.isMeshNormalMaterial?s(x,d):d.isLineBasicMaterial?(a(x,d),d.isLineDashedMaterial&&o(x,d)):d.isPointsMaterial?c(x,d,v,M):d.isSpriteMaterial?u(x,d):d.isShadowMaterial?(x.color.value.copy(d.color),x.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(x,d){x.opacity.value=d.opacity,d.color&&x.diffuse.value.copy(d.color),d.emissive&&x.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(x.map.value=d.map,n(d.map,x.mapTransform)),d.alphaMap&&(x.alphaMap.value=d.alphaMap,n(d.alphaMap,x.alphaMapTransform)),d.bumpMap&&(x.bumpMap.value=d.bumpMap,n(d.bumpMap,x.bumpMapTransform),x.bumpScale.value=d.bumpScale,d.side===yn&&(x.bumpScale.value*=-1)),d.normalMap&&(x.normalMap.value=d.normalMap,n(d.normalMap,x.normalMapTransform),x.normalScale.value.copy(d.normalScale),d.side===yn&&x.normalScale.value.negate()),d.displacementMap&&(x.displacementMap.value=d.displacementMap,n(d.displacementMap,x.displacementMapTransform),x.displacementScale.value=d.displacementScale,x.displacementBias.value=d.displacementBias),d.emissiveMap&&(x.emissiveMap.value=d.emissiveMap,n(d.emissiveMap,x.emissiveMapTransform)),d.specularMap&&(x.specularMap.value=d.specularMap,n(d.specularMap,x.specularMapTransform)),d.alphaTest>0&&(x.alphaTest.value=d.alphaTest);const v=e.get(d),M=v.envMap,y=v.envMapRotation;M&&(x.envMap.value=M,x.envMapRotation.value.setFromMatrix4(A2.makeRotationFromEuler(y)).transpose(),M.isCubeTexture&&M.isRenderTargetTexture===!1&&x.envMapRotation.value.premultiply(Sv),x.reflectivity.value=d.reflectivity,x.ior.value=d.ior,x.refractionRatio.value=d.refractionRatio),d.lightMap&&(x.lightMap.value=d.lightMap,x.lightMapIntensity.value=d.lightMapIntensity,n(d.lightMap,x.lightMapTransform)),d.aoMap&&(x.aoMap.value=d.aoMap,x.aoMapIntensity.value=d.aoMapIntensity,n(d.aoMap,x.aoMapTransform))}function a(x,d){x.diffuse.value.copy(d.color),x.opacity.value=d.opacity,d.map&&(x.map.value=d.map,n(d.map,x.mapTransform))}function o(x,d){x.dashSize.value=d.dashSize,x.totalSize.value=d.dashSize+d.gapSize,x.scale.value=d.scale}function c(x,d,v,M){x.diffuse.value.copy(d.color),x.opacity.value=d.opacity,x.size.value=d.size*v,x.scale.value=M*.5,d.map&&(x.map.value=d.map,n(d.map,x.uvTransform)),d.alphaMap&&(x.alphaMap.value=d.alphaMap,n(d.alphaMap,x.alphaMapTransform)),d.alphaTest>0&&(x.alphaTest.value=d.alphaTest)}function u(x,d){x.diffuse.value.copy(d.color),x.opacity.value=d.opacity,x.rotation.value=d.rotation,d.map&&(x.map.value=d.map,n(d.map,x.mapTransform)),d.alphaMap&&(x.alphaMap.value=d.alphaMap,n(d.alphaMap,x.alphaMapTransform)),d.alphaTest>0&&(x.alphaTest.value=d.alphaTest)}function h(x,d){x.specular.value.copy(d.specular),x.shininess.value=Math.max(d.shininess,1e-4)}function p(x,d){d.gradientMap&&(x.gradientMap.value=d.gradientMap)}function f(x,d){x.metalness.value=d.metalness,d.metalnessMap&&(x.metalnessMap.value=d.metalnessMap,n(d.metalnessMap,x.metalnessMapTransform)),x.roughness.value=d.roughness,d.roughnessMap&&(x.roughnessMap.value=d.roughnessMap,n(d.roughnessMap,x.roughnessMapTransform)),d.envMap&&(x.envMapIntensity.value=d.envMapIntensity)}function m(x,d,v){x.ior.value=d.ior,d.sheen>0&&(x.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),x.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(x.sheenColorMap.value=d.sheenColorMap,n(d.sheenColorMap,x.sheenColorMapTransform)),d.sheenRoughnessMap&&(x.sheenRoughnessMap.value=d.sheenRoughnessMap,n(d.sheenRoughnessMap,x.sheenRoughnessMapTransform))),d.clearcoat>0&&(x.clearcoat.value=d.clearcoat,x.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(x.clearcoatMap.value=d.clearcoatMap,n(d.clearcoatMap,x.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(x.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,n(d.clearcoatRoughnessMap,x.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(x.clearcoatNormalMap.value=d.clearcoatNormalMap,n(d.clearcoatNormalMap,x.clearcoatNormalMapTransform),x.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===yn&&x.clearcoatNormalScale.value.negate())),d.dispersion>0&&(x.dispersion.value=d.dispersion),d.iridescence>0&&(x.iridescence.value=d.iridescence,x.iridescenceIOR.value=d.iridescenceIOR,x.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],x.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(x.iridescenceMap.value=d.iridescenceMap,n(d.iridescenceMap,x.iridescenceMapTransform)),d.iridescenceThicknessMap&&(x.iridescenceThicknessMap.value=d.iridescenceThicknessMap,n(d.iridescenceThicknessMap,x.iridescenceThicknessMapTransform))),d.transmission>0&&(x.transmission.value=d.transmission,x.transmissionSamplerMap.value=v.texture,x.transmissionSamplerSize.value.set(v.width,v.height),d.transmissionMap&&(x.transmissionMap.value=d.transmissionMap,n(d.transmissionMap,x.transmissionMapTransform)),x.thickness.value=d.thickness,d.thicknessMap&&(x.thicknessMap.value=d.thicknessMap,n(d.thicknessMap,x.thicknessMapTransform)),x.attenuationDistance.value=d.attenuationDistance,x.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(x.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(x.anisotropyMap.value=d.anisotropyMap,n(d.anisotropyMap,x.anisotropyMapTransform))),x.specularIntensity.value=d.specularIntensity,x.specularColor.value.copy(d.specularColor),d.specularColorMap&&(x.specularColorMap.value=d.specularColorMap,n(d.specularColorMap,x.specularColorMapTransform)),d.specularIntensityMap&&(x.specularIntensityMap.value=d.specularIntensityMap,n(d.specularIntensityMap,x.specularIntensityMapTransform))}function _(x,d){d.matcap&&(x.matcap.value=d.matcap)}function w(x,d){const v=e.get(d).light;x.referencePosition.value.setFromMatrixPosition(v.matrixWorld),x.nearDistance.value=v.shadow.camera.near,x.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function N2(t,e,n,i){let r={},s={},a=[];const o=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,T){const A=T.program;i.uniformBlockBinding(y,A)}function u(y,T){let A=r[y.id];A===void 0&&(x(y),A=h(y),r[y.id]=A,y.addEventListener("dispose",v));const P=T.program;i.updateUBOMapping(y,P);const g=e.render.frame;s[y.id]!==g&&(f(y),s[y.id]=g)}function h(y){const T=p();y.__bindingPointIndex=T;const A=t.createBuffer(),P=y.__size,g=y.usage;return t.bindBuffer(t.UNIFORM_BUFFER,A),t.bufferData(t.UNIFORM_BUFFER,P,g),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,T,A),A}function p(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return ut("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(y){const T=r[y.id],A=y.uniforms,P=y.__cache;t.bindBuffer(t.UNIFORM_BUFFER,T);for(let g=0,R=A.length;g<R;g++){const C=A[g];if(Array.isArray(C))for(let D=0,z=C.length;D<z;D++)m(C[D],g,D,P);else m(C,g,0,P)}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(y,T,A,P){if(w(y,T,A,P)===!0){const g=y.__offset,R=y.value;if(Array.isArray(R)){let C=0;for(let D=0;D<R.length;D++){const z=R[D],j=d(z);_(z,y.__data,C),typeof z!="number"&&typeof z!="boolean"&&!z.isMatrix3&&!ArrayBuffer.isView(z)&&(C+=j.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(R,y.__data,0);t.bufferSubData(t.UNIFORM_BUFFER,g,y.__data)}}function _(y,T,A){typeof y=="number"||typeof y=="boolean"?T[0]=y:y.isMatrix3?(T[0]=y.elements[0],T[1]=y.elements[1],T[2]=y.elements[2],T[3]=0,T[4]=y.elements[3],T[5]=y.elements[4],T[6]=y.elements[5],T[7]=0,T[8]=y.elements[6],T[9]=y.elements[7],T[10]=y.elements[8],T[11]=0):ArrayBuffer.isView(y)?T.set(new y.constructor(y.buffer,y.byteOffset,T.length)):y.toArray(T,A)}function w(y,T,A,P){const g=y.value,R=T+"_"+A;if(P[R]===void 0)return typeof g=="number"||typeof g=="boolean"?P[R]=g:ArrayBuffer.isView(g)?P[R]=g.slice():P[R]=g.clone(),!0;{const C=P[R];if(typeof g=="number"||typeof g=="boolean"){if(C!==g)return P[R]=g,!0}else{if(ArrayBuffer.isView(g))return!0;if(C.equals(g)===!1)return C.copy(g),!0}}return!1}function x(y){const T=y.uniforms;let A=0;const P=16;for(let R=0,C=T.length;R<C;R++){const D=Array.isArray(T[R])?T[R]:[T[R]];for(let z=0,j=D.length;z<j;z++){const ne=D[z],V=Array.isArray(ne.value)?ne.value:[ne.value];for(let Q=0,$=V.length;Q<$;Q++){const b=V[Q],E=d(b),L=A%P,O=L%E.boundary,U=L+O;A+=O,U!==0&&P-U<E.storage&&(A+=P-U),ne.__data=new Float32Array(E.storage/Float32Array.BYTES_PER_ELEMENT),ne.__offset=A,A+=E.storage}}}const g=A%P;return g>0&&(A+=P-g),y.__size=A,y.__cache={},this}function d(y){const T={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(T.boundary=4,T.storage=4):y.isVector2?(T.boundary=8,T.storage=8):y.isVector3||y.isColor?(T.boundary=16,T.storage=12):y.isVector4?(T.boundary=16,T.storage=16):y.isMatrix3?(T.boundary=48,T.storage=48):y.isMatrix4?(T.boundary=64,T.storage=64):y.isTexture?We("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(T.boundary=16,T.storage=y.byteLength):We("WebGLRenderer: Unsupported uniform value type.",y),T}function v(y){const T=y.target;T.removeEventListener("dispose",v);const A=a.indexOf(T.__bindingPointIndex);a.splice(A,1),t.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function M(){for(const y in r)t.deleteBuffer(r[y]);a=[],r={},s={}}return{bind:c,update:u,dispose:M}}const P2=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ai=null;function L2(){return ai===null&&(ai=new SM(P2,16,16,Xr,ki),ai.name="DFG_LUT",ai.minFilter=nn,ai.magFilter=nn,ai.wrapS=Ri,ai.wrapT=Ri,ai.generateMipmaps=!1,ai.needsUpdate=!0),ai}class D2{constructor(e={}){const{canvas:n=Z1(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:u=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:f=!1,outputBufferType:m=Cn}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=a;const w=m,x=new Set([Sh,yh,_h]),d=new Set([Cn,vi,Qa,Ja,xh,vh]),v=new Uint32Array(4),M=new Int32Array(4),y=new J;let T=null,A=null;const P=[],g=[];let R=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=mi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let D=!1,z=null,j=null,ne=null,V=null;this._outputColorSpace=Un;let Q=0,$=0,b=null,E=-1,L=null;const O=new Tt,U=new Tt;let ce=null;const he=new dt(0);let se=0,k=n.width,q=n.height,K=1,ge=null,me=null;const ue=new Tt(0,0,k,q),Re=new Tt(0,0,k,q);let Me=!1;const _e=new Ch;let we=!1,Fe=!1;const Ge=new Pt,Xe=new J,Ye=new Tt,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ke=!1;function et(){return b===null?K:1}let B=i;function tt(N,X){return n.getContext(N,X)}try{const N={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:u,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${mh}`),n.addEventListener("webglcontextlost",ve,!1),n.addEventListener("webglcontextrestored",ze,!1),n.addEventListener("webglcontextcreationerror",Ze,!1),B===null){const X="webgl2";if(B=tt(X,N),B===null)throw tt(X)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(N){throw ut("WebGLRenderer: "+N.message),N}let qe,I,S,H,Z,oe,xe,Ee,de,pe,be,De,Te,Ce,ke,Oe,je,G,Se,Y,F,re,W;function fe(){qe=new Lb(B),qe.init(),F=new w2(B,qe),I=new Eb(B,qe,e,F),S=new S2(B,qe),I.reversedDepthBuffer&&f&&S.buffers.depth.setReversed(!0),j=B.createFramebuffer(),ne=B.createFramebuffer(),V=B.createFramebuffer(),H=new Ub(B),Z=new o2,oe=new M2(B,qe,S,Z,I,F,H),xe=new Pb(C),Ee=new zM(B),re=new Mb(B,Ee),de=new Db(B,Ee,H,re),pe=new kb(B,de,Ee,re,H),G=new Fb(B,I,oe),ke=new bb(Z),be=new a2(C,xe,qe,I,re,ke),De=new R2(C,Z),Te=new c2,Ce=new m2(qe),je=new Sb(C,xe,S,pe,_,c),Oe=new y2(C,pe,I),W=new N2(B,H,I,S),Se=new wb(B,qe,H),Y=new Ib(B,qe,H),H.programs=be.programs,C.capabilities=I,C.extensions=qe,C.properties=Z,C.renderLists=Te,C.shadowMap=Oe,C.state=S,C.info=H}fe(),w!==Cn&&(R=new zb(w,n.width,n.height,o,r,s));const ie=new C2(C,B);this.xr=ie,this.getContext=function(){return B},this.getContextAttributes=function(){return B.getContextAttributes()},this.forceContextLoss=function(){const N=qe.get("WEBGL_lose_context");N&&N.loseContext()},this.forceContextRestore=function(){const N=qe.get("WEBGL_lose_context");N&&N.restoreContext()},this.getPixelRatio=function(){return K},this.setPixelRatio=function(N){N!==void 0&&(K=N,this.setSize(k,q,!1))},this.getSize=function(N){return N.set(k,q)},this.setSize=function(N,X,ae=!0){if(ie.isPresenting){We("WebGLRenderer: Can't change size while VR device is presenting.");return}k=N,q=X,n.width=Math.floor(N*K),n.height=Math.floor(X*K),ae===!0&&(n.style.width=N+"px",n.style.height=X+"px"),R!==null&&R.setSize(n.width,n.height),this.setViewport(0,0,N,X)},this.getDrawingBufferSize=function(N){return N.set(k*K,q*K).floor()},this.setDrawingBufferSize=function(N,X,ae){k=N,q=X,K=ae,n.width=Math.floor(N*ae),n.height=Math.floor(X*ae),this.setViewport(0,0,N,X)},this.setEffects=function(N){if(w===Cn){ut("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(N){for(let X=0;X<N.length;X++)if(N[X].isOutputPass===!0){We("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}R.setEffects(N||[])},this.getCurrentViewport=function(N){return N.copy(O)},this.getViewport=function(N){return N.copy(ue)},this.setViewport=function(N,X,ae,ee){N.isVector4?ue.set(N.x,N.y,N.z,N.w):ue.set(N,X,ae,ee),S.viewport(O.copy(ue).multiplyScalar(K).round())},this.getScissor=function(N){return N.copy(Re)},this.setScissor=function(N,X,ae,ee){N.isVector4?Re.set(N.x,N.y,N.z,N.w):Re.set(N,X,ae,ee),S.scissor(U.copy(Re).multiplyScalar(K).round())},this.getScissorTest=function(){return Me},this.setScissorTest=function(N){S.setScissorTest(Me=N)},this.setOpaqueSort=function(N){ge=N},this.setTransparentSort=function(N){me=N},this.getClearColor=function(N){return N.copy(je.getClearColor())},this.setClearColor=function(){je.setClearColor(...arguments)},this.getClearAlpha=function(){return je.getClearAlpha()},this.setClearAlpha=function(){je.setClearAlpha(...arguments)},this.clear=function(N=!0,X=!0,ae=!0){let ee=0;if(N){let te=!1;if(b!==null){const Pe=b.texture.format;te=x.has(Pe)}if(te){const Pe=b.texture.type,Ie=d.has(Pe),Ne=je.getClearColor(),Be=je.getClearAlpha(),Ve=Ne.r,Qe=Ne.g,it=Ne.b;Ie?(v[0]=Ve,v[1]=Qe,v[2]=it,v[3]=Be,B.clearBufferuiv(B.COLOR,0,v)):(M[0]=Ve,M[1]=Qe,M[2]=it,M[3]=Be,B.clearBufferiv(B.COLOR,0,M))}else ee|=B.COLOR_BUFFER_BIT}X&&(ee|=B.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),ae&&(ee|=B.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),ee!==0&&B.clear(ee)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(N){N.setRenderer(this),z=N},this.dispose=function(){n.removeEventListener("webglcontextlost",ve,!1),n.removeEventListener("webglcontextrestored",ze,!1),n.removeEventListener("webglcontextcreationerror",Ze,!1),je.dispose(),Te.dispose(),Ce.dispose(),Z.dispose(),xe.dispose(),pe.dispose(),re.dispose(),W.dispose(),be.dispose(),ie.dispose(),ie.removeEventListener("sessionstart",kh),ie.removeEventListener("sessionend",Oh),Sr.stop()};function ve(N){N.preventDefault(),Mm("WebGLRenderer: Context Lost."),D=!0}function ze(){Mm("WebGLRenderer: Context Restored."),D=!1;const N=H.autoReset,X=Oe.enabled,ae=Oe.autoUpdate,ee=Oe.needsUpdate,te=Oe.type;fe(),H.autoReset=N,Oe.enabled=X,Oe.autoUpdate=ae,Oe.needsUpdate=ee,Oe.type=te}function Ze(N){ut("WebGLRenderer: A WebGL context could not be created. Reason: ",N.statusMessage)}function ht(N){const X=N.target;X.removeEventListener("dispose",ht),Sn(X)}function Sn(N){St(N),Z.remove(N)}function St(N){const X=Z.get(N).programs;X!==void 0&&(X.forEach(function(ae){be.releaseProgram(ae)}),N.isShaderMaterial&&be.releaseShaderCache(N))}this.renderBufferDirect=function(N,X,ae,ee,te,Pe){X===null&&(X=Je);const Ie=te.isMesh&&te.matrixWorld.determinantAffine()<0,Ne=Ev(N,X,ae,ee,te);S.setMaterial(ee,Ie);let Be=ae.index,Ve=1;if(ee.wireframe===!0){if(Be=de.getWireframeAttribute(ae),Be===void 0)return;Ve=2}const Qe=ae.drawRange,it=ae.attributes.position;let He=Qe.start*Ve,gt=(Qe.start+Qe.count)*Ve;Pe!==null&&(He=Math.max(He,Pe.start*Ve),gt=Math.min(gt,(Pe.start+Pe.count)*Ve)),Be!==null?(He=Math.max(He,0),gt=Math.min(gt,Be.count)):it!=null&&(He=Math.max(He,0),gt=Math.min(gt,it.count));const Lt=gt-He;if(Lt<0||Lt===1/0)return;re.setup(te,ee,Ne,ae,Be);let Rt,xt=Se;if(Be!==null&&(Rt=Ee.get(Be),xt=Y,xt.setIndex(Rt)),te.isMesh)ee.wireframe===!0?(S.setLineWidth(ee.wireframeLinewidth*et()),xt.setMode(B.LINES)):xt.setMode(B.TRIANGLES);else if(te.isLine){let Yt=ee.linewidth;Yt===void 0&&(Yt=1),S.setLineWidth(Yt*et()),te.isLineSegments?xt.setMode(B.LINES):te.isLineLoop?xt.setMode(B.LINE_LOOP):xt.setMode(B.LINE_STRIP)}else te.isPoints?xt.setMode(B.POINTS):te.isSprite&&xt.setMode(B.TRIANGLES);if(te.isBatchedMesh)if(qe.get("WEBGL_multi_draw"))xt.renderMultiDraw(te._multiDrawStarts,te._multiDrawCounts,te._multiDrawCount);else{const Yt=te._multiDrawStarts,Le=te._multiDrawCounts,Mn=te._multiDrawCount,ct=Be?Ee.get(Be).bytesPerElement:1,Dn=Z.get(ee).currentProgram.getUniforms();for(let ii=0;ii<Mn;ii++)Dn.setValue(B,"_gl_DrawID",ii),xt.render(Yt[ii]/ct,Le[ii])}else if(te.isInstancedMesh)xt.renderInstances(He,Lt,te.count);else if(ae.isInstancedBufferGeometry){const Yt=ae._maxInstanceCount!==void 0?ae._maxInstanceCount:1/0,Le=Math.min(ae.instanceCount,Yt);xt.renderInstances(He,Lt,Le)}else xt.render(He,Lt)};function jt(N,X,ae){N.transparent===!0&&N.side===ui&&N.forceSinglePass===!1?(N.side=yn,N.needsUpdate=!0,fo(N,X,ae),N.side=gr,N.needsUpdate=!0,fo(N,X,ae),N.side=ui):fo(N,X,ae)}this.compile=function(N,X,ae=null){ae===null&&(ae=N),A=Ce.get(ae),A.init(X),g.push(A),ae.traverseVisible(function(te){te.isLight&&te.layers.test(X.layers)&&(A.pushLight(te),te.castShadow&&A.pushShadow(te))}),N!==ae&&N.traverseVisible(function(te){te.isLight&&te.layers.test(X.layers)&&(A.pushLight(te),te.castShadow&&A.pushShadow(te))}),A.setupLights();const ee=new Set;return N.traverse(function(te){if(!(te.isMesh||te.isPoints||te.isLine||te.isSprite))return;const Pe=te.material;if(Pe)if(Array.isArray(Pe))for(let Ie=0;Ie<Pe.length;Ie++){const Ne=Pe[Ie];jt(Ne,ae,te),ee.add(Ne)}else jt(Pe,ae,te),ee.add(Pe)}),A=g.pop(),ee},this.compileAsync=function(N,X,ae=null){const ee=this.compile(N,X,ae);return new Promise(te=>{function Pe(){if(ee.forEach(function(Ie){Z.get(Ie).currentProgram.isReady()&&ee.delete(Ie)}),ee.size===0){te(N);return}setTimeout(Pe,10)}qe.get("KHR_parallel_shader_compile")!==null?Pe():setTimeout(Pe,10)})};let Zr=null;function Mv(N){Zr&&Zr(N)}function kh(){Sr.stop()}function Oh(){Sr.start()}const Sr=new pv;Sr.setAnimationLoop(Mv),typeof self<"u"&&Sr.setContext(self),this.setAnimationLoop=function(N){Zr=N,ie.setAnimationLoop(N),N===null?Sr.stop():Sr.start()},ie.addEventListener("sessionstart",kh),ie.addEventListener("sessionend",Oh),this.render=function(N,X){if(X!==void 0&&X.isCamera!==!0){ut("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;z!==null&&z.renderStart(N,X);const ae=ie.enabled===!0&&ie.isPresenting===!0,ee=R!==null&&(b===null||ae)&&R.begin(C,b);if(N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),X.parent===null&&X.matrixWorldAutoUpdate===!0&&X.updateMatrixWorld(),ie.enabled===!0&&ie.isPresenting===!0&&(R===null||R.isCompositing()===!1)&&(ie.cameraAutoUpdate===!0&&ie.updateCamera(X),X=ie.getCamera()),N.isScene===!0&&N.onBeforeRender(C,N,X,b),A=Ce.get(N,g.length),A.init(X),A.state.textureUnits=oe.getTextureUnits(),g.push(A),Ge.multiplyMatrices(X.projectionMatrix,X.matrixWorldInverse),_e.setFromProjectionMatrix(Ge,fi,X.reversedDepth),Fe=this.localClippingEnabled,we=ke.init(this.clippingPlanes,Fe),T=Te.get(N,P.length),T.init(),P.push(T),ie.enabled===!0&&ie.isPresenting===!0){const Ie=C.xr.getDepthSensingMesh();Ie!==null&&_c(Ie,X,-1/0,C.sortObjects)}_c(N,X,0,C.sortObjects),T.finish(),C.sortObjects===!0&&T.sort(ge,me,X.reversedDepth),Ke=ie.enabled===!1||ie.isPresenting===!1||ie.hasDepthSensing()===!1,Ke&&je.addToRenderList(T,N),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),we===!0&&ke.beginShadows();const te=A.state.shadowsArray;if(Oe.render(te,N,X),we===!0&&ke.endShadows(),(ee&&R.hasRenderPass())===!1){const Ie=T.opaque,Ne=T.transmissive;if(A.setupLights(),X.isArrayCamera){const Be=X.cameras;if(Ne.length>0)for(let Ve=0,Qe=Be.length;Ve<Qe;Ve++){const it=Be[Ve];Bh(Ie,Ne,N,it)}Ke&&je.render(N);for(let Ve=0,Qe=Be.length;Ve<Qe;Ve++){const it=Be[Ve];zh(T,N,it,it.viewport)}}else Ne.length>0&&Bh(Ie,Ne,N,X),Ke&&je.render(N),zh(T,N,X)}b!==null&&$===0&&(oe.updateMultisampleRenderTarget(b),oe.updateRenderTargetMipmap(b)),ee&&R.end(C),N.isScene===!0&&N.onAfterRender(C,N,X),re.resetDefaultState(),E=-1,L=null,g.pop(),g.length>0?(A=g[g.length-1],oe.setTextureUnits(A.state.textureUnits),we===!0&&ke.setGlobalState(C.clippingPlanes,A.state.camera)):A=null,P.pop(),P.length>0?T=P[P.length-1]:T=null,z!==null&&z.renderEnd()};function _c(N,X,ae,ee){if(N.visible===!1)return;if(N.layers.test(X.layers)){if(N.isGroup)ae=N.renderOrder;else if(N.isLOD)N.autoUpdate===!0&&N.update(X);else if(N.isLightProbeGrid)A.pushLightProbeGrid(N);else if(N.isLight)A.pushLight(N),N.castShadow&&A.pushShadow(N);else if(N.isSprite){if(!N.frustumCulled||_e.intersectsSprite(N)){ee&&Ye.setFromMatrixPosition(N.matrixWorld).applyMatrix4(Ge);const Ie=pe.update(N),Ne=N.material;Ne.visible&&T.push(N,Ie,Ne,ae,Ye.z,null)}}else if((N.isMesh||N.isLine||N.isPoints)&&(!N.frustumCulled||_e.intersectsObject(N))){const Ie=pe.update(N),Ne=N.material;if(ee&&(N.boundingSphere!==void 0?(N.boundingSphere===null&&N.computeBoundingSphere(),Ye.copy(N.boundingSphere.center)):(Ie.boundingSphere===null&&Ie.computeBoundingSphere(),Ye.copy(Ie.boundingSphere.center)),Ye.applyMatrix4(N.matrixWorld).applyMatrix4(Ge)),Array.isArray(Ne)){const Be=Ie.groups;for(let Ve=0,Qe=Be.length;Ve<Qe;Ve++){const it=Be[Ve],He=Ne[it.materialIndex];He&&He.visible&&T.push(N,Ie,He,ae,Ye.z,it)}}else Ne.visible&&T.push(N,Ie,Ne,ae,Ye.z,null)}}const Pe=N.children;for(let Ie=0,Ne=Pe.length;Ie<Ne;Ie++)_c(Pe[Ie],X,ae,ee)}function zh(N,X,ae,ee){const{opaque:te,transmissive:Pe,transparent:Ie}=N;A.setupLightsView(ae),we===!0&&ke.setGlobalState(C.clippingPlanes,ae),ee&&S.viewport(O.copy(ee)),te.length>0&&uo(te,X,ae),Pe.length>0&&uo(Pe,X,ae),Ie.length>0&&uo(Ie,X,ae),S.buffers.depth.setTest(!0),S.buffers.depth.setMask(!0),S.buffers.color.setMask(!0),S.setPolygonOffset(!1)}function Bh(N,X,ae,ee){if((ae.isScene===!0?ae.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[ee.id]===void 0){const He=qe.has("EXT_color_buffer_half_float")||qe.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[ee.id]=new gi(1,1,{generateMipmaps:!0,type:He?ki:Cn,minFilter:Ur,samples:Math.max(4,I.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:at.workingColorSpace})}const Pe=A.state.transmissionRenderTarget[ee.id],Ie=ee.viewport||O;Pe.setSize(Ie.z*C.transmissionResolutionScale,Ie.w*C.transmissionResolutionScale);const Ne=C.getRenderTarget(),Be=C.getActiveCubeFace(),Ve=C.getActiveMipmapLevel();C.setRenderTarget(Pe),C.getClearColor(he),se=C.getClearAlpha(),se<1&&C.setClearColor(16777215,.5),C.clear(),Ke&&je.render(ae);const Qe=C.toneMapping;C.toneMapping=mi;const it=ee.viewport;if(ee.viewport!==void 0&&(ee.viewport=void 0),A.setupLightsView(ee),we===!0&&ke.setGlobalState(C.clippingPlanes,ee),uo(N,ae,ee),oe.updateMultisampleRenderTarget(Pe),oe.updateRenderTargetMipmap(Pe),qe.has("WEBGL_multisampled_render_to_texture")===!1){let He=!1;for(let gt=0,Lt=X.length;gt<Lt;gt++){const Rt=X[gt],{object:xt,geometry:Yt,material:Le,group:Mn}=Rt;if(Le.side===ui&&xt.layers.test(ee.layers)){const ct=Le.side;Le.side=yn,Le.needsUpdate=!0,Vh(xt,ae,ee,Yt,Le,Mn),Le.side=ct,Le.needsUpdate=!0,He=!0}}He===!0&&(oe.updateMultisampleRenderTarget(Pe),oe.updateRenderTargetMipmap(Pe))}C.setRenderTarget(Ne,Be,Ve),C.setClearColor(he,se),it!==void 0&&(ee.viewport=it),C.toneMapping=Qe}function uo(N,X,ae){const ee=X.isScene===!0?X.overrideMaterial:null;for(let te=0,Pe=N.length;te<Pe;te++){const Ie=N[te],{object:Ne,geometry:Be,group:Ve}=Ie;let Qe=Ie.material;Qe.allowOverride===!0&&ee!==null&&(Qe=ee),Ne.layers.test(ae.layers)&&Vh(Ne,X,ae,Be,Qe,Ve)}}function Vh(N,X,ae,ee,te,Pe){N.onBeforeRender(C,X,ae,ee,te,Pe),N.modelViewMatrix.multiplyMatrices(ae.matrixWorldInverse,N.matrixWorld),N.normalMatrix.getNormalMatrix(N.modelViewMatrix),te.onBeforeRender(C,X,ae,ee,N,Pe),te.transparent===!0&&te.side===ui&&te.forceSinglePass===!1?(te.side=yn,te.needsUpdate=!0,C.renderBufferDirect(ae,X,ee,te,N,Pe),te.side=gr,te.needsUpdate=!0,C.renderBufferDirect(ae,X,ee,te,N,Pe),te.side=ui):C.renderBufferDirect(ae,X,ee,te,N,Pe),N.onAfterRender(C,X,ae,ee,te,Pe)}function fo(N,X,ae){X.isScene!==!0&&(X=Je);const ee=Z.get(N),te=A.state.lights,Pe=A.state.shadowsArray,Ie=te.state.version,Ne=be.getParameters(N,te.state,Pe,X,ae,A.state.lightProbeGridArray),Be=be.getProgramCacheKey(Ne);let Ve=ee.programs;ee.environment=N.isMeshStandardMaterial||N.isMeshLambertMaterial||N.isMeshPhongMaterial?X.environment:null,ee.fog=X.fog;const Qe=N.isMeshStandardMaterial||N.isMeshLambertMaterial&&!N.envMap||N.isMeshPhongMaterial&&!N.envMap;ee.envMap=xe.get(N.envMap||ee.environment,Qe),ee.envMapRotation=ee.environment!==null&&N.envMap===null?X.environmentRotation:N.envMapRotation,Ve===void 0&&(N.addEventListener("dispose",ht),Ve=new Map,ee.programs=Ve);let it=Ve.get(Be);if(it!==void 0){if(ee.currentProgram===it&&ee.lightsStateVersion===Ie)return Gh(N,Ne),it}else Ne.uniforms=be.getUniforms(N),z!==null&&N.isNodeMaterial&&z.build(N,ae,Ne),N.onBeforeCompile(Ne,C),it=be.acquireProgram(Ne,Be),Ve.set(Be,it),ee.uniforms=Ne.uniforms;const He=ee.uniforms;return(!N.isShaderMaterial&&!N.isRawShaderMaterial||N.clipping===!0)&&(He.clippingPlanes=ke.uniform),Gh(N,Ne),ee.needsLights=Tv(N),ee.lightsStateVersion=Ie,ee.needsLights&&(He.ambientLightColor.value=te.state.ambient,He.lightProbe.value=te.state.probe,He.directionalLights.value=te.state.directional,He.directionalLightShadows.value=te.state.directionalShadow,He.spotLights.value=te.state.spot,He.spotLightShadows.value=te.state.spotShadow,He.rectAreaLights.value=te.state.rectArea,He.ltc_1.value=te.state.rectAreaLTC1,He.ltc_2.value=te.state.rectAreaLTC2,He.pointLights.value=te.state.point,He.pointLightShadows.value=te.state.pointShadow,He.hemisphereLights.value=te.state.hemi,He.directionalShadowMatrix.value=te.state.directionalShadowMatrix,He.spotLightMatrix.value=te.state.spotLightMatrix,He.spotLightMap.value=te.state.spotLightMap,He.pointShadowMatrix.value=te.state.pointShadowMatrix),ee.lightProbeGrid=A.state.lightProbeGridArray.length>0,ee.currentProgram=it,ee.uniformsList=null,it}function Hh(N){if(N.uniformsList===null){const X=N.currentProgram.getUniforms();N.uniformsList=vl.seqWithValue(X.seq,N.uniforms)}return N.uniformsList}function Gh(N,X){const ae=Z.get(N);ae.outputColorSpace=X.outputColorSpace,ae.batching=X.batching,ae.batchingColor=X.batchingColor,ae.instancing=X.instancing,ae.instancingColor=X.instancingColor,ae.instancingMorph=X.instancingMorph,ae.skinning=X.skinning,ae.morphTargets=X.morphTargets,ae.morphNormals=X.morphNormals,ae.morphColors=X.morphColors,ae.morphTargetsCount=X.morphTargetsCount,ae.numClippingPlanes=X.numClippingPlanes,ae.numIntersection=X.numClipIntersection,ae.vertexAlphas=X.vertexAlphas,ae.vertexTangents=X.vertexTangents,ae.toneMapping=X.toneMapping}function wv(N,X){if(N.length===0)return null;if(N.length===1)return N[0].texture!==null?N[0]:null;y.setFromMatrixPosition(X.matrixWorld);for(let ae=0,ee=N.length;ae<ee;ae++){const te=N[ae];if(te.texture!==null&&te.boundingBox.containsPoint(y))return te}return null}function Ev(N,X,ae,ee,te){X.isScene!==!0&&(X=Je),oe.resetTextureUnits();const Pe=X.fog,Ie=ee.isMeshStandardMaterial||ee.isMeshLambertMaterial||ee.isMeshPhongMaterial?X.environment:null,Ne=b===null?C.outputColorSpace:b.isXRRenderTarget===!0?b.texture.colorSpace:at.workingColorSpace,Be=ee.isMeshStandardMaterial||ee.isMeshLambertMaterial&&!ee.envMap||ee.isMeshPhongMaterial&&!ee.envMap,Ve=xe.get(ee.envMap||Ie,Be),Qe=ee.vertexColors===!0&&!!ae.attributes.color&&ae.attributes.color.itemSize===4,it=!!ae.attributes.tangent&&(!!ee.normalMap||ee.anisotropy>0),He=!!ae.morphAttributes.position,gt=!!ae.morphAttributes.normal,Lt=!!ae.morphAttributes.color;let Rt=mi;ee.toneMapped&&(b===null||b.isXRRenderTarget===!0)&&(Rt=C.toneMapping);const xt=ae.morphAttributes.position||ae.morphAttributes.normal||ae.morphAttributes.color,Yt=xt!==void 0?xt.length:0,Le=Z.get(ee),Mn=A.state.lights;if(we===!0&&(Fe===!0||N!==L)){const _t=N===L&&ee.id===E;ke.setState(ee,N,_t)}let ct=!1;ee.version===Le.__version?(Le.needsLights&&Le.lightsStateVersion!==Mn.state.version||Le.outputColorSpace!==Ne||te.isBatchedMesh&&Le.batching===!1||!te.isBatchedMesh&&Le.batching===!0||te.isBatchedMesh&&Le.batchingColor===!0&&te.colorTexture===null||te.isBatchedMesh&&Le.batchingColor===!1&&te.colorTexture!==null||te.isInstancedMesh&&Le.instancing===!1||!te.isInstancedMesh&&Le.instancing===!0||te.isSkinnedMesh&&Le.skinning===!1||!te.isSkinnedMesh&&Le.skinning===!0||te.isInstancedMesh&&Le.instancingColor===!0&&te.instanceColor===null||te.isInstancedMesh&&Le.instancingColor===!1&&te.instanceColor!==null||te.isInstancedMesh&&Le.instancingMorph===!0&&te.morphTexture===null||te.isInstancedMesh&&Le.instancingMorph===!1&&te.morphTexture!==null||Le.envMap!==Ve||ee.fog===!0&&Le.fog!==Pe||Le.numClippingPlanes!==void 0&&(Le.numClippingPlanes!==ke.numPlanes||Le.numIntersection!==ke.numIntersection)||Le.vertexAlphas!==Qe||Le.vertexTangents!==it||Le.morphTargets!==He||Le.morphNormals!==gt||Le.morphColors!==Lt||Le.toneMapping!==Rt||Le.morphTargetsCount!==Yt||!!Le.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(ct=!0):(ct=!0,Le.__version=ee.version);let Dn=Le.currentProgram;ct===!0&&(Dn=fo(ee,X,te),z&&ee.isNodeMaterial&&z.onUpdateProgram(ee,Dn,Le));let ii=!1,Bi=!1,Qr=!1;const vt=Dn.getUniforms(),Dt=Le.uniforms;if(S.useProgram(Dn.program)&&(ii=!0,Bi=!0,Qr=!0),ee.id!==E&&(E=ee.id,Bi=!0),Le.needsLights){const _t=wv(A.state.lightProbeGridArray,te);Le.lightProbeGrid!==_t&&(Le.lightProbeGrid=_t,Bi=!0)}if(ii||L!==N){S.buffers.depth.getReversed()&&N.reversedDepth!==!0&&(N._reversedDepth=!0,N.updateProjectionMatrix()),vt.setValue(B,"projectionMatrix",N.projectionMatrix),vt.setValue(B,"viewMatrix",N.matrixWorldInverse);const Hi=vt.map.cameraPosition;Hi!==void 0&&Hi.setValue(B,Xe.setFromMatrixPosition(N.matrixWorld)),I.logarithmicDepthBuffer&&vt.setValue(B,"logDepthBufFC",2/(Math.log(N.far+1)/Math.LN2)),(ee.isMeshPhongMaterial||ee.isMeshToonMaterial||ee.isMeshLambertMaterial||ee.isMeshBasicMaterial||ee.isMeshStandardMaterial||ee.isShaderMaterial)&&vt.setValue(B,"isOrthographic",N.isOrthographicCamera===!0),L!==N&&(L=N,Bi=!0,Qr=!0)}if(Le.needsLights&&(Mn.state.directionalShadowMap.length>0&&vt.setValue(B,"directionalShadowMap",Mn.state.directionalShadowMap,oe),Mn.state.spotShadowMap.length>0&&vt.setValue(B,"spotShadowMap",Mn.state.spotShadowMap,oe),Mn.state.pointShadowMap.length>0&&vt.setValue(B,"pointShadowMap",Mn.state.pointShadowMap,oe)),te.isSkinnedMesh){vt.setOptional(B,te,"bindMatrix"),vt.setOptional(B,te,"bindMatrixInverse");const _t=te.skeleton;_t&&(_t.boneTexture===null&&_t.computeBoneTexture(),vt.setValue(B,"boneTexture",_t.boneTexture,oe))}te.isBatchedMesh&&(vt.setOptional(B,te,"batchingTexture"),vt.setValue(B,"batchingTexture",te._matricesTexture,oe),vt.setOptional(B,te,"batchingIdTexture"),vt.setValue(B,"batchingIdTexture",te._indirectTexture,oe),vt.setOptional(B,te,"batchingColorTexture"),te._colorsTexture!==null&&vt.setValue(B,"batchingColorTexture",te._colorsTexture,oe));const Vi=ae.morphAttributes;if((Vi.position!==void 0||Vi.normal!==void 0||Vi.color!==void 0)&&G.update(te,ae,Dn),(Bi||Le.receiveShadow!==te.receiveShadow)&&(Le.receiveShadow=te.receiveShadow,vt.setValue(B,"receiveShadow",te.receiveShadow)),(ee.isMeshStandardMaterial||ee.isMeshLambertMaterial||ee.isMeshPhongMaterial)&&ee.envMap===null&&X.environment!==null&&(Dt.envMapIntensity.value=X.environmentIntensity),Dt.dfgLUT!==void 0&&(Dt.dfgLUT.value=L2()),Bi){if(vt.setValue(B,"toneMappingExposure",C.toneMappingExposure),Le.needsLights&&bv(Dt,Qr),Pe&&ee.fog===!0&&De.refreshFogUniforms(Dt,Pe),De.refreshMaterialUniforms(Dt,ee,K,q,A.state.transmissionRenderTarget[N.id]),Le.needsLights&&Le.lightProbeGrid){const _t=Le.lightProbeGrid;Dt.probesSH.value=_t.texture,Dt.probesMin.value.copy(_t.boundingBox.min),Dt.probesMax.value.copy(_t.boundingBox.max),Dt.probesResolution.value.copy(_t.resolution)}vl.upload(B,Hh(Le),Dt,oe)}if(ee.isShaderMaterial&&ee.uniformsNeedUpdate===!0&&(vl.upload(B,Hh(Le),Dt,oe),ee.uniformsNeedUpdate=!1),ee.isSpriteMaterial&&vt.setValue(B,"center",te.center),vt.setValue(B,"modelViewMatrix",te.modelViewMatrix),vt.setValue(B,"normalMatrix",te.normalMatrix),vt.setValue(B,"modelMatrix",te.matrixWorld),ee.uniformsGroups!==void 0){const _t=ee.uniformsGroups;for(let Hi=0,Jr=_t.length;Hi<Jr;Hi++){const jh=_t[Hi];W.update(jh,Dn),W.bind(jh,Dn)}}return Dn}function bv(N,X){N.ambientLightColor.needsUpdate=X,N.lightProbe.needsUpdate=X,N.directionalLights.needsUpdate=X,N.directionalLightShadows.needsUpdate=X,N.pointLights.needsUpdate=X,N.pointLightShadows.needsUpdate=X,N.spotLights.needsUpdate=X,N.spotLightShadows.needsUpdate=X,N.rectAreaLights.needsUpdate=X,N.hemisphereLights.needsUpdate=X}function Tv(N){return N.isMeshLambertMaterial||N.isMeshToonMaterial||N.isMeshPhongMaterial||N.isMeshStandardMaterial||N.isShadowMaterial||N.isShaderMaterial&&N.lights===!0}this.getActiveCubeFace=function(){return Q},this.getActiveMipmapLevel=function(){return $},this.getRenderTarget=function(){return b},this.setRenderTargetTextures=function(N,X,ae){const ee=Z.get(N);ee.__autoAllocateDepthBuffer=N.resolveDepthBuffer===!1,ee.__autoAllocateDepthBuffer===!1&&(ee.__useRenderToTexture=!1),Z.get(N.texture).__webglTexture=X,Z.get(N.depthTexture).__webglTexture=ee.__autoAllocateDepthBuffer?void 0:ae,ee.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(N,X){const ae=Z.get(N);ae.__webglFramebuffer=X,ae.__useDefaultFramebuffer=X===void 0},this.setRenderTarget=function(N,X=0,ae=0){b=N,Q=X,$=ae;let ee=null,te=!1,Pe=!1;if(N){const Ne=Z.get(N);if(Ne.__useDefaultFramebuffer!==void 0){S.bindFramebuffer(B.FRAMEBUFFER,Ne.__webglFramebuffer),O.copy(N.viewport),U.copy(N.scissor),ce=N.scissorTest,S.viewport(O),S.scissor(U),S.setScissorTest(ce),E=-1;return}else if(Ne.__webglFramebuffer===void 0)oe.setupRenderTarget(N);else if(Ne.__hasExternalTextures)oe.rebindTextures(N,Z.get(N.texture).__webglTexture,Z.get(N.depthTexture).__webglTexture);else if(N.depthBuffer){const Qe=N.depthTexture;if(Ne.__boundDepthTexture!==Qe){if(Qe!==null&&Z.has(Qe)&&(N.width!==Qe.image.width||N.height!==Qe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");oe.setupDepthRenderbuffer(N)}}const Be=N.texture;(Be.isData3DTexture||Be.isDataArrayTexture||Be.isCompressedArrayTexture)&&(Pe=!0);const Ve=Z.get(N).__webglFramebuffer;N.isWebGLCubeRenderTarget?(Array.isArray(Ve[X])?ee=Ve[X][ae]:ee=Ve[X],te=!0):N.samples>0&&oe.useMultisampledRTT(N)===!1?ee=Z.get(N).__webglMultisampledFramebuffer:Array.isArray(Ve)?ee=Ve[ae]:ee=Ve,O.copy(N.viewport),U.copy(N.scissor),ce=N.scissorTest}else O.copy(ue).multiplyScalar(K).floor(),U.copy(Re).multiplyScalar(K).floor(),ce=Me;if(ae!==0&&(ee=j),S.bindFramebuffer(B.FRAMEBUFFER,ee)&&S.drawBuffers(N,ee),S.viewport(O),S.scissor(U),S.setScissorTest(ce),te){const Ne=Z.get(N.texture);B.framebufferTexture2D(B.FRAMEBUFFER,B.COLOR_ATTACHMENT0,B.TEXTURE_CUBE_MAP_POSITIVE_X+X,Ne.__webglTexture,ae)}else if(Pe){const Ne=X;for(let Be=0;Be<N.textures.length;Be++){const Ve=Z.get(N.textures[Be]);B.framebufferTextureLayer(B.FRAMEBUFFER,B.COLOR_ATTACHMENT0+Be,Ve.__webglTexture,ae,Ne)}}else if(N!==null&&ae!==0){const Ne=Z.get(N.texture);B.framebufferTexture2D(B.FRAMEBUFFER,B.COLOR_ATTACHMENT0,B.TEXTURE_2D,Ne.__webglTexture,ae)}E=-1},this.readRenderTargetPixels=function(N,X,ae,ee,te,Pe,Ie,Ne=0){if(!(N&&N.isWebGLRenderTarget)){ut("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Be=Z.get(N).__webglFramebuffer;if(N.isWebGLCubeRenderTarget&&Ie!==void 0&&(Be=Be[Ie]),Be){S.bindFramebuffer(B.FRAMEBUFFER,Be);try{const Ve=N.textures[Ne],Qe=Ve.format,it=Ve.type;if(N.textures.length>1&&B.readBuffer(B.COLOR_ATTACHMENT0+Ne),!I.textureFormatReadable(Qe)){ut("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!I.textureTypeReadable(it)){ut("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}X>=0&&X<=N.width-ee&&ae>=0&&ae<=N.height-te&&B.readPixels(X,ae,ee,te,F.convert(Qe),F.convert(it),Pe)}finally{const Ve=b!==null?Z.get(b).__webglFramebuffer:null;S.bindFramebuffer(B.FRAMEBUFFER,Ve)}}},this.readRenderTargetPixelsAsync=async function(N,X,ae,ee,te,Pe,Ie,Ne=0){if(!(N&&N.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Be=Z.get(N).__webglFramebuffer;if(N.isWebGLCubeRenderTarget&&Ie!==void 0&&(Be=Be[Ie]),Be)if(X>=0&&X<=N.width-ee&&ae>=0&&ae<=N.height-te){S.bindFramebuffer(B.FRAMEBUFFER,Be);const Ve=N.textures[Ne],Qe=Ve.format,it=Ve.type;if(N.textures.length>1&&B.readBuffer(B.COLOR_ATTACHMENT0+Ne),!I.textureFormatReadable(Qe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!I.textureTypeReadable(it))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const He=B.createBuffer();B.bindBuffer(B.PIXEL_PACK_BUFFER,He),B.bufferData(B.PIXEL_PACK_BUFFER,Pe.byteLength,B.STREAM_READ),B.readPixels(X,ae,ee,te,F.convert(Qe),F.convert(it),0);const gt=b!==null?Z.get(b).__webglFramebuffer:null;S.bindFramebuffer(B.FRAMEBUFFER,gt);const Lt=B.fenceSync(B.SYNC_GPU_COMMANDS_COMPLETE,0);return B.flush(),await Q1(B,Lt,4),B.bindBuffer(B.PIXEL_PACK_BUFFER,He),B.getBufferSubData(B.PIXEL_PACK_BUFFER,0,Pe),B.deleteBuffer(He),B.deleteSync(Lt),Pe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(N,X=null,ae=0){const ee=Math.pow(2,-ae),te=Math.floor(N.image.width*ee),Pe=Math.floor(N.image.height*ee),Ie=X!==null?X.x:0,Ne=X!==null?X.y:0;oe.setTexture2D(N,0),B.copyTexSubImage2D(B.TEXTURE_2D,ae,0,0,Ie,Ne,te,Pe),S.unbindTexture()},this.copyTextureToTexture=function(N,X,ae=null,ee=null,te=0,Pe=0){let Ie,Ne,Be,Ve,Qe,it,He,gt,Lt;const Rt=N.isCompressedTexture?N.mipmaps[Pe]:N.image;if(ae!==null)Ie=ae.max.x-ae.min.x,Ne=ae.max.y-ae.min.y,Be=ae.isBox3?ae.max.z-ae.min.z:1,Ve=ae.min.x,Qe=ae.min.y,it=ae.isBox3?ae.min.z:0;else{const Dt=Math.pow(2,-te);Ie=Math.floor(Rt.width*Dt),Ne=Math.floor(Rt.height*Dt),N.isDataArrayTexture?Be=Rt.depth:N.isData3DTexture?Be=Math.floor(Rt.depth*Dt):Be=1,Ve=0,Qe=0,it=0}ee!==null?(He=ee.x,gt=ee.y,Lt=ee.z):(He=0,gt=0,Lt=0);const xt=F.convert(X.format),Yt=F.convert(X.type);let Le;X.isData3DTexture?(oe.setTexture3D(X,0),Le=B.TEXTURE_3D):X.isDataArrayTexture||X.isCompressedArrayTexture?(oe.setTexture2DArray(X,0),Le=B.TEXTURE_2D_ARRAY):(oe.setTexture2D(X,0),Le=B.TEXTURE_2D),S.activeTexture(B.TEXTURE0),S.pixelStorei(B.UNPACK_FLIP_Y_WEBGL,X.flipY),S.pixelStorei(B.UNPACK_PREMULTIPLY_ALPHA_WEBGL,X.premultiplyAlpha),S.pixelStorei(B.UNPACK_ALIGNMENT,X.unpackAlignment);const Mn=S.getParameter(B.UNPACK_ROW_LENGTH),ct=S.getParameter(B.UNPACK_IMAGE_HEIGHT),Dn=S.getParameter(B.UNPACK_SKIP_PIXELS),ii=S.getParameter(B.UNPACK_SKIP_ROWS),Bi=S.getParameter(B.UNPACK_SKIP_IMAGES);S.pixelStorei(B.UNPACK_ROW_LENGTH,Rt.width),S.pixelStorei(B.UNPACK_IMAGE_HEIGHT,Rt.height),S.pixelStorei(B.UNPACK_SKIP_PIXELS,Ve),S.pixelStorei(B.UNPACK_SKIP_ROWS,Qe),S.pixelStorei(B.UNPACK_SKIP_IMAGES,it);const Qr=N.isDataArrayTexture||N.isData3DTexture,vt=X.isDataArrayTexture||X.isData3DTexture;if(N.isDepthTexture){const Dt=Z.get(N),Vi=Z.get(X),_t=Z.get(Dt.__renderTarget),Hi=Z.get(Vi.__renderTarget);S.bindFramebuffer(B.READ_FRAMEBUFFER,_t.__webglFramebuffer),S.bindFramebuffer(B.DRAW_FRAMEBUFFER,Hi.__webglFramebuffer);for(let Jr=0;Jr<Be;Jr++)Qr&&(B.framebufferTextureLayer(B.READ_FRAMEBUFFER,B.COLOR_ATTACHMENT0,Z.get(N).__webglTexture,te,it+Jr),B.framebufferTextureLayer(B.DRAW_FRAMEBUFFER,B.COLOR_ATTACHMENT0,Z.get(X).__webglTexture,Pe,Lt+Jr)),B.blitFramebuffer(Ve,Qe,Ie,Ne,He,gt,Ie,Ne,B.DEPTH_BUFFER_BIT,B.NEAREST);S.bindFramebuffer(B.READ_FRAMEBUFFER,null),S.bindFramebuffer(B.DRAW_FRAMEBUFFER,null)}else if(te!==0||N.isRenderTargetTexture||Z.has(N)){const Dt=Z.get(N),Vi=Z.get(X);S.bindFramebuffer(B.READ_FRAMEBUFFER,ne),S.bindFramebuffer(B.DRAW_FRAMEBUFFER,V);for(let _t=0;_t<Be;_t++)Qr?B.framebufferTextureLayer(B.READ_FRAMEBUFFER,B.COLOR_ATTACHMENT0,Dt.__webglTexture,te,it+_t):B.framebufferTexture2D(B.READ_FRAMEBUFFER,B.COLOR_ATTACHMENT0,B.TEXTURE_2D,Dt.__webglTexture,te),vt?B.framebufferTextureLayer(B.DRAW_FRAMEBUFFER,B.COLOR_ATTACHMENT0,Vi.__webglTexture,Pe,Lt+_t):B.framebufferTexture2D(B.DRAW_FRAMEBUFFER,B.COLOR_ATTACHMENT0,B.TEXTURE_2D,Vi.__webglTexture,Pe),te!==0?B.blitFramebuffer(Ve,Qe,Ie,Ne,He,gt,Ie,Ne,B.COLOR_BUFFER_BIT,B.NEAREST):vt?B.copyTexSubImage3D(Le,Pe,He,gt,Lt+_t,Ve,Qe,Ie,Ne):B.copyTexSubImage2D(Le,Pe,He,gt,Ve,Qe,Ie,Ne);S.bindFramebuffer(B.READ_FRAMEBUFFER,null),S.bindFramebuffer(B.DRAW_FRAMEBUFFER,null)}else vt?N.isDataTexture||N.isData3DTexture?B.texSubImage3D(Le,Pe,He,gt,Lt,Ie,Ne,Be,xt,Yt,Rt.data):X.isCompressedArrayTexture?B.compressedTexSubImage3D(Le,Pe,He,gt,Lt,Ie,Ne,Be,xt,Rt.data):B.texSubImage3D(Le,Pe,He,gt,Lt,Ie,Ne,Be,xt,Yt,Rt):N.isDataTexture?B.texSubImage2D(B.TEXTURE_2D,Pe,He,gt,Ie,Ne,xt,Yt,Rt.data):N.isCompressedTexture?B.compressedTexSubImage2D(B.TEXTURE_2D,Pe,He,gt,Rt.width,Rt.height,xt,Rt.data):B.texSubImage2D(B.TEXTURE_2D,Pe,He,gt,Ie,Ne,xt,Yt,Rt);S.pixelStorei(B.UNPACK_ROW_LENGTH,Mn),S.pixelStorei(B.UNPACK_IMAGE_HEIGHT,ct),S.pixelStorei(B.UNPACK_SKIP_PIXELS,Dn),S.pixelStorei(B.UNPACK_SKIP_ROWS,ii),S.pixelStorei(B.UNPACK_SKIP_IMAGES,Bi),Pe===0&&X.generateMipmaps&&B.generateMipmap(Le),S.unbindTexture()},this.initRenderTarget=function(N){Z.get(N).__webglFramebuffer===void 0&&oe.setupRenderTarget(N)},this.initTexture=function(N){N.isCubeTexture?oe.setTextureCube(N,0):N.isData3DTexture?oe.setTexture3D(N,0):N.isDataArrayTexture||N.isCompressedArrayTexture?oe.setTexture2DArray(N,0):oe.setTexture2D(N,0),S.unbindTexture()},this.resetState=function(){Q=0,$=0,b=null,S.reset(),re.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return fi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=at._getDrawingBufferColorSpace(e),n.unpackColorSpace=at._getUnpackColorSpace()}}const I2=({open:t})=>{const e=le.useRef(null),n=le.useRef(null),i=le.useRef(null),r=le.useRef(null),s=le.useRef([]),a=le.useRef(null),o=le.useRef(t);return le.useEffect(()=>{o.current=t},[t]),le.useEffect(()=>{const c=e.current;if(!c)return;const u=window.innerWidth,h=window.innerHeight,p=new pM;i.current=p;const f=new On(45,u/h,.1,100);f.position.set(0,0,12),r.current=f;const m=new D2({alpha:!0,antialias:!0});m.setSize(u,h),m.setPixelRatio(Math.min(window.devicePixelRatio,2)),m.shadowMap.enabled=!0,m.shadowMap.type=Da,n.current=m,c.appendChild(m.domElement);const _=new UM(16777215,.45);p.add(_);const w=new Hm(16772566,1.2);w.position.set(5,8,8),w.castShadow=!0,w.shadow.mapSize.width=1024,w.shadow.mapSize.height=1024,w.shadow.camera.near=.1,w.shadow.camera.far=30,w.shadow.camera.left=-15,w.shadow.camera.right=15,w.shadow.camera.top=15,w.shadow.camera.bottom=-15,p.add(w);const x=new Hm(12773887,.35);x.position.set(-4,2,-5),p.add(x);const d=12,v=45*Math.PI/180,M=2*Math.tan(v/2)*d,y=M*(u/h),T=y*1.02,A=y*.48,P=M*.035,g=M*.028,R=M*.006,C=M*.008,D=M*.02,z=M/2-P/2,j=M-P-D,ne=Math.floor(j/(g+C)),V=new qr(T,g,R),Q=new wu({color:2763306,roughness:.85,metalness:.1}),$=[],b=z-P/2-D-g/2;for(let _e=0;_e<ne;_e++){const we=new en(V,Q);we.position.y=b-_e*(g+C),we.castShadow=!0,we.receiveShadow=!0,p.add(we),$.push(we)}s.current=$;const E=M*.005,L=new Ah(E,E,j,8),O=new wu({color:15790320,roughness:.9}),U=R+.02,ce=new en(L,O);ce.position.set(-A,b-j/2,U),p.add(ce);const he=new en(L,O);he.position.set(A,b-j/2,U),p.add(he);const se=new Rh(E*1.4,8,8);for(let _e=0;_e<ne;_e++){const we=b-_e*(g+C),Fe=new en(se,O);Fe.position.set(-A,we,U),p.add(Fe);const Ge=new en(se,O);Ge.position.set(A,we,U),p.add(Ge)}const k=new qr(T+M*.02,P,M*.018),q=new wu({color:2039583,roughness:.8,metalness:.1}),K=new en(k,q);K.position.y=z,K.position.z=R/2,K.castShadow=!0,K.receiveShadow=!0,p.add(K);const ge=new co(y*2,M*2),me=new Th({color:0,transparent:!0,opacity:0,side:ui,depthWrite:!1}),ue=new en(ge,me);ue.position.z=-2,p.add(ue);const Re=()=>{const _e=window.innerWidth,we=window.innerHeight;f.aspect=_e/we,f.updateProjectionMatrix(),m.setSize(_e,we)};window.addEventListener("resize",Re);const Me=()=>{a.current=requestAnimationFrame(Me);const _e=o.current?.85:0,we=o.current?.35:1,Fe=o.current?.25:.85;s.current.forEach(Ge=>{Ge.rotation.x+=(_e-Ge.rotation.x)*.08,Ge.scale.y+=(we-Ge.scale.y)*.08}),ue.material.opacity+=(Fe-ue.material.opacity)*.05,m.render(p,f)};return Me(),()=>{window.removeEventListener("resize",Re),a.current&&cancelAnimationFrame(a.current),m.dispose(),c.contains(m.domElement)&&c.removeChild(m.domElement)}},[]),l.jsx("div",{ref:e,className:"absolute inset-0 z-20 pointer-events-none",style:{mixBlendMode:"normal"}})},U2=({src:t})=>{const e=le.useRef(null),n=le.useRef(null),i=le.useRef(null),r=le.useRef("A"),s=le.useRef(0),a=le.useRef(null),[o,c]=le.useState(!1);return le.useEffect(()=>{const u=n.current,h=i.current;if(!u||!h)return;let p=0;const f=()=>{p+=1,p===2&&(s.current=u.duration||2,c(!0),u.play().catch(()=>{}),r.current="A")};return u.addEventListener("loadedmetadata",f,{once:!0}),h.addEventListener("loadedmetadata",f,{once:!0}),u.load(),h.load(),()=>{a.current&&cancelAnimationFrame(a.current),u.pause(),h.pause(),u.src="",h.src="",u.load(),h.load()}},[t]),le.useEffect(()=>{if(!o)return;const u=n.current,h=i.current;if(!u||!h)return;const p=s.current,f=Math.min(p*.4,.8),m=()=>{const _=r.current==="A"?u:h,w=r.current==="A"?h:u,x=_.currentTime,d=p-x;if(d<=f&&w.paused&&w!==_&&(w.currentTime=0,w.play().catch(()=>{})),d<=f){const v=Math.max(0,Math.min(1,1-d/f));_.style.opacity=String(1-v),w.style.opacity=String(v)}else _.style.opacity="1",w.style.opacity="0";x>=p-.01&&(r.current==="A"?(r.current="B",u.currentTime=0,u.pause()):(r.current="A",h.currentTime=0,h.pause())),a.current=requestAnimationFrame(m)};return a.current=requestAnimationFrame(m),()=>{a.current&&cancelAnimationFrame(a.current)}},[o]),l.jsxs("div",{ref:e,className:"absolute inset-0 w-full h-full pointer-events-none z-20",style:{mixBlendMode:"screen"},children:[l.jsx("video",{ref:n,className:"absolute inset-0 w-full h-full object-cover",src:t,autoPlay:!1,muted:!0,playsInline:!0,preload:"auto",style:{opacity:1,filter:"grayscale(0.35) brightness(0.85) contrast(0.95) saturate(0.7)"}}),l.jsx("video",{ref:i,className:"absolute inset-0 w-full h-full object-cover",src:t,autoPlay:!1,muted:!0,playsInline:!0,preload:"auto",style:{opacity:0,filter:"grayscale(0.35) brightness(0.85) contrast(0.95) saturate(0.7)"}})]})},Ph=({onBack:t,simple:e=!1})=>{const[n,i]=le.useState(!0),[r,s]=le.useState(null),[a,o]=le.useState(!1),[c,u]=le.useState(!1),[h,p]=le.useState(0),f=le.useRef(null),m=le.useRef(null),_=[{id:"rain",label:"Pluie",icon:em,src:"/media/visualizer-add/rain.mp4"},{id:"window",label:"Vitre",icon:aS,src:"/media/visualizer-add/window.mp4"},{id:"rain_window",label:"Pluie + Vitre",icon:em,src:"/media/visualizer-add/rain-window.mp4"}],w={label:"Store"};le.useEffect(()=>{const y=g=>g&&g.target&&m.current&&m.current.contains(g.target),T=g=>{y(g)||(i(!0),f.current&&clearTimeout(f.current),f.current=setTimeout(()=>i(!1),3e3))},A=()=>{i(!0),f.current&&clearTimeout(f.current)},P=()=>{f.current&&clearTimeout(f.current),f.current=setTimeout(()=>i(!1),3e3)};return window.addEventListener("mousemove",T),m.current&&(m.current.addEventListener("mouseenter",A),m.current.addEventListener("mouseleave",P)),i(!0),f.current=setTimeout(()=>i(!1),3e3),()=>{window.removeEventListener("mousemove",T),m.current&&(m.current.removeEventListener("mouseenter",A),m.current.removeEventListener("mouseleave",P)),f.current&&clearTimeout(f.current)}},[]),le.useEffect(()=>{const y=window.location.hash.substring(1),T=y.indexOf("?");if(T>-1){const A=new URLSearchParams(y.substring(T+1)),P=A.get("overlay"),g=A.get("open");if(P){const R=P.split(","),C=R.find(z=>_.some(j=>j.id===z)),D=R.includes("blinds");s(C||null),o(D),D&&u(g==="true"),p(z=>z+1)}}},[]);const x=(y,T,A=!1)=>{const P=window.location.hash.split("?")[0],g=[];if(y&&g.push(y),T&&g.push("blinds"),g.length>0){const R=T?`&open=${A}`:"";window.location.hash=`${P}?overlay=${g.join(",")}${R}`}else window.location.hash=P},d=y=>{s(T=>{const A=T===y?null:y;return x(A,a,c),A}),p(T=>T+1)},v=()=>{o(y=>{const T=!y;return T||u(!1),x(r,T,T?c:!1),T})},M=()=>{u(y=>{const T=!y;return x(r,a,T),T})};return l.jsxs(l.Fragment,{children:[r&&l.jsx(U2,{src:_.find(y=>y.id===r).src},`${r}-${h}`),a&&l.jsx(I2,{open:c}),l.jsxs("div",{ref:m,className:`absolute top-4 left-1/2 -translate-x-1/2 z-30 flex items-center gap-2 px-4 py-3 rounded-lg border backdrop-blur-md transition-all duration-500 ${n?"opacity-100 translate-y-0":"opacity-0 -translate-y-4 pointer-events-none"}`,style:{borderColor:"rgba(6, 182, 212, 0.3)",background:"rgba(0, 0, 0, 0.75)"},children:[!e&&_.map(y=>{const T=y.icon,A=r===y.id;return l.jsxs("button",{onClick:()=>d(y.id),className:`flex items-center gap-2 px-3 py-2 rounded text-xs font-semibold tracking-wider transition-all duration-200 ${A?"bg-cyan-500/20 text-cyan-400 border border-cyan-500/40":"text-gray-400 hover:text-white hover:bg-white/5 border border-transparent"}`,title:y.label,children:[l.jsx(T,{className:"w-4 h-4"}),l.jsx("span",{className:"hidden sm:inline",children:y.label})]},y.id)}),!e&&l.jsxs("button",{onClick:v,className:`flex items-center gap-2 px-3 py-2 rounded text-xs font-semibold tracking-wider transition-all duration-200 ${a?"bg-cyan-500/20 text-cyan-400 border border-cyan-500/40":"text-gray-400 hover:text-white hover:bg-white/5 border border-transparent"}`,title:w.label,children:[l.jsx(nS,{className:"w-4 h-4"}),l.jsx("span",{className:"hidden sm:inline",children:w.label})]}),!e&&a&&l.jsx("button",{onClick:M,className:"ml-2 px-3 py-2 rounded text-xs font-semibold tracking-wider text-cyan-400 border border-cyan-500/30 hover:bg-cyan-500/10 transition-all duration-200",children:c?"Fermer":"Ouvrir"}),!e&&l.jsx("div",{className:"w-px h-6 bg-white/10 mx-1"}),l.jsxs("button",{onClick:t,className:"flex items-center gap-1 px-3 py-2 rounded text-xs font-semibold tracking-wider text-red-400 border border-red-500/30 hover:bg-red-500/10 transition-all duration-200",title:"Quitter",children:[l.jsx(pc,{className:"w-4 h-4"}),l.jsx("span",{className:"hidden sm:inline",children:"Quitter"})]})]})]})},F2=({onBack:t})=>{const e=le.useRef(null),[n,i]=le.useState(!0),[r,s]=le.useState(!1),a=le.useRef(!1);return le.useEffect(()=>{const o=e.current;if(!o)return;const c=()=>{const h=new Date,p=new Date(h.toLocaleString("en-US",{timeZone:"Europe/Paris"})),f=p.getHours(),m=p.getMinutes(),_=p.getSeconds();let x=f+m/60+_/3600-20;x<0&&(x+=24);const v=x*7.5*60,M=240*60,y=v%M;o.readyState>=2&&(o.currentTime=y,o.playbackRate=.125,o.play().then(()=>{i(!1),setTimeout(()=>s(!0),100)}).catch(T=>{console.log("Erreur lecture vidéo:",T),i(!1),s(!0)}))},u=()=>{a.current||(a.current=!0,c())};return o.addEventListener("canplaythrough",u,{once:!0}),o.readyState>=4&&!a.current&&(a.current=!0,c()),()=>{o.removeEventListener("canplaythrough",u),o&&(o.pause(),o.src="",o.load())}},[]),l.jsxs("div",{className:"fixed inset-0 bg-black z-50",children:[n&&l.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-black z-40",children:l.jsxs("div",{className:"flex flex-col items-center",children:[l.jsx("div",{className:"w-16 h-16 border-4 border-cyan-500/30 border-t-cyan-500 rounded-full animate-spin mb-4"}),l.jsx("p",{className:"text-cyan-400/80 text-sm tracking-wider",children:"CHARGEMENT..."})]})}),l.jsxs("video",{ref:e,className:`w-full h-full object-cover transition-opacity duration-500 ${r?"opacity-100":"opacity-0"}`,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,preload:"metadata",children:[l.jsx("source",{src:"https://github.com/Obsidian-Chrome/nexus/releases/download/1.0.0/nightcity_24h.webm",type:"video/webm"}),"Votre navigateur ne supporte pas la lecture de vidéos."]}),l.jsx(Ph,{onBack:t})]})},k2=({onBack:t})=>{const e=le.useRef(null),[n,i]=le.useState(!0),[r,s]=le.useState(!1),a=()=>{i(!1),setTimeout(()=>s(!0),100)};return le.useEffect(()=>()=>{const o=e.current;o&&(o.pause(),o.src="",o.load())},[]),l.jsxs("div",{className:"fixed inset-0 bg-black z-50",children:[n&&l.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-black z-40",children:l.jsxs("div",{className:"flex flex-col items-center",children:[l.jsx("div",{className:"w-16 h-16 border-4 border-cyan-500/30 border-t-cyan-500 rounded-full animate-spin mb-4"}),l.jsx("p",{className:"text-cyan-400/80 text-sm tracking-wider",children:"CHARGEMENT..."})]})}),l.jsxs("video",{ref:e,className:`w-full h-full object-cover transition-opacity duration-500 ${r?"opacity-100":"opacity-0"}`,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,preload:"metadata",onCanPlayThrough:a,children:[l.jsx("source",{src:"https://github.com/Obsidian-Chrome/nexus/releases/download/1.1.0/PyonPix.-.Centre.Ville.webm",type:"video/webm"}),"Votre navigateur ne supporte pas la lecture de vidéos."]}),l.jsx(Ph,{onBack:t})]})},O2=({onBack:t})=>{const e=le.useRef(null),[n,i]=le.useState(!0),[r,s]=le.useState(!1),a=le.useRef(!1);return le.useEffect(()=>{const o=e.current;if(!o)return;const c=()=>{const h=new Date,p=new Date(h.getTime()+60*60*1e3),f=p.getUTCHours(),m=p.getUTCMinutes(),_=p.getUTCSeconds(),w=f*3600+m*60+_;if(o.readyState>=2&&o.duration){const x=w%o.duration;o.currentTime=x,o.play().then(()=>{i(!1),setTimeout(()=>s(!0),100)}).catch(d=>{console.log("Erreur lecture vidéo:",d),i(!1),s(!0)})}},u=()=>{a.current||(a.current=!0,c())};return o.addEventListener("canplaythrough",u,{once:!0}),o.readyState>=4&&!a.current&&(a.current=!0,c()),()=>{o.removeEventListener("canplaythrough",u),o&&(o.pause(),o.src="",o.load())}},[]),l.jsxs("div",{className:"fixed inset-0 bg-black z-50",children:[n&&l.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-black z-40",children:l.jsxs("div",{className:"flex flex-col items-center",children:[l.jsx("div",{className:"w-16 h-16 border-4 border-cyan-500/30 border-t-cyan-500 rounded-full animate-spin mb-4"}),l.jsx("p",{className:"text-cyan-400/80 text-sm tracking-wider",children:"CHARGEMENT..."})]})}),l.jsxs("video",{ref:e,className:`w-full h-full object-cover transition-opacity duration-500 ${r?"opacity-100":"opacity-0"}`,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,preload:"metadata",children:[l.jsx("source",{src:"https://github.com/Obsidian-Chrome/nexus/releases/download/1.2.0/Cyberpunk.Assets.-.Pubs.webm",type:"video/webm"}),"Votre navigateur ne supporte pas la lecture de vidéos."]}),l.jsx(Ph,{onBack:t,simple:!0})]})},z2=({onBack:t})=>{const e=le.useRef(null),[n,i]=le.useState(!0),[r,s]=le.useState(!1),[a,o]=le.useState(null),[c,u]=le.useState(null),[h,p]=le.useState(0);le.useEffect(()=>{const m=new Date().getTime();fetch(`/coven/visualizer.json?t=${m}`).then(_=>_.json()).then(_=>u(_)).catch(_=>console.error("Erreur chargement visualizer.json:",_))},[]),le.useEffect(()=>{if(!c)return;const m=()=>{const w=new Date,x=w.toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}),d=w.toTimeString().slice(0,5),M=c.events.find(y=>{if(y.date!==x)return!1;const[T,A]=y.heureDebut.split(":").map(Number),[P,g]=y.heureFin.split(":").map(Number),[R,C]=d.split(":").map(Number),D=T*60+A,z=P*60+g,j=R*60+C;return j>=D&&j<=z})||c.default;o(y=>((y==null?void 0:y.fichier)!==(M==null?void 0:M.fichier)&&(i(!0),s(!1),p(T=>T+1)),M))};m();const _=setInterval(m,6e4);return()=>clearInterval(_)},[c]);const f=()=>{i(!1),setTimeout(()=>s(!0),100)};return le.useEffect(()=>()=>{const m=e.current;m&&(m.pause(),m.src="",m.load())},[]),a?l.jsxs("div",{className:"fixed inset-0 bg-black z-50",children:[n&&l.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-black z-40",children:l.jsxs("div",{className:"flex flex-col items-center",children:[l.jsx("div",{className:"w-16 h-16 border-4 border-red-500/30 border-t-red-500 rounded-full animate-spin mb-4"}),l.jsx("p",{className:"text-red-400/80 text-sm tracking-wider",children:"CHARGEMENT..."})]})}),l.jsxs("div",{className:"relative w-full h-full",children:[l.jsxs("video",{ref:e,className:`w-full h-full object-cover transition-opacity duration-500 ${r?"opacity-100":"opacity-0"}`,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,preload:"metadata",onClick:t,onCanPlayThrough:f,children:[l.jsx("source",{src:`/coven/visualizer/${a.fichier}`,type:"video/webm"}),"Votre navigateur ne supporte pas la lecture de vidéos."]},h),r&&a.hexadecimal&&a.hexadecimal!=="#000000"&&l.jsx("div",{className:"absolute inset-0 pointer-events-none mix-blend-multiply transition-opacity duration-500",style:{backgroundColor:a.hexadecimal,opacity:.3}})]})]}):l.jsx("div",{className:"fixed inset-0 bg-black z-50 flex items-center justify-center",children:l.jsx("p",{className:"text-white",children:"Aucun événement configuré"})})},B2=()=>l.jsx("div",{className:"fixed inset-0 bg-black z-50 overflow-y-auto",children:l.jsxs("div",{className:"min-h-screen relative",children:[l.jsx("div",{className:"border-b border-zinc-800 bg-black/95 backdrop-blur-sm sticky top-0 z-10",children:l.jsxs("div",{className:"max-w-7xl mx-auto px-8 py-6 flex items-center justify-between",children:[l.jsxs("button",{onClick:()=>window.location.hash="",className:"flex items-center space-x-2 text-white/80 hover:text-red-400 transition-all duration-300",children:[l.jsx(Kn,{className:"w-5 h-5"}),l.jsx("span",{className:"font-medium",children:"Retour"})]}),l.jsx("img",{src:"/coven/coven_logo.png",alt:"Coven",className:"h-24 object-contain"}),l.jsx("div",{className:"w-24"})]})}),l.jsx("div",{className:"max-w-6xl mx-auto px-8 py-24",children:l.jsxs("div",{className:"flex flex-col md:flex-row gap-6 justify-center items-stretch",children:[l.jsx("a",{href:"#coven/visualizer",className:"flex-1 max-w-md bg-zinc-900/50 border border-zinc-800 p-8 hover:border-red-500/60 hover:shadow-[0_0_30px_rgba(220,38,38,0.3)] transition-all duration-300 group",children:l.jsxs("div",{className:"flex flex-col items-center text-center gap-4",children:[l.jsx("div",{className:"w-16 h-16 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center group-hover:bg-red-500/30 transition-all",children:l.jsx(hl,{className:"w-8 h-8 text-red-400"})}),l.jsx("h2",{className:"text-2xl font-bold text-white group-hover:text-red-400 transition-colors",children:"Visualizer"})]})}),l.jsx("a",{href:"#coven/dvd",className:"flex-1 max-w-md bg-zinc-900/50 border border-zinc-800 p-8 hover:border-red-500/60 hover:shadow-[0_0_30px_rgba(220,38,38,0.3)] transition-all duration-300 group",children:l.jsxs("div",{className:"flex flex-col items-center text-center gap-4",children:[l.jsx("div",{className:"w-16 h-16 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center group-hover:bg-red-500/30 transition-all",children:l.jsx(Rx,{className:"w-8 h-8 text-red-400"})}),l.jsx("h2",{className:"text-2xl font-bold text-white group-hover:text-red-400 transition-colors",children:"DVD Screensaver"})]})}),l.jsx("div",{className:"flex-1 max-w-md bg-zinc-900/50 border border-zinc-800 p-8 opacity-50 cursor-not-allowed",children:l.jsxs("div",{className:"flex flex-col items-center text-center gap-4",children:[l.jsx("div",{className:"w-16 h-16 rounded-full bg-red-500/10 border border-red-500/30 flex items-center justify-center",children:l.jsx(_S,{className:"w-8 h-8 text-red-400/50"})}),l.jsx("h2",{className:"text-2xl font-bold text-white/50",children:"Carte"})]})})]})})]})}),V2=()=>{const t=le.useRef(null),e=le.useRef(null),n=le.useRef({x:100,y:100}),i=le.useRef({x:2,y:2}),r=le.useRef(null),[s,a]=le.useState(0);return le.useEffect(()=>{const o=t.current,c=e.current;if(!o||!c)return;const u=250,h=250,p=()=>{const _=c.clientWidth,w=c.clientHeight;n.current.x+=i.current.x,n.current.y+=i.current.y;let x=!1;(n.current.x+u>=_||n.current.x<=0)&&(i.current.x*=-1,n.current.x=Math.max(0,Math.min(n.current.x,_-u)),x=!0),(n.current.y+h>=w||n.current.y<=0)&&(i.current.y*=-1,n.current.y=Math.max(0,Math.min(n.current.y,w-h)),x=!0),x&&a(Math.random()*360),o.style.transform=`translate(${n.current.x}px, ${n.current.y}px)`,r.current=requestAnimationFrame(p)};n.current={x:Math.random()*(c.clientWidth-u),y:Math.random()*(c.clientHeight-h)};const f=2,m=Math.random()*Math.PI*2;return i.current={x:Math.cos(m)*f,y:Math.sin(m)*f},p(),()=>{r.current&&cancelAnimationFrame(r.current)}},[]),l.jsx("div",{ref:e,className:"fixed inset-0 bg-black z-50 overflow-hidden",children:l.jsx("img",{ref:t,src:"/coven/coven_logo.png",alt:"Coven Logo",className:"absolute w-[250px] h-[250px] object-contain transition-all duration-100",style:{filter:`hue-rotate(${s}deg) saturate(1.5)`,willChange:"transform"}})})},el="https://raw.githubusercontent.com/Obsidian-Chrome/nexus/main/public/media/radio/mp3/",p0=[{id:1,freq:"69.9",name:"Funk Radio",slug:"funk-radio",logo:"/media/radio/logos/69.9_Funk_Radio.webp",color:"#2596be",playlistFile:"/media/radio/playlists/69.9_Funk_Radio.json"},{id:2,freq:"87.7",name:"Magenta Station",slug:"magenta-station",logo:"/media/radio/logos/87.7_Magenta_Station.webp",color:"#2596be",playlistFile:"/media/radio/playlists/87.7_Magenta_Station.json"},{id:3,freq:"88.9",name:"Pacific Dreams",slug:"pacific-dreams",logo:"/media/radio/logos/88.9_Pacific_Dreams.webp",color:"#2596be",playlistFile:"/media/radio/playlists/88.9_Pacific_Dreams.json"},{id:4,freq:"89.3",name:"Radio Vexelstrom",slug:"radio-vexelstrom",logo:"/media/radio/logos/89.3_Radio_Vexelstrom.webp",color:"#2596be",playlistFile:"/media/radio/playlists/89.3_Radio_Vexelstrom.json"},{id:5,freq:"89.7",name:"Growl FM",slug:"growl-fm",logo:"/media/radio/logos/89.7_Growl_FM.webp",color:"#2596be",playlistFile:"/media/radio/playlists/89.7_Growl_FM.json"},{id:6,freq:"91.9",name:"Royal Blue Radio",slug:"royal-blue-radio",logo:"/media/radio/logos/91.9_Royal_Blue_Radio.webp",color:"#2596be",playlistFile:"/media/radio/playlists/91.9_Royal_Blue_Radio.json"},{id:7,freq:"92.9",name:"Night FM",slug:"night-fm",logo:"/media/radio/logos/92.9_Night_FM.webp",color:"#2596be",playlistFile:"/media/radio/playlists/92.9_Night_FM.json"},{id:8,freq:"95.2",name:"Samizdat Radio",slug:"samizdat-radio",logo:"/media/radio/logos/95.2_Samizdat_Radio.webp",color:"#2596be",playlistFile:"/media/radio/playlists/95.2_Samizdat_Radio.json"},{id:9,freq:"96.1",name:"Ritual FM",slug:"ritual-fm",logo:"/media/radio/logos/96.1_Ritual_FM.webp",color:"#2596be",playlistFile:"/media/radio/playlists/96.1_Ritual_FM.json"},{id:10,freq:"98.7",name:"Body Heat Radio",slug:"body-heat-radio",logo:"/media/radio/logos/98.7_Body_Heat_Radio.webp",color:"#2596be",playlistFile:"/media/radio/playlists/98.7_Body_Heat_Radio.json"},{id:11,freq:"99.9",name:"Impulse",slug:"impulse",logo:"/media/radio/logos/99.9_Impulse.webp",color:"#2596be",playlistFile:"/media/radio/playlists/99.9_Impulse.json"},{id:12,freq:"101.9",name:"The Dirge",slug:"the-dirge",logo:"/media/radio/logos/101.9_The_Dirge.webp",color:"#2596be",playlistFile:"/media/radio/playlists/101.9_The_Dirge.json"},{id:13,freq:"103.5",name:"Radio PEBKAC",slug:"radio-pebkac",logo:"/media/radio/logos/103.5_Radio_PEBKAC.webp",color:"#2596be",playlistFile:"/media/radio/playlists/103.5_Radio_PEBKAC.json"},{id:14,freq:"106.9",name:"30 PRINCIPALES",slug:"30-principales",logo:"/media/radio/logos/106.9_30_PRINCIPALES.webp",color:"#2596be",playlistFile:"/media/radio/playlists/106.9_30_PRINCIPALES.json"},{id:15,freq:"107.3",name:"Morro Rock Radio",slug:"morro-rock-radio",logo:"/media/radio/logos/107.3_Morro_Rock_Radio.webp",color:"#2596be",playlistFile:"/media/radio/playlists/107.3_Morro_Rock_Radio.json"},{id:16,freq:"107.5",name:"Dark Star",slug:"dark-star",logo:"/media/radio/logos/107.5_Dark_Star.webp",color:"#2596be",playlistFile:"/media/radio/playlists/107.5_Dark_Star.json"}],H2=({active:t,color:e})=>l.jsx("div",{className:"flex items-end gap-[2px] h-5",children:[...Array(4)].map((n,i)=>{const r=.3+Math.random()*.4,s=i*.1;return l.jsx("div",{className:"w-[3px] rounded-sm transition-all duration-150",style:{height:t?`${Math.random()*80+20}%`:"20%",backgroundColor:t?"#22c55e":"#1a0000",animationName:t?"barPulse":"none",animationDuration:t?`${r}s`:void 0,animationTimingFunction:t?"ease-in-out":void 0,animationIterationCount:t?"infinite":void 0,animationDirection:t?"alternate":void 0,animationDelay:t?`${s}s`:void 0}},i)})}),G2=({onBack:t})=>{const e=le.useRef(null),[n,i]=le.useState(null),[r,s]=le.useState(!1),[a,o]=le.useState(!1),[c,u]=le.useState(.2),[h,p]=le.useState(!1),[f,m]=le.useState(!1),[_,w]=le.useState([]),[x,d]=le.useState(null),[v,M]=le.useState([]),[y,T]=le.useState(0),[A,P]=le.useState(0),[g,R]=le.useState(0),[C,D]=le.useState(!1),z=le.useRef(null),j=le.useRef(!1);le.useRef(!0);const[ne,V]=le.useState(null),[Q,$]=le.useState(!1);le.useEffect(()=>{const k=window.location.hash,q=k.indexOf("?");if(q>-1){const K=k.substring(q+1),me=new URLSearchParams(K).get("radio");if(me){const ue=p0.find(Re=>Re.slug===me);ue&&(i(ue),$(!0))}}},[]),le.useEffect(()=>{const k=setInterval(()=>{Math.random()>.85&&(m(!0),setTimeout(()=>m(!1),120))},2e3);return()=>clearInterval(k)},[]),le.useEffect(()=>{if(!n)return;D(!1),M([]),d(null),(async()=>{try{const K=await(await fetch(n.playlistFile)).json(),ge=await Promise.all(K.tracks.map(async Me=>new Promise(_e=>{const we=Me.file.startsWith("http")?Me.file:`${el}${Me.file}`,Fe=new Audio(we);Fe.addEventListener("loadedmetadata",()=>{_e({...Me,duration:Fe.duration})}),Fe.addEventListener("error",()=>{console.error(`Erreur chargement: ${Me.file}`),_e({...Me,duration:180})})})));w(ge);const me=new Date().toISOString().split("T")[0],ue=`${n.freq}_${n.name}_${me}`,Re=E([...ge],ue);M(Re),setTimeout(()=>D(!0),0)}catch(q){console.error("Erreur chargement playlist:",q),w([]),M([]),D(!1),o(!1)}})()},[n]),le.useEffect(()=>{if(!C||!j.current||v.length===0||!v[0])return;const q=v.reduce((_e,we)=>_e+we.duration,0),ge=Date.now()/1e3%q;let me=0,ue=0,Re=0;for(let _e=0;_e<v.length;_e++){if(me+v[_e].duration>ge){ue=_e,Re=ge-me;break}me+=v[_e].duration}const Me=v[ue];if(d(Me),R(ue),e.current){const _e=Me.file.startsWith("http")?Me.file:`${el}${Me.file}`;e.current.src=_e,e.current.currentTime=Re,e.current.volume=c,e.current.play().catch(we=>console.error("Erreur lecture:",we)),s(!0),o(!1)}j.current=!1},[C]);const b=()=>{if(v.length===0)return;const k=(g+1)%v.length,q=v[k];if(d(q),R(k),e.current&&r){const K=q.file.startsWith("http")?q.file:`${el}${q.file}`;e.current.src=K,e.current.currentTime=0,e.current.volume=c,e.current.play().catch(ge=>console.error("Erreur lecture:",ge))}};le.useEffect(()=>{if(!r||!e.current)return;const q=setInterval(()=>{e.current&&(T(e.current.currentTime),P(e.current.duration))},100);return()=>clearInterval(q)},[r]);const E=(k,q)=>{const K=ue=>{let Re=Math.sin(ue++)*1e4;return Re-Math.floor(Re)};let ge=0;for(let ue=0;ue<q.length;ue++)ge+=q.charCodeAt(ue);const me=[...k];for(let ue=me.length-1;ue>0;ue--){const Re=Math.floor(K(ge+ue)*(ue+1));[me[ue],me[Re]]=[me[Re],me[ue]]}return me},L=k=>{const q=`${window.location.origin}${window.location.pathname}#radio?radio=${k.slug}`;navigator.clipboard.writeText(q).then(()=>{V(k.id),setTimeout(()=>V(null),2e3)})},O=k=>{z.current!==k.id&&(e.current&&(e.current.pause(),e.current.currentTime=0),s(!1),o(!0),d(null),D(!1),i(k),z.current=k.id,j.current=!0)},U=()=>{var k;if(r)(k=e.current)==null||k.pause(),s(!1);else{if(!x&&n){if(C&&v.length>0){const q=v.reduce((_e,we)=>_e+we.duration,0),ge=Date.now()/1e3%q;let me=0,ue=0,Re=0;for(let _e=0;_e<v.length;_e++){if(me+v[_e].duration>ge){ue=_e,Re=ge-me;break}me+=v[_e].duration}const Me=v[ue];if(d(Me),R(ue),e.current){const _e=Me.file.startsWith("http")?Me.file:`${el}${Me.file}`;e.current.src=_e,e.current.currentTime=Re,e.current.volume=c,e.current.play().catch(we=>console.error("Erreur lecture:",we)),s(!0)}}else o(!0),j.current=!0;return}e.current&&x&&(e.current.volume=c,e.current.play().catch(q=>console.error("Erreur lecture:",q))),s(!0),o(!1)}},ce=k=>{const q=parseFloat(k.target.value);u(q),p(!1),e.current&&(e.current.volume=q)},he=k=>{if(!k||isNaN(k))return"0:00";const q=Math.floor(k/60),K=Math.floor(k%60);return`${q}:${K.toString().padStart(2,"0")}`},se=()=>{const k=!h;p(k),e.current&&(e.current.muted=k)};return l.jsxs("div",{className:"fixed inset-0 z-50 overflow-hidden overflow-x-hidden max-w-screen",style:{fontFamily:"'Rajdhani', sans-serif",background:"#0a0000",maxWidth:"100vw",width:"100vw",boxSizing:"border-box"},children:[l.jsx("div",{className:"pointer-events-none fixed inset-0 z-10",style:{backgroundImage:"repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,0,0,0.18) 2px, rgba(0,0,0,0.18) 4px)"}}),l.jsx("div",{className:"pointer-events-none fixed inset-0 z-0",style:{background:"radial-gradient(ellipse at 50% 30%, rgba(180,0,0,0.18) 0%, transparent 70%)"}}),l.jsxs("div",{className:"relative z-20 h-screen flex flex-col overflow-x-hidden",children:[l.jsxs("div",{className:"border-b px-2 lg:px-8 py-5 flex items-center justify-between flex-shrink-0",style:{borderColor:"#8B0000",background:"rgba(10,0,0,0.95)"},children:[!Q&&l.jsxs("button",{onClick:t,className:"flex items-center gap-2 transition-colors duration-200 group lg:w-auto w-8",style:{color:"#2596be"},children:[l.jsx(Kn,{className:"w-5 h-5 group-hover:text-white transition-colors"}),l.jsx("span",{className:"text-lg font-semibold tracking-widest uppercase hidden lg:inline",children:"Retour"})]}),Q&&l.jsx("div",{className:"w-8 lg:w-32"}),l.jsxs("div",{className:"flex flex-col items-center flex-1 lg:flex-none",children:[l.jsxs("div",{className:"flex items-center gap-2 lg:gap-3",children:[l.jsx("div",{className:"w-2 h-2 rounded-full animate-pulse hidden lg:block",style:{backgroundColor:"#8B0000",boxShadow:"0 0 8px #ff0000"}}),l.jsx("span",{className:"text-2xl lg:text-4xl font-bold tracking-widest lg:tracking-[0.25em] uppercase",style:{color:"#2596be",textShadow:f?"3px 0 #ff0000, -3px 0 #00ffff":"0 0 20px rgba(0,180,255,0.8), 0 0 40px rgba(0,180,255,0.3)"},children:"RADIO"}),l.jsx("div",{className:"w-2 h-2 rounded-full animate-pulse hidden lg:block",style:{backgroundColor:"#8B0000",boxShadow:"0 0 8px #ff0000",animationDelay:"0.5s"}})]}),l.jsx("div",{className:"text-[0.5rem] lg:text-xs tracking-[0.3em] lg:tracking-[0.5em] mt-1",style:{color:"#8B0000"},children:"NIGHT CITY BROADCAST"})]}),l.jsx("div",{className:"w-8 lg:w-32"})]}),l.jsxs("div",{className:"flex flex-col lg:flex-row gap-0 flex-1 min-h-0 overflow-hidden",children:[!Q&&l.jsxs("div",{className:"lg:w-[420px] lg:border-r flex-shrink-0 flex flex-col overflow-x-hidden overflow-y-hidden h-auto lg:h-full",style:{borderColor:"#3a0000",background:"rgba(8,0,0,0.97)"},children:[l.jsx("div",{className:"px-4 lg:px-6 py-4 border-b flex-shrink-0",style:{borderColor:"#3a0000"},children:l.jsx("div",{className:"text-xs tracking-wider lg:tracking-[0.4em] uppercase font-semibold text-center lg:text-left",style:{color:"#8B0000"},children:"— STATIONS DISPONIBLES —"})}),l.jsx("div",{className:"flex-1 overflow-y-auto max-h-[40vh] lg:max-h-none",style:{scrollbarWidth:"thin",scrollbarColor:"#3a0000 transparent"},children:p0.map((k,q)=>{const K=(n==null?void 0:n.id)===k.id;return l.jsxs("div",{onClick:()=>O(k),className:"w-full px-2 lg:px-6 py-4 border-b transition-all duration-200 relative cursor-pointer",style:{borderColor:"#1a0000",background:K?"linear-gradient(90deg, rgba(0,180,255,0.08) 0%, transparent 100%)":"transparent"},children:[l.jsx("div",{className:"absolute left-0 top-0 bottom-0 w-[3px] transition-all duration-200",style:{background:K?"#2596be":"transparent",boxShadow:K?"0 0 12px #2596be":"none"}}),l.jsxs("div",{className:"flex items-center gap-4",children:[l.jsx("div",{className:"flex-shrink-0",children:l.jsx("img",{src:k.logo,alt:k.name,className:"w-16 h-16 object-contain rounded-sm",style:{filter:K?"brightness(1.1)":"brightness(0.6)",border:K?`2px solid ${k.color}40`:"2px solid transparent"}})}),l.jsxs("div",{className:"flex-1 min-w-0",children:[l.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[l.jsxs("span",{className:"text-lg font-bold tracking-widest",style:{color:K?k.color:"#8B0000"},children:[k.freq," FM"]}),K&&r&&l.jsx("span",{className:"text-sm animate-pulse",style:{color:"#22c55e"},children:"◉"})]}),l.jsx("div",{className:"text-base font-bold tracking-wider truncate transition-colors duration-200",style:{color:K?"#ffffff":"#aaaaaa",textShadow:K?`0 0 15px ${k.color}60`:"none"},children:k.name})]}),l.jsxs("div",{className:"flex-shrink-0 flex items-center gap-2",children:[K&&r?l.jsxs(l.Fragment,{children:[l.jsx(H2,{active:!0,color:k.color}),l.jsx("button",{onClick:ge=>{ge.stopPropagation(),U()},className:"w-8 h-8 rounded-sm flex items-center justify-center border transition-all duration-200 hover:scale-110 cursor-pointer",style:{borderColor:k.color,background:`${k.color}20`,color:k.color},children:l.jsx(nm,{className:"w-4 h-4"})})]}):K&&a?l.jsx("div",{className:"w-8 h-8 rounded-sm flex items-center justify-center border",style:{borderColor:k.color,background:"transparent",color:k.color},children:l.jsx("div",{className:"w-4 h-4 border-2 border-t-transparent rounded-full animate-spin",style:{borderColor:k.color,borderTopColor:"transparent"}})}):K?l.jsx("button",{onClick:ge=>{ge.stopPropagation(),U()},className:"w-8 h-8 rounded-sm flex items-center justify-center border transition-all duration-200 hover:scale-110 cursor-pointer",style:{borderColor:k.color,background:"transparent",color:k.color},children:l.jsx(hl,{className:"w-4 h-4 ml-0.5"})}):l.jsx("button",{onClick:ge=>{ge.stopPropagation(),O(k)},className:"w-8 h-8 rounded-sm flex items-center justify-center border transition-all duration-200 hover:scale-110 cursor-pointer",style:{borderColor:k.color,background:"transparent",color:k.color,opacity:.6},children:l.jsx(hl,{className:"w-4 h-4 ml-0.5"})}),l.jsxs("button",{onClick:ge=>{ge.stopPropagation(),L(k)},className:"w-8 h-8 rounded-sm flex items-center justify-center border transition-all duration-200 hover:scale-110 cursor-pointer relative",style:{borderColor:k.color,background:"transparent",color:k.color,opacity:K?1:.6},title:"Copier le lien direct",children:[l.jsx(lS,{className:"w-4 h-4"}),ne===k.id&&l.jsx("span",{className:"absolute -top-8 left-1/2 -translate-x-1/2 bg-black/90 text-white text-xs px-2 py-1 rounded whitespace-nowrap",style:{color:k.color},children:"Copié !"})]})]})]})]},k.id)})})]}),l.jsx("div",{className:"flex-1 flex items-center justify-center overflow-y-auto overflow-x-hidden p-2 lg:p-8",children:n?l.jsxs("div",{className:"flex flex-col items-center gap-4 lg:gap-8 w-full max-w-full lg:max-w-xl py-4 lg:py-0",children:[(Q||window.innerWidth>=1024)&&l.jsx("div",{className:"flex items-center justify-center flex-shrink-0",children:l.jsx("img",{src:n.logo,alt:n.name,className:"w-48 h-48 lg:w-80 lg:h-80 object-contain",style:{filter:"brightness(1.2) drop-shadow(0 0 30px rgba(37, 150, 190, 0.5))"}})}),l.jsxs("div",{className:"text-center flex-shrink-0 px-2 max-w-full",children:[l.jsx("h2",{className:"text-2xl lg:text-5xl font-bold tracking-wide lg:tracking-widest uppercase mb-2 truncate",style:{color:n.color,textShadow:`0 0 30px ${n.color}80, 0 0 60px ${n.color}30`},children:n.name}),l.jsxs("div",{className:"text-xl lg:text-2xl font-bold tracking-wide lg:tracking-widest",style:{color:"#2596be"},children:[n.freq," FM"]})]}),Q&&l.jsx("div",{className:"flex justify-center",children:a?l.jsx("div",{className:"w-16 h-16 rounded-full flex items-center justify-center border-2",style:{borderColor:n.color,background:"transparent"},children:l.jsx("div",{className:"w-8 h-8 border-2 border-t-transparent rounded-full animate-spin",style:{borderColor:n.color,borderTopColor:"transparent"}})}):l.jsx("button",{onClick:U,className:"w-16 h-16 rounded-full flex items-center justify-center border-2 transition-all duration-200 hover:scale-110",style:{borderColor:n.color,background:r?`${n.color}20`:"transparent",color:n.color},children:r?l.jsx(nm,{className:"w-8 h-8"}):l.jsx(hl,{className:"w-8 h-8 ml-1"})})}),r&&x?l.jsxs("div",{className:"text-center flex-shrink-0 px-2 max-w-full",children:[l.jsx("div",{className:"text-xs tracking-wider lg:tracking-[0.5em] mb-2",style:{color:"#8B0000"},children:"EN LECTURE"}),l.jsx("div",{className:"text-base lg:text-xl font-bold tracking-wide lg:tracking-wider mb-1 truncate",style:{color:"#ffffff"},children:x.name}),l.jsx("div",{className:"text-sm tracking-wide lg:tracking-widest truncate",style:{color:"#2596be"},children:x.artist}),l.jsxs("div",{className:"mt-3 flex items-center justify-center gap-2",children:[l.jsx("span",{className:"text-xs font-mono",style:{color:"#2596be"},children:he(y)}),l.jsx("span",{className:"text-xs",style:{color:"#555555"},children:"/"}),l.jsx("span",{className:"text-xs font-mono",style:{color:"#555555"},children:he(A)})]})]}):l.jsx("div",{className:"text-center py-4 flex-shrink-0",children:l.jsx("div",{className:"text-sm tracking-widest",style:{color:"#555555"},children:r?"CHARGEMENT...":"APPUYEZ SUR PLAY"})}),l.jsx("div",{className:"hidden lg:flex flex-col items-center gap-6 w-full max-w-sm flex-shrink-0",children:l.jsx("div",{className:"w-full px-6 py-4 rounded-sm border",style:{borderColor:`${n.color}30`,background:"rgba(0,0,0,0.3)"},children:l.jsxs("div",{className:"flex items-center gap-4",children:[l.jsx("button",{onClick:se,className:"transition-all duration-200 hover:scale-110",style:{color:h?"#555555":n.color},children:h?l.jsx(vS,{className:"w-6 h-6"}):l.jsx(xS,{className:"w-6 h-6"})}),l.jsx("div",{className:"flex-1 relative",children:l.jsx("input",{type:"range",min:"0",max:"1",step:"0.01",value:h?0:c,onChange:ce,className:"w-full h-2 rounded-full appearance-none cursor-pointer",style:{background:`linear-gradient(to right, ${n.color} 0%, ${n.color} ${c*100}%, #1a0000 ${c*100}%, #1a0000 100%)`,accentColor:n.color}})}),l.jsx("span",{className:"text-xs font-bold tracking-wider min-w-[3ch]",style:{color:n.color},children:Math.round(c*100)})]})})})]}):l.jsxs("div",{className:"flex flex-col items-center gap-6 text-center",children:[l.jsx("div",{className:"text-2xl font-bold tracking-widest",style:{color:"#8B0000"},children:"SÉLECTIONNEZ UNE RADIO"}),l.jsx("div",{className:"text-sm tracking-wider",style:{color:"#555555"},children:"Cliquez sur une station dans la liste pour commencer"})]})})]})]}),l.jsx("audio",{ref:e,onEnded:b}),l.jsx("style",{children:`
        @keyframes barPulse {
